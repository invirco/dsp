...
.var _mtr_peak_C2_MTR_AUX_03 = 0.0;
.global _mtr_rms_C2_MTR_AUX_03;
.var _mtr_rms_C2_MTR_AUX_03 = 0.0;
.global _mtr_gr_C2_MTR_AUX_03;
.var _mtr_gr_C2_MTR_AUX_03 = 0.0;         /* gain reduction (gate or comp) */
...
_C2_MTR_AUX_03_process:
    ...
    comp(f0, f1);
    if le jump (pc, .mtr_decay_C2_MTR_AUX_03);
    dm(_mtr_peak_C2_MTR_AUX_03) = f0;
    rts;
.mtr_decay_C2_MTR_AUX_03:

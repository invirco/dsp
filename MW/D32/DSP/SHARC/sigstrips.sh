...
# the verdict by the HONEST rule: 1500 passes/s is real time;
# audio_verdict.py's REAL_TIME label only means it cleared 1450, and
# anything below 1500 is dropping blocks.
#

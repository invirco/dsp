#!/bin/bash
# bqguard_run.sh — boot the staged image and read the headroom-guard verdict.
set -u
cd /home/app/dspboot
...
# RETRY THE LINK, NOT THE VERDICT. dsp4_bqg_verify.py exits 1 when it
...
for g in 1 2 3 4 5 6; do
  ...
  python3 dsp4_bqg_verify.py /home/app/dspboot/chip1.sym.json \
      /home/app/dspboot/bqg_vectors.json
  rc=$?
  [ $rc -eq 0 ] && exit 0
  [ $rc -eq 1 ] && exit 1
  sleep 2

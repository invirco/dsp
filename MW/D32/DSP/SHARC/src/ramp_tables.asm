...
/* Frame period: 0.3333 ms (16 samples @ 48 kHz) */
...
_ramp_profile_table:
    ...
    /* GainFast (ID=1) */
    .var = 1;    /* mode: Slew */
    .var = 9;    /* up: 3ms = 9 frames */
    .var = 24;    /* down: 8ms = 24 frames */
    .var = 1;    /* curve: Exp */
    .var = 0;    /* scope: Scalar */

    /* GainSafe (ID=2) */
    .var = 1;    /* mode: Slew */
    .var = 30;    /* up: 10ms = 30 frames */
    .var = 90;    /* down: 30ms = 90 frames */
    .var = 1;    /* curve: Exp */
    .var = 0;    /* scope: Scalar */

    /* EqSafe (ID=3) */
    .var = 2;    /* mode: LinearFrames */
    .var = 36;    /* up: 12ms = 36 frames */
    .var = 36;    /* down: 12ms = 36 frames */
    .var = 0;    /* curve: Linear */
    .var = 1;    /* scope: CoeffSetAtomic */

    /* DynSafe (ID=4) */
    .var = 2;    /* mode: LinearFrames */
    .var = 18;    /* up: 6ms = 18 frames */
    .var = 60;    /* down: 20ms = 60 frames */
    .var = 1;    /* curve: Exp */
    .var = 0;    /* scope: Scalar */

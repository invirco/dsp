/*----------------------------------------------------------------------
 * Snake Return 1 (INPUT_TDM)
 * Node ID:    C1_XIN_SNK_01
 * Chip:       1
 * Channels:   1
 * SPI Page:   -1
 * SPI Addr:   -1
...
/* INPUT_TDM: Read from SPORT5 TDM slot 0 */
...
.global _rx_slot_C1_XIN_SNK_01;
.var _rx_slot_C1_XIN_SNK_01;
#if DSP4_BLOCK_KERNELS
.global _buf_C1_XIN_SNK_01;
.var _buf_C1_XIN_SNK_01[DSP4_BLOCK_SIZE];
#else
.global _buf_C1_XIN_SNK_01;
.var _buf_C1_XIN_SNK_01;
#endif

.section/pm seg_pmco;
.global _C1_XIN_SNK_01_process;
_C1_XIN_SNK_01_process:
#if DSP4_BLOCK_KERNELS
...
.in_lp_C1_XIN_SNK_01:
    ...
    rts;
#else
    r0 = dm(_rx_slot_C1_XIN_SNK_01);
    dm(_buf_C1_XIN_SNK_01) = r0;
    rts;
#endif
_C1_XIN_SNK_01_process.end:

...
.extern _buf_L_C1_FDR_07;
.extern _buf_R_C1_FDR_07;
...
.rtg_nosub_C1_RTG_07:
    ...
    lcntr = r5, do .rtg_aux_C1_RTG_07 until lce;
        ...
        r6 = pass r6;
        if eq jump (pc, .rab_pk0_C1_RTG_07);
        r7 = 1;
        comp(r6, r7);
        if eq jump (pc, .rab_pk1_C1_RTG_07);
        r7 = 2;
        comp(r6, r7);
        if eq jump (pc, .rab_pk2_C1_RTG_07);
        r0 = _tap_post_fader_C1_FDR_07;
        jump (pc, .rab_pkd_C1_RTG_07);
    .rab_pk0_C1_RTG_07:
    ...
    lcntr = r5, do .rtg_fx_C1_RTG_07 until lce;
        ...
        r6 = dm(i6, 1);               /* pickoff enum */
        r6 = pass r6;
        if eq jump (pc, .rfb_pk0_C1_RTG_07);
        r7 = 1;
        comp(r6, r7);
        if eq jump (pc, .rfb_pk1_C1_RTG_07);
        r7 = 2;
        comp(r6, r7);
        if eq jump (pc, .rfb_pk2_C1_RTG_07);
        r0 = _tap_post_fader_C1_FDR_07;
        jump (pc, .rfb_pkd_C1_RTG_07);
    .rfb_pk0_C1_RTG_07:
        r0 = _tap_post_trim_C1_GAIN_07;
        jump (pc, .rfb_pkd_C1_RTG_07);
    .rfb_pk1_C1_RTG_07:

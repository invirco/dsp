...
.extern _fdr_lq_C1_FDR_18;
.extern _fdr_rq_C1_FDR_18;
 ...
 * left; _fdr_busy_C1_FDR_18 is the same for the fader, whose pan legs
...
.var _rtg_aux_sq_C1_RTG_18[12];               /* crosspoint coeffs */
.global _rtg_aux_src_C1_RTG_18;
.var _rtg_aux_src_C1_RTG_18[12];              /* resolved sources  */
...
.global _rtg_fx_src_C1_RTG_18;
.var _rtg_fx_src_C1_RTG_18[6];
.global _rtg_mtx_on_C1_RTG_18;
.var _rtg_mtx_on_C1_RTG_18[2];
.global _rtg_mtx_send_C1_RTG_18;
.var _rtg_mtx_send_C1_RTG_18[2];
.global _rtg_mtx_send_target_C1_RTG_18;
.var _rtg_mtx_send_target_C1_RTG_18[2];
.global _rtg_mtx_send_step_C1_RTG_18;
.var _rtg_mtx_send_step_C1_RTG_18[2];
.global _rtg_mtx_send_frames_C1_RTG_18;
.var _rtg_mtx_send_frames_C1_RTG_18[2];
.global _rtg_mtx_pick_C1_RTG_18;
.var _rtg_mtx_pick_C1_RTG_18[2] = 3, 3;
.global _rtg_mtx_sq_C1_RTG_18;
.var _rtg_mtx_sq_C1_RTG_18[2];
.global _rtg_mtx_src_C1_RTG_18;
.var _rtg_mtx_src_C1_RTG_18[2];
/* main/sub/group crosspoint coefficients: pan leg or unity, times
 * the bus-assign bit. Prepared below at control rate. */
.global _rtg_mlq_C1_RTG_18;
.var _rtg_mlq_C1_RTG_18 = 0;
.global _rtg_mrq_C1_RTG_18;
.var _rtg_mrq_C1_RTG_18 = 0;
.global _rtg_subq_C1_RTG_18;
.var _rtg_subq_C1_RTG_18 = 0;
.global _rtg_grpq_C1_RTG_18;
.var _rtg_grpq_C1_RTG_18[4] = 0, 0, 0, 0;
...
.global _rtg_list_C1_RTG_18;
.var _rtg_list_C1_RTG_18[81];
.global _rtg_n_C1_RTG_18;
.var _rtg_n_C1_RTG_18 = 0;
...
_C1_RTG_18_process:
    ...
    if eq jump (pc, .rtg_acc_C1_RTG_18);
#endif
    ...
    r1 = dm(_fdr_lq_C1_FDR_18);
    r2 = pass r2;
    if eq r1 = r8;
    dm(_rtg_mlq_C1_RTG_18) = r1;
    r1 = dm(_fdr_rq_C1_FDR_18);
    r2 = pass r2;
    if eq r1 = r8;
    dm(_rtg_mrq_C1_RTG_18) = r1;
    ...
    r1 = r9;
    r3 = dm(_fdr_lcr_on_C1_FDR_18);
    r4 = dm(_fdr_cq_C1_FDR_18);
    r3 = pass r3;
    if ne r1 = r4;
    r2 = pass r2;
    if eq r1 = r8;
    dm(_rtg_subq_C1_RTG_18) = r1;
    ...
    i6 = _rtg_grpq_C1_RTG_18;
    lcntr = 4, do .rtg_gq_C1_RTG_18 until lce;
        r2 = dm(i5, 1);
        r1 = r9;
        r2 = pass r2;
        if eq r1 = r8;
    ...
    l1 = 0;
    i1 = _rtg_aux_sq_C1_RTG_18;
    i5 = _rtg_aux_pick_C1_RTG_18;
    i6 = _rtg_aux_src_C1_RTG_18;
    r5 = 12;
    lcntr = r5, do .auxsrc_C1_RTG_18 until lce;
        r6 = dm(i5, 1);               /* pickoff enum */
        r4 = dm(i1, 1);               /* coefficient */
        r0 = BLK_CHAIN_A;
        r4 = pass r4;
        if eq jump (pc, .auxsrcd_C1_RTG_18);
        r6 = pass r6;
        if eq jump (pc, .auxsrc0_C1_RTG_18);
        r7 = 1;
        comp(r6, r7);
        if eq jump (pc, .auxsrc1_C1_RTG_18);
        r7 = 2;
        comp(r6, r7);
        if ne jump (pc, .auxsrcd_C1_RTG_18);
        r0 = BLK_TAP_PREFDR;
        jump (pc, .auxsrcd_C1_RTG_18);
    .auxsrc0_C1_RTG_18:
        r0 = BLK_TAP_TRIM;
        jump (pc, .auxsrcd_C1_RTG_18);
    .auxsrc1_C1_RTG_18:
    ...
    lcntr = r5, do .auxsrc_C1_RTG_18 until lce;
        ...
        comp(r6, r7);
        if ne jump (pc, .auxsrcd_C1_RTG_18);
        r0 = _tap_pre_fader_C1_DLY_18;
        jump (pc, .auxsrcd_C1_RTG_18);
    .auxsrc0_C1_RTG_18:
        r0 = _tap_post_trim_C1_GAIN_18;
        jump (pc, .auxsrcd_C1_RTG_18);
    .auxsrc1_C1_RTG_18:
        r0 = _tap_post_eq_C1_EQ_18;
    .auxsrcd_C1_RTG_18:
        dm(i6, 1) = r0;
    .auxsrc_C1_RTG_18:
        nop;
     ...
     * coefficient is zero keep the default and are never read. */
    l1 = 0;
    i1 = _rtg_fx_sq_C1_RTG_18;
    i5 = _rtg_fx_pick_C1_RTG_18;
    i6 = _rtg_fx_src_C1_RTG_18;
    r5 = 6;
    lcntr = r5, do .fxsrc_C1_RTG_18 until lce;
        r6 = dm(i5, 1);               /* pickoff enum */
        r4 = dm(i1, 1);               /* coefficient */
        r0 = BLK_CHAIN_A;
        r4 = pass r4;
        if eq jump (pc, .fxsrcd_C1_RTG_18);
        r6 = pass r6;
        if eq jump (pc, .fxsrc0_C1_RTG_18);
        r7 = 1;
        comp(r6, r7);
        if eq jump (pc, .fxsrc1_C1_RTG_18);
        r7 = 2;
        comp(r6, r7);
        if ne jump (pc, .fxsrcd_C1_RTG_18);
        r0 = BLK_TAP_PREFDR;
        jump (pc, .fxsrcd_C1_RTG_18);
    .fxsrc0_C1_RTG_18:
        r0 = BLK_TAP_TRIM;
        jump (pc, .fxsrcd_C1_RTG_18);
    .fxsrc1_C1_RTG_18:
...
#if DSP4_BLOCK_KERNELS
    l0 = 0;
    i0 = _rtg_mtx_on_C1_RTG_18;
    i4 = _rtg_mtx_send_C1_RTG_18;
    i5 = _rtg_mtx_send_step_C1_RTG_18;
    i6 = _rtg_mtx_send_frames_C1_RTG_18;
    i3 = _rtg_mtx_send_target_C1_RTG_18;
    i2 = _rtg_mtx_sq_C1_RTG_18;
    r5 = 2;
    lcntr = r5, do .mtxrmp_C1_RTG_18 until lce;
        r4 = dm(i6, 0);
        r6 = DSP4_BLOCK_SIZE;
        comp(r4, r6);
        if lt r6 = r4;                /* n = min(frames, BLOCK) */
...
#endif
        r4 = pass r6;
        if eq jump (pc, .mtxsnap_C1_RTG_18);
        f1 = dm(i4, 0);
        f2 = dm(i5, 0);
        f3 = float r6;
        f2 = f2 * f3;                 /* step * n */
     ...
     * coefficient is zero keep the default and are never read. */
    l1 = 0;
    i1 = _rtg_mtx_sq_C1_RTG_18;
    i5 = _rtg_mtx_pick_C1_RTG_18;
    i6 = _rtg_mtx_src_C1_RTG_18;
    r5 = 2;
    lcntr = r5, do .mtxsrc_C1_RTG_18 until lce;
        r6 = dm(i5, 1);               /* pickoff enum */
        r4 = dm(i1, 1);               /* coefficient */
        r0 = BLK_CHAIN_A;
        r4 = pass r4;
        if eq jump (pc, .mtxsrcd_C1_RTG_18);
        r6 = pass r6;
        if eq jump (pc, .mtxsrc0_C1_RTG_18);
        r7 = 1;
        comp(r6, r7);
        if eq jump (pc, .mtxsrc1_C1_RTG_18);
        r7 = 2;
        comp(r6, r7);
        if ne jump (pc, .mtxsrcd_C1_RTG_18);
        r0 = BLK_TAP_PREFDR;
        jump (pc, .mtxsrcd_C1_RTG_18);
    .mtxsrc0_C1_RTG_18:
        r0 = BLK_TAP_TRIM;
        jump (pc, .mtxsrcd_C1_RTG_18);
    .mtxsrc1_C1_RTG_18:
    ...
    i1 = _xpc + 17;                  /* this strip's column   */
    r1 = dm(_rtg_mlq_C1_RTG_18);
    dm(i1, m4) = r1;
    r1 = dm(_rtg_mrq_C1_RTG_18);
    dm(i1, m4) = r1;
    r1 = dm(_rtg_subq_C1_RTG_18);
    dm(i1, m4) = r1;
    i4 = _rtg_grpq_C1_RTG_18;
    lcntr = 4, do .xc_grp_C1_RTG_18 until lce;
        r1 = dm(i4, 1);
    .xc_grp_C1_RTG_18:
        dm(i1, m4) = r1;
    i0 = _rtg_list_C1_RTG_18;
    r10 = 0;                          /* residual crosspoints  */
    i4 = _rtg_aux_sq_C1_RTG_18;
    i5 = _rtg_aux_src_C1_RTG_18;
    i3 = _bus_acc_aux_ptrs;
    lcntr = 12, do .xc_aux_C1_RTG_18 until lce;
        r1 = dm(i4, 1);               /* coefficient       */
        r2 = dm(i5, 1);               /* resolved source   */
        r3 = dm(i3, 1);               /* bus accumulator   */
        comp(r2, r12);
        if eq jump (pc, .xc_auxd_C1_RTG_18);
        r1 = pass r1;
        if eq jump (pc, .xc_auxz_C1_RTG_18);
    ...
    i5 = _rtg_fx_src_C1_RTG_18;
    i3 = _bus_acc_fx_ptrs;
    lcntr = 6, do .xc_fx_C1_RTG_18 until lce;
        r1 = dm(i4, 1);               /* coefficient       */
        r2 = dm(i5, 1);               /* resolved source   */
        r3 = dm(i3, 1);               /* bus accumulator   */
        comp(r2, r12);
        if eq jump (pc, .xc_fxd_C1_RTG_18);
        r1 = pass r1;
        if eq jump (pc, .xc_fxz_C1_RTG_18);
        dm(i0, 1) = r2;               /* a tap, not the parked  */
        dm(i0, 1) = r3;               /* block: keep it sparse  */
        dm(i0, 1) = r1;
        r10 = r10 + 1;
    ...
    .xc_fx_C1_RTG_18:
        nop;
    i4 = _rtg_mtx_sq_C1_RTG_18;
    i5 = _rtg_mtx_src_C1_RTG_18;
    i3 = _bus_acc_mtx_ptrs;
    lcntr = 2, do .xc_mtx_C1_RTG_18 until lce;
        r1 = dm(i4, 1);               /* coefficient       */
        r2 = dm(i5, 1);               /* resolved source   */
        r3 = dm(i3, 1);               /* bus accumulator   */
        comp(r2, r12);
        if eq jump (pc, .xc_mtxd_C1_RTG_18);
        r1 = pass r1;
        if eq jump (pc, .xc_mtxz_C1_RTG_18);
        dm(i0, 1) = r2;               /* a tap, not the parked  */
        dm(i0, 1) = r3;               /* block: keep it sparse  */
        dm(i0, 1) = r1;
        r10 = r10 + 1;
...
#else
    r12 = _buf_C1_FDR_18;              /* post-fader mono word  */
#endif
    l0 = 0;
    l3 = 0;
    l4 = 0;
    ...
    r1 = dm(_rtg_mlq_C1_RTG_18);
    r1 = pass r1;
    if eq jump (pc, .lb_noml_C1_RTG_18);
    dm(i0, 1) = r12;
    r2 = _bus_acc_main_l;
    dm(i0, 1) = r2;
    dm(i0, 1) = r1;
...
.lb_noml_C1_RTG_18:
    r1 = dm(_rtg_mrq_C1_RTG_18);
    r1 = pass r1;
    if eq jump (pc, .lb_nomr_C1_RTG_18);
    dm(i0, 1) = r12;
    r2 = _bus_acc_main_r;
    dm(i0, 1) = r2;
    dm(i0, 1) = r1;
...
.lb_nomr_C1_RTG_18:
    r1 = dm(_rtg_subq_C1_RTG_18);
    r1 = pass r1;
    if eq jump (pc, .lb_nosub_C1_RTG_18);
    dm(i0, 1) = r12;
    r2 = _bus_acc_sub;
    dm(i0, 1) = r2;
    dm(i0, 1) = r1;
...
.lb_nosub_C1_RTG_18:
    ...
    lcntr = 4, do .lb_grp_C1_RTG_18 until lce;
        r1 = dm(i4, 1);
        r3 = dm(i3, 1);
        r1 = pass r1;
        if eq jump (pc, .lb_gskip_C1_RTG_18);
        dm(i0, 1) = r12;
        dm(i0, 1) = r3;
        dm(i0, 1) = r1;
        r10 = r10 + 1;
    ...
    i5 = _rtg_aux_src_C1_RTG_18;
    i3 = _bus_acc_aux_ptrs;
    lcntr = 12, do .lb_aux_C1_RTG_18 until lce;
        r1 = dm(i4, 1);
        r3 = dm(i3, 1);
        r2 = dm(i5, 1);
        r1 = pass r1;
        if eq jump (pc, .lb_askip_C1_RTG_18);
        dm(i0, 1) = r2;
        dm(i0, 1) = r3;
        dm(i0, 1) = r1;
        r10 = r10 + 1;
    ...
    i5 = _rtg_fx_src_C1_RTG_18;
    i3 = _bus_acc_fx_ptrs;
    lcntr = 6, do .lb_fx_C1_RTG_18 until lce;
        r1 = dm(i4, 1);
        r3 = dm(i3, 1);
        r2 = dm(i5, 1);
        r1 = pass r1;
        if eq jump (pc, .lb_fskip_C1_RTG_18);
        dm(i0, 1) = r2;
        dm(i0, 1) = r3;
        dm(i0, 1) = r1;
        r10 = r10 + 1;
...
i4 = _rtg_mtx_sq_C1_RTG_18;
    i5 = _rtg_mtx_src_C1_RTG_18;
    i3 = _bus_acc_mtx_ptrs;
    lcntr = 2, do .lb_mtx_C1_RTG_18 until lce;
        r1 = dm(i4, 1);
        r3 = dm(i3, 1);
        r2 = dm(i5, 1);
        r1 = pass r1;
        if eq jump (pc, .lb_mskip_C1_RTG_18);
        dm(i0, 1) = r2;
        dm(i0, 1) = r3;
        dm(i0, 1) = r1;
        r10 = r10 + 1;
...
.rtg_acc_C1_RTG_18:
    ...
    l1 = 0;
    i0 = BLK_CHAIN_A;
    i1 = _rtg_src + 17 * DSP4_BLOCK_SIZE;
    lcntr = DSP4_BLOCK_HALF, do .rtg_cp_C1_RTG_18 until lce;
        r0 = dm(i0, 1);
        r2 = dm(i0, 1);
        dm(i1, 1) = r0;
    .rtg_cp_C1_RTG_18:
    ...
    jump (pc, .rtg_tail_C1_RTG_18);
#endif
    r5 = dm(_rtg_n_C1_RTG_18);
    r5 = pass r5;
    if eq jump (pc, .rtg_tail_C1_RTG_18);
    l1 = 0;
    l2 = 0;
    l6 = 0;
    i6 = _rtg_list_C1_RTG_18;
    lcntr = r5, do .rtg_xp_C1_RTG_18 until lce;
        r6 = dm(i6, 1);               /* source            */

...
#include "lib/dyn_lut.h"
        ...
        /* SPI page=1 addr=3968 */

        .section/dm seg_dmda;
.extern _buf_C1_DLY_28;
.extern _sys_lcr_law;
        .global _fdr_level_C1_FDR_28;
        .var _fdr_level_C1_FDR_28 = 1.0;
        .global _fdr_level_target_C1_FDR_28;
        .var _fdr_level_target_C1_FDR_28 = 1.0;
        .global _fdr_level_step_C1_FDR_28;
        .var _fdr_level_step_C1_FDR_28 = 0.0;
        .global _fdr_level_frames_C1_FDR_28;
        .var _fdr_level_frames_C1_FDR_28 = 0;
        .global _fdr_pan_C1_FDR_28;
        .var _fdr_pan_C1_FDR_28 = 0.5;
        .global _fdr_pan_target_C1_FDR_28;
        .var _fdr_pan_target_C1_FDR_28 = 0.5;
        .global _fdr_pan_step_C1_FDR_28;
        .var _fdr_pan_step_C1_FDR_28 = 0.0;
        .global _fdr_pan_frames_C1_FDR_28;
        .var _fdr_pan_frames_C1_FDR_28 = 0;
        .global _fdr_mute_C1_FDR_28;
        .var _fdr_mute_C1_FDR_28 = 0;
        ...
        .global _fdr_gq_C1_FDR_28;
        .var _fdr_gq_C1_FDR_28 = 0x10000000;          /* Q4.28 level */
        ...
        .global _fdr_busy_C1_FDR_28;
        .global _fdr_busy_C1_FDR_28;
        .var _fdr_busy_C1_FDR_28 = 0;
        #endif

        .global _tap_post_fader_C1_FDR_28;
        .var _tap_post_fader_C1_FDR_28;
        .global _buf_C1_FDR_28;
        .var _buf_C1_FDR_28;
        .global _fdr_lq_C1_FDR_28;
        .var _fdr_lq_C1_FDR_28 = 0;
        .global _fdr_rq_C1_FDR_28;
        .var _fdr_rq_C1_FDR_28 = 0;
        .global _fdr_cq_C1_FDR_28;
        .var _fdr_cq_C1_FDR_28 = 0;
        .global _fdr_lcr_on_C1_FDR_28;
        .var _fdr_lcr_on_C1_FDR_28 = 0;
        .global _fdr_lcr_seen_C1_FDR_28;
        .var _fdr_lcr_seen_C1_FDR_28 = -1;
        ...
        _C1_FDR_28_process:
            ...
            r4 = dm(_fdr_level_frames_C1_FDR_28);
            r1 = dm(_fdr_pan_frames_C1_FDR_28);
            r1 = max(r1, r4);
            r5 = 0;
            r1 = max(r1, r5);
r4 = dm(_fdr_lcr_on_C1_FDR_28);
            r5 = dm(_sys_lcr_law);
            r4 = r4 + r4;
            r4 = r4 + r5;                     /* (LcrOn, law) as one word */
            r5 = dm(_fdr_lcr_seen_C1_FDR_28);
            comp(r4, r5);
            if eq jump (pc, .lcrsame_C1_FDR_28);
            dm(_fdr_lcr_seen_C1_FDR_28) = r4;
            r5 = DSP4_BLOCK_SIZE;
            r1 = max(r1, r5);
            .lcrsame_C1_FDR_28:
                        dm(_fdr_busy_C1_FDR_28) = r1;
        #endif
            ...
            r5 = DSP4_BLOCK_SIZE;
            r4 = r4 - r5;
            dm(_fdr_level_frames_C1_FDR_28) = r4;
            f1 = dm(_fdr_level_C1_FDR_28);
            f2 = dm(_fdr_level_step_C1_FDR_28);
            r5 = DSP4_BLOCK_F32;              /* BLOCK_SIZE as float */
            f5 = r5;
            f2 = f2 * f5;
            f1 = f1 + f2;
            dm(_fdr_level_C1_FDR_28) = f1;
            jump (pc, .pramp_C1_FDR_28);
        .lsnap_C1_FDR_28:
            f1 = dm(_fdr_level_target_C1_FDR_28);
            dm(_fdr_level_C1_FDR_28) = f1;
        .pramp_C1_FDR_28:
            /* pan ramp */
            r4 = dm(_fdr_pan_frames_C1_FDR_28);
            r1 = 0;
            comp(r4, r1);
            if le jump (pc, .psnap_C1_FDR_28);
            /* Consume a BLOCK's worth of frames and apply a BLOCK's
             * worth of step. spi_handler scales every profile frame count
             * by DSP4_BLOCK_SIZE, which is right for the ramps that
             * decrement once per SAMPLE. This one decrements once per
            ...
            r5 = DSP4_BLOCK_SIZE;
            r4 = r4 - r5;
            dm(_fdr_pan_frames_C1_FDR_28) = r4;
            f1 = dm(_fdr_pan_C1_FDR_28);
            f2 = dm(_fdr_pan_step_C1_FDR_28);
            r5 = DSP4_BLOCK_F32;              /* BLOCK_SIZE as float */
            f5 = r5;
            f2 = f2 * f5;
            f1 = f1 + f2;
            dm(_fdr_pan_C1_FDR_28) = f1;
            jump (pc, .cvt_C1_FDR_28);
        .psnap_C1_FDR_28:
            f1 = dm(_fdr_pan_target_C1_FDR_28);
            dm(_fdr_pan_C1_FDR_28) = f1;
        .cvt_C1_FDR_28:
            ...
            r3 = dm(_fdr_mute_C1_FDR_28);
            r4 = 0;
            comp(r3, r4);
            if ne r2 = r4;
            dm(_fdr_gq_C1_FDR_28) = r2;
    ...
    r0 = dm(_fdr_pan_C1_FDR_28);
    r1 = dm(_fdr_lcr_on_C1_FDR_28);
    call _pan_legs;
    dm(_fdr_lq_C1_FDR_28) = r0;
    dm(_fdr_cq_C1_FDR_28) = r1;
    dm(_fdr_rq_C1_FDR_28) = r2;
#else
    r2 = 0x3F800000;
    f2 = r2;
    f5 = dm(_fdr_pan_C1_FDR_28);
    f6 = f2 - f5;                     /* L gain = 1 - pan */
    r2 = 0x4D800000;
    f7 = r2;
    f6 = f6 * f7;
    r2 = fix f6;
    dm(_fdr_lq_C1_FDR_28) = r2;
    f5 = f5 * f7;
    r2 = fix f5;
    dm(_fdr_rq_C1_FDR_28) = r2;
    r2 = 0;
    dm(_fdr_cq_C1_FDR_28) = r2;
#endif
             ...
             * construction. */
            r14 = DSP4_BLOCK_HALF;
            lcntr = r14; do .fdr_lp_C1_FDR_28 until lce;
                r0 = dm(i0, 1);                 /* xA */
                r3 = dm(i0, 1);                 /* xB */
                mrf = r0 * r1 (ssi);
                mrb = r3 * r1 (ssi);
        ...
        .fdr_lp_C1_FDR_28:
                dm(i1, 1) = r3;
            dm(_tap_post_fader_C1_FDR_28) = r3;   /* linkage scalars */
            dm(_buf_C1_FDR_28) = r3;
            rts;
        #else
            r14 = DSP4_BLOCK_SIZE;
        .fdr_lp_C1_FDR_28:
            ...
            r13 = r0;
            r14 = r14 - 1;
            if gt jump (pc, .fdr_lp_C1_FDR_28);
            dm(_tap_post_fader_C1_FDR_28) = r13;  /* linkage scalars */
            dm(_buf_C1_FDR_28) = r13;
            rts;
        #endif
#else
        .apply_C1_FDR_28:
            ...
            r0 = dm(_buf_C1_DLY_28);
            r1 = dm(_fdr_gq_C1_FDR_28);
            mrf = r0 * r1 (ssi);
            call _mrf_rns28;

            dm(_tap_post_fader_C1_FDR_28) = r0;
            dm(_buf_C1_FDR_28) = r0;

            rts;
#endif
        _C1_FDR_28_process.end:

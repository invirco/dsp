...
.extern _sys_lcr_law;
        ...
        .global _fdr_cq_C1_FDR_14;
        .var _fdr_cq_C1_FDR_14 = 0;
        .global _fdr_lcr_on_C1_FDR_14;
        .var _fdr_lcr_on_C1_FDR_14 = 0;
        .global _fdr_lcr_seen_C1_FDR_14;
        .var _fdr_lcr_seen_C1_FDR_14 = -1;
        ...
        _C1_FDR_14_process:
            ...
            r5 = 0;
            r1 = max(r1, r5);
r4 = dm(_fdr_lcr_on_C1_FDR_14);
            r5 = dm(_sys_lcr_law);
            r4 = r4 + r4;
            r4 = r4 + r5;                     /* (LcrOn, law) as one word */
            r5 = dm(_fdr_lcr_seen_C1_FDR_14);
            comp(r4, r5);
            if eq jump (pc, .lcrsame_C1_FDR_14);
            dm(_fdr_lcr_seen_C1_FDR_14) = r4;
            r5 = DSP4_BLOCK_SIZE;
            r1 = max(r1, r5);
            .lcrsame_C1_FDR_14:
    ...
    r0 = dm(_fdr_pan_C1_FDR_14);
    r1 = dm(_fdr_lcr_on_C1_FDR_14);
    call _pan_legs;
    dm(_fdr_lq_C1_FDR_14) = r0;
    dm(_fdr_cq_C1_FDR_14) = r1;

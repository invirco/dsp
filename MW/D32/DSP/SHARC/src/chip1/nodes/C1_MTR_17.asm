...
#include "lib/dyn_lut.h"
        ...
        /* SPI page=1 addr=4672 */

        #include "blk_pool.h"

        .section/dm seg_dmda;
        /* ORDER IS LOAD-BEARING: _mtr_fold takes the address of
         * _mtr_peak_C1_MTR_17 and reaches the rest by offset. The three float
         * words keep their names and their SPI dispatch entries. */
        .global _mtr_peak_C1_MTR_17;
        .var _mtr_peak_C1_MTR_17 = 0.0;      /* +0 linear peak, host contract */
        .global _mtr_rms_C1_MTR_17;
        .var _mtr_rms_C1_MTR_17 = 0.0;       /* +1 linear TRUE rms            */
        .global _mtr_gr_C1_MTR_17;
        .var _mtr_gr_C1_MTR_17 = 0.0;        /* +2 gain reduction -- see below */
        .global _mtr_st_C1_MTR_17;
        .var _mtr_st_C1_MTR_17[4];           /* +3 pk_lo pk_hi ms_lo ms_hi     */
         ...
         * is state and not a sign extension. Filled by C1_GAIN_17 under block
         * kernels and by this node's own per-sample body otherwise. */
        .global _mtr_acc_C1_MTR_17;
        .var _mtr_acc_C1_MTR_17[5];          /* mx mn ssq_lo ssq_hi ssq_ex     */
        ...
        .global _mtr_cgr_C1_MTR_17;
        .var _mtr_cgr_C1_MTR_17 = 0.0;   /* comp gain reduction, dB */

        .section/pm seg_pmco;
        .extern _mtr_fold;
        .extern _mtr_load_fold;
        .extern _sample_idx;
        .extern _mtr_wide_C1_GAIN_17;
        .extern _comp_gain_C1_COMP_17;
        .extern _log2q_fx;
        .global _C1_MTR_17_process;
        _C1_MTR_17_process:
        #if DSP4_MTR_OFF
            ...
            comp(f0, f1);
            if lt r0 = r1;
            dm(_mtr_cgr_C1_MTR_17) = r0;
/* WIDE WORD, 'acc' shape. C1_GAIN_17 accumulated this block's peak,
 ...
 * two thousand left. */
r0 = _mtr_peak_C1_MTR_17;
r1 = _mtr_acc_C1_MTR_17;
call _mtr_load_fold;
rts;
             ...
             *
             * Source: _mtr_wide_C1_GAIN_17, the Q8.24 word C1_GAIN_17 publishes from its
             * product register before it rounds or saturates. */
            r0 = dm(_mtr_wide_C1_GAIN_17);
            r4 = dm(_sample_idx);
            r1 = 0;
            comp(r4, r1);
            if ne jump (pc, .mtacc_C1_MTR_17);
            ...
            dm(_mtr_cgr_C1_MTR_17) = r0;
            r0 = dm(_mtr_wide_C1_GAIN_17);
            dm(_mtr_acc_C1_MTR_17 + 0) = r0;
            dm(_mtr_acc_C1_MTR_17 + 1) = r0;
            mrf = 0;
            mrf = mrf + r0 * r0 (ssi);
            r2 = mr0f;
            dm(_mtr_acc_C1_MTR_17 + 2) = r2;
            r2 = mr1f;
            dm(_mtr_acc_C1_MTR_17 + 3) = r2;
            r2 = mr2f;
            dm(_mtr_acc_C1_MTR_17 + 4) = r2;
            rts;
        .mtacc_C1_MTR_17:
            r2 = dm(_mtr_acc_C1_MTR_17 + 0);
            r2 = max(r2, r0);
            dm(_mtr_acc_C1_MTR_17 + 0) = r2;
            r2 = dm(_mtr_acc_C1_MTR_17 + 1);
            r2 = min(r2, r0);
            dm(_mtr_acc_C1_MTR_17 + 1) = r2;
            r2 = dm(_mtr_acc_C1_MTR_17 + 2);
            mr0f = r2;
            r3 = dm(_mtr_acc_C1_MTR_17 + 3);
            mr1f = r3;
            r2 = dm(_mtr_acc_C1_MTR_17 + 4);
            mr2f = r2;
            mrf = mrf + r0 * r0 (ssi);
            r2 = mr0f;
            dm(_mtr_acc_C1_MTR_17 + 2) = r2;
            ...
            comp(r4, r1);
            if ne rts;
            r8 = dm(_mtr_acc_C1_MTR_17 + 0);
            r9 = dm(_mtr_acc_C1_MTR_17 + 1);
            r0 = _mtr_peak_C1_MTR_17;
            call _mtr_fold;
            rts;
        #endif
        _C1_MTR_17_process.end:

        /* _mtr_gr_C1_MTR_17 IS STILL NOT WRITTEN, and that is recorded defect

...
.var _mtr_acc_C1_MTR_17[4];          /* mx mn ssq_lo ssq_hi            */
#endif
...
_C1_MTR_17_process:
     ...
     *
     * Source: BLK_TAP_TRIM_P1, the block C1_GAIN_17 publishes.
    ...
    l2 = 0;
    m2 = 1;
    i2 = BLK_TAP_TRIM_P1;          /* C1_GAIN_17 publishes its block here */
    r8 = 0x80000000;              /* running max: most negative */
    r9 = 0x7FFFFFFF;              /* running min: most positive */
    mrf = 0;
    lcntr = DSP4_BLOCK_SIZE, do .mtrk_C1_MTR_17 until lce;
        r0 = dm(i2, m2);
        r8 = max(r8, r0);
        mrf = mrf + r0 * r0 (ssi);
    .mtrk_C1_MTR_17:

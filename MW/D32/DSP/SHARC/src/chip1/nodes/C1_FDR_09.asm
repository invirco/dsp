...
.extern _sys_lcr_law;
        ...
        .var _fdr_gq_C1_FDR_09 = 0x10000000;          /* Q4.28 level */
        ...
        .global _fdr_busy_C1_FDR_09;
        .global _fdr_busy_C1_FDR_09;
        .var _fdr_busy_C1_FDR_09 = 0;
        #endif
        ...
        .global _fdr_cq_C1_FDR_09;
        .var _fdr_cq_C1_FDR_09 = 0;
        .global _fdr_lcr_on_C1_FDR_09;
        .var _fdr_lcr_on_C1_FDR_09 = 0;
        .global _fdr_lcr_seen_C1_FDR_09;
        .var _fdr_lcr_seen_C1_FDR_09 = -1;
        ...
        _C1_FDR_09_process:
            ...
            r1 = dm(_fdr_pan_frames_C1_FDR_09);
            r1 = max(r1, r4);
            r5 = 0;
            r1 = max(r1, r5);
r4 = dm(_fdr_lcr_on_C1_FDR_09);
            r5 = dm(_sys_lcr_law);
            r4 = r4 + r4;
            r4 = r4 + r5;                     /* (LcrOn, law) as one word */
            r5 = dm(_fdr_lcr_seen_C1_FDR_09);
            comp(r4, r5);
            if eq jump (pc, .lcrsame_C1_FDR_09);
            dm(_fdr_lcr_seen_C1_FDR_09) = r4;
            r5 = DSP4_BLOCK_SIZE;
            r1 = max(r1, r5);
            .lcrsame_C1_FDR_09:
                        dm(_fdr_busy_C1_FDR_09) = r1;
        #endif
    ...
    r0 = dm(_fdr_pan_C1_FDR_09);
    r1 = dm(_fdr_lcr_on_C1_FDR_09);
    call _pan_legs;
    dm(_fdr_lq_C1_FDR_09) = r0;
    dm(_fdr_cq_C1_FDR_09) = r1;

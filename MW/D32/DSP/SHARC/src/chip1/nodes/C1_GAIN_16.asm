 ...
 * C1_MTR_16. The block path never stores it -- it hands
 * the finished accumulators over instead. */
.global _mtr_wide_C1_GAIN_16;
.var _mtr_wide_C1_GAIN_16;
...
.cvt_C1_GAIN_16:
    ...
    call _gsimd_enter;
    lcntr = DSP4_BLOCK_HALF, do .gk_lp_C1_GAIN_16 until lce;
...
.gk_lp_C1_GAIN_16:
        dm(i4, 1) = r3;
    dm(_tap_post_trim_C1_GAIN_16) = r3;   /* linkage scalars */
    dm(_buf_C1_GAIN_16) = r3;
    rts;
#else
    r5 = DSP4_BLOCK_SIZE;
    lcntr = r5; do .gk_lp_C1_GAIN_16 until lce;

/*----------------------------------------------------------------------
 * Matrix 1 Bus (MIX_BUS)
 * Node ID:    C1_BUS_MTX_01
 * Chip:       1
 * Channels:   1
 * SPI Page:   1
 * SPI Addr:   4798
...
/* MIX_BUS (FIXED, D5): bus_id=37 — exact 64-bit acc readout */

#include "blk_pool.h"

.section/dm seg_dmda;
#if DSP4_BLOCK_KERNELS
.global _buf_C1_BUS_MTX_01;
.var _buf_C1_BUS_MTX_01[DSP4_BLOCK_SIZE];
#else
.global _buf_C1_BUS_MTX_01;
.var _buf_C1_BUS_MTX_01;
#endif

.section/pm seg_pmco;
.extern _bus_acc_mtx_01;
.extern _acc64_rns28;
.global _C1_BUS_MTX_01_process;
_C1_BUS_MTX_01_process:
#if DSP4_BLOCK_KERNELS
    ...
    l3 = 0;
    i2 = _bus_acc_mtx_01;
    i3 = _buf_C1_BUS_MTX_01;
    r8 = 0x08000000;          /* 2^27, the rounding half */
    r9 = 1;
    r10 = 0x7FFFFFFF;
    lcntr = DSP4_BLOCK_SIZE, do .mbk_C1_BUS_MTX_01 until lce;
        r1 = dm(i2, 1);       /* lo; i2 -> hi              */
        mr0f = r1;
        r2 = dm(i2, 1);       /* hi; i2 -> ex              */
        mr1f = r2;
        ...
        r3 = pass r3;
        if ne r0 = r11;
    .mbk_C1_BUS_MTX_01: dm(i3, 1) = r0;
    rts;
#else
    i2 = _bus_acc_mtx_01;
    call _acc64_rns28;
    dm(_buf_C1_BUS_MTX_01) = r0;
    rts;
#endif
_C1_BUS_MTX_01_process.end:

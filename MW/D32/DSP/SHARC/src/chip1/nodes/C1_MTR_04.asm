...
.var _mtr_peak_C1_MTR_04 = 0.0;
.global _mtr_rms_C1_MTR_04;
.var _mtr_rms_C1_MTR_04 = 0.0;
.global _mtr_gr_C1_MTR_04;
.var _mtr_gr_C1_MTR_04 = 0.0;         /* gain reduction (gate or comp) */
...
_C1_MTR_04_process:
    ...
    lcntr = DSP4_BLOCK_SIZE, do .mtrk_C1_MTR_04 until lce;
        r0 = dm(i2, 1);
        f0 = abs f0;
        f1 = dm(_mtr_peak_C1_MTR_04);
        comp(f0, f1);
        if le jump (pc, .mtrd_C1_MTR_04);
        dm(_mtr_peak_C1_MTR_04) = f0;
        jump (pc, .mtrk_C1_MTR_04);
    .mtrd_C1_MTR_04:
        f1 = f1 * f2;                     /* peak *= 0.9995 */
        dm(_mtr_peak_C1_MTR_04) = f1;
        f3 = dm(_mtr_rms_C1_MTR_04);
        f4 = f0 * f0;                     /* x^2 */
        f6 = f4 - f3;
        f6 = f5 * f6;
        f3 = f3 + f6;
        dm(_mtr_rms_C1_MTR_04) = f3;
    .mtrk_C1_MTR_04:
        nop;
    rts;
#else
    ...
    f1 = dm(_mtr_peak_C1_MTR_04);
    comp(f0, f1);
    if le jump (pc, .mtr_decay_C1_MTR_04);
    dm(_mtr_peak_C1_MTR_04) = f0;
    rts;
.mtr_decay_C1_MTR_04:

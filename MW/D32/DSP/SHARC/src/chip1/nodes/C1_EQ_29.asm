...
.var _eq_coeffs_A_C1_EQ_29[20] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#elif DSP4_BQ_GUARD
.global _eq_coeffs_A_C1_EQ_29;
.var _eq_coeffs_A_C1_EQ_29[20 + 1] = 0, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#else
.global _eq_coeffs_A_C1_EQ_29;
.var _eq_coeffs_A_C1_EQ_29[20] = 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#endif
.global _eq_state_A_C1_EQ_29;
.var _eq_state_A_C1_EQ_29[24];
#if DSP4_BQ_FLOAT
.global _eq_coeffs_B_C1_EQ_29;
.var _eq_coeffs_B_C1_EQ_29[20] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#elif DSP4_BQ_GUARD
.global _eq_coeffs_B_C1_EQ_29;
.var _eq_coeffs_B_C1_EQ_29[20 + 1] = 0, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#else
.global _eq_coeffs_B_C1_EQ_29;
.var _eq_coeffs_B_C1_EQ_29[20] = 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#endif
...
.var _eq_coeffs_next_C1_EQ_29[20] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#else
.global _eq_coeffs_next_C1_EQ_29;
...
#if DSP4_BQ_GUARD
.global _eq_hrw_C1_EQ_29;
.var _eq_hrw_C1_EQ_29 = 0;        /* 0 idle, 1 asked, 2 re-ask */
.global _eq_hrl_C1_EQ_29;
.var _eq_hrl_C1_EQ_29[2];       /* (block, stages) pairs */
#endif
...
_C1_EQ_29_process:
    ...
    r5 = dm(_eq_xfade_step_C1_EQ_29);
    r4 = r4 or r5;
#if DSP4_BQ_GUARD
    r5 = dm(_eq_hrw_C1_EQ_29);
    r4 = r4 or r5;      /* a sizing in flight is a transient too */
#endif
    r4 = pass r4;
    if eq jump (pc, .ekb_ss_C1_EQ_29);
    ...
    i4 = BLK_CHAIN_B_P1;
    i5 = BLK_TAP_EQ_P1;
    lcntr = DSP4_BLOCK_SIZE, do .ekb_xl_C1_EQ_29 until lce;
        r0 = dm(i3, 1);
        dm(_buf_C1_FILT_29) = r0;
        call _C1_EQ_29_process_sample;
        r0 = dm(_buf_C1_EQ_29);
        dm(i5, 1) = r0;         /* tap carries the block too */
    .ekb_xl_C1_EQ_29: dm(i4, 1) = r0;
    rts;
...
.ekb_ss_C1_EQ_29:
    ...
    r4 = pass r4;
    if ne jump (pc, .ekb_b_C1_EQ_29);
    i0 = _eq_coeffs_A_C1_EQ_29;
    i1 = _eq_state_A_C1_EQ_29;
    jump (pc, .ekb_go_C1_EQ_29);
.ekb_b_C1_EQ_29:
...
.ekb_go_C1_EQ_29:
    ...
    i3 = BLK_CHAIN_B_P1;
    i4 = BLK_TAP_EQ_P1;
    lcntr = DSP4_BLOCK_SIZE, do .ekb_tp_C1_EQ_29 until lce;
        r0 = dm(i3, 1);
    .ekb_tp_C1_EQ_29: dm(i4, 1) = r0;
    rts;

.global _C1_EQ_29_process_sample;
_C1_EQ_29_process_sample:
#endif
...
_eq_start_xfade_C1_EQ_29:
    ...
    r0 = _eq_hrw_C1_EQ_29;
    r1 = _eq_hrl_C1_EQ_29;
    r2 = _eq_active_C1_EQ_29;
    r3 = _eq_coeffs_A_C1_EQ_29;
    r4 = _eq_coeffs_B_C1_EQ_29;
    r5 = _eq_state_A_C1_EQ_29;
    r6 = _eq_state_B_C1_EQ_29;
    r7 = _eq_coeffs_next_C1_EQ_29;
    r8 = 4;

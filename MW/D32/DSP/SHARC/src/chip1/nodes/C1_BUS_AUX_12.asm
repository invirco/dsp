...
/* MIX_BUS (FIXED, D5): bus_id=18 — exact 64-bit acc readout */
...
.var _buf_C1_BUS_AUX_12[DSP4_BLOCK_SIZE];
#else
.global _buf_C1_BUS_AUX_12;
...
_C1_BUS_AUX_12_process:
    ...
    l3 = 0;
    i2 = _bus_acc_aux_12;
    i3 = _buf_C1_BUS_AUX_12;
    r8 = 0x08000000;          /* 2^27, the rounding half */
    r9 = 1;
    r10 = 0x7FFFFFFF;
    lcntr = DSP4_BLOCK_SIZE, do .mbk_C1_BUS_AUX_12 until lce;
        r1 = dm(i2, 1);       /* lo; i2 -> hi              */
        ...
        comp(r1, r3);
        if ne r0 = r11;
    .mbk_C1_BUS_AUX_12: dm(i3, 1) = r0;
    rts;
#else
    i2 = _bus_acc_aux_12;
    call _acc64_rns28;
    dm(_buf_C1_BUS_AUX_12) = r0;
    rts;
#endif

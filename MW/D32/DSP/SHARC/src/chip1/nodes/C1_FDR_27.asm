...
.extern _sys_lcr_law;
        ...
        .var _fdr_gq_C1_FDR_27 = 0x10000000;          /* Q4.28 level */
        ...
        .global _fdr_busy_C1_FDR_27;
        .global _fdr_busy_C1_FDR_27;
        .var _fdr_busy_C1_FDR_27 = 0;
        #endif
        ...
        .global _fdr_cq_C1_FDR_27;
        .var _fdr_cq_C1_FDR_27 = 0;
        .global _fdr_lcr_on_C1_FDR_27;
        .var _fdr_lcr_on_C1_FDR_27 = 0;
        .global _fdr_lcr_seen_C1_FDR_27;
        .var _fdr_lcr_seen_C1_FDR_27 = -1;
        ...
        _C1_FDR_27_process:
            ...
            r1 = dm(_fdr_pan_frames_C1_FDR_27);
            r1 = max(r1, r4);
            r5 = 0;
            r1 = max(r1, r5);
r4 = dm(_fdr_lcr_on_C1_FDR_27);
            r5 = dm(_sys_lcr_law);
            r4 = r4 + r4;
            r4 = r4 + r5;                     /* (LcrOn, law) as one word */
            r5 = dm(_fdr_lcr_seen_C1_FDR_27);
            comp(r4, r5);
            if eq jump (pc, .lcrsame_C1_FDR_27);
            dm(_fdr_lcr_seen_C1_FDR_27) = r4;
            r5 = DSP4_BLOCK_SIZE;
            r1 = max(r1, r5);
            .lcrsame_C1_FDR_27:
                        dm(_fdr_busy_C1_FDR_27) = r1;
        #endif
    ...
    r0 = dm(_fdr_pan_C1_FDR_27);
    r1 = dm(_fdr_lcr_on_C1_FDR_27);
    call _pan_legs;
    dm(_fdr_lq_C1_FDR_27) = r0;
    dm(_fdr_cq_C1_FDR_27) = r1;
    ...
    dm(_fdr_cq_C1_FDR_27) = r2;
             ...
             * construction. */
            r14 = DSP4_BLOCK_HALF;
            lcntr = r14; do .fdr_lp_C1_FDR_27 until lce;
                r0 = dm(i0, 1);                 /* xA */
                r3 = dm(i0, 1);                 /* xB */
                mrf = r0 * r1 (ssi);
                mrb = r3 * r1 (ssi);
        ...
        .fdr_lp_C1_FDR_27:
                dm(i1, 1) = r3;
            dm(_tap_post_fader_C1_FDR_27) = r3;   /* linkage scalars */
            dm(_buf_C1_FDR_27) = r3;
            rts;
        #else
            r14 = DSP4_BLOCK_SIZE;
        .fdr_lp_C1_FDR_27:
            ...
            r13 = r0;
            r14 = r14 - 1;
            if gt jump (pc, .fdr_lp_C1_FDR_27);
            dm(_tap_post_fader_C1_FDR_27) = r13;  /* linkage scalars */
            dm(_buf_C1_FDR_27) = r13;
            rts;
        #endif
#else
        .apply_C1_FDR_27:

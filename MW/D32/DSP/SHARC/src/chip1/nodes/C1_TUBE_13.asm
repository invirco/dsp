...
.global _tube_on_C1_TUBE_13;
.var _tube_on_C1_TUBE_13 = 0;
.global _tube_sat_C1_TUBE_13;
.var _tube_sat_C1_TUBE_13 = 0.0;
.global _tube_sat_target_C1_TUBE_13;
.var _tube_sat_target_C1_TUBE_13 = 0.0;
.global _tube_sat_step_C1_TUBE_13;
.var _tube_sat_step_C1_TUBE_13 = 0.0;
.global _tube_sat_frames_C1_TUBE_13;
.var _tube_sat_frames_C1_TUBE_13 = 0;
.global _buf_C1_TUBE_13;
.var _buf_C1_TUBE_13;
...
_C1_TUBE_13_process:
    ...
    i3 = BLK_CHAIN_B_P1;
    i4 = BLK_CHAIN_A_P1;
    i7 = _tube_on_C1_TUBE_13;
    l7 = 0;
    i5 = _buf_C1_COMP_13;
    l5 = 0;
    jump _shk_tube_blk;
_C1_TUBE_13_process.end:
.global _C1_TUBE_13_process_sample;
_C1_TUBE_13_process_sample:
    i7 = _tube_on_C1_TUBE_13;
    l7 = 0;
    i5 = _buf_C1_COMP_13;
    l5 = 0;
    jump _shk_tube_smp;
_C1_TUBE_13_process_sample.end:
#else
.global _C1_TUBE_13_process;
_C1_TUBE_13_process:
    ...
    r2 = pass r2;
    if eq jump (pc, .tkb_copy_C1_TUBE_13);
    r4 = dm(_tube_sat_frames_C1_TUBE_13);
    r5 = 1;
    r4 = r4 - r5;
    if gt jump (pc, .tkb_ref_C1_TUBE_13);     /* ramping */

    f3 = dm(_tube_sat_target_C1_TUBE_13);
    ...
    lcntr = DSP4_BLOCK_SIZE, do .tkb_lp_C1_TUBE_13 until lce;
        r8 = dm(i3, 1);
        mrf = r8 * r8 (ssi);
        call _mrf_rns28;
        r10 = 0x10000000;
        ...
        nop;
        nop;
    .tkb_lp_C1_TUBE_13: dm(i4, 1) = r0;
    rts;

.tkb_copy_C1_TUBE_13:
    lcntr = DSP4_BLOCK_SIZE, do .tkb_cp_C1_TUBE_13 until lce;
        r0 = dm(i3, 1);
    .tkb_cp_C1_TUBE_13: dm(i4, 1) = r0;
    rts;

.tkb_ref_C1_TUBE_13:
    lcntr = DSP4_BLOCK_SIZE, do .tkb_rl_C1_TUBE_13 until lce;
        r0 = dm(i3, 1);
        dm(_buf_C1_COMP_13) = r0;
        call _C1_TUBE_13_process_sample;
        r0 = dm(_buf_C1_TUBE_13);
    .tkb_rl_C1_TUBE_13: dm(i4, 1) = r0;
    rts;
...
_C1_TUBE_13_process_sample:
    ...
    r15 = 1;
    r4 = r4 - r15;
    if le jump (pc, .no_tramp_C1_TUBE_13);
    dm(_tube_sat_frames_C1_TUBE_13) = r4;
    f3 = dm(_tube_sat_C1_TUBE_13);
    f2 = dm(_tube_sat_step_C1_TUBE_13);
    f3 = f3 + f2;
    dm(_tube_sat_C1_TUBE_13) = f3;
    jump (pc, .tube_go_C1_TUBE_13);
.no_tramp_C1_TUBE_13:
    f3 = dm(_tube_sat_target_C1_TUBE_13);
    dm(_tube_sat_C1_TUBE_13) = f3;
.tube_go_C1_TUBE_13:

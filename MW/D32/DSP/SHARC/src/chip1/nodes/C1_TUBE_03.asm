...
.var _tube_on_C1_TUBE_03 = 0;
.global _tube_sat_C1_TUBE_03;
.var _tube_sat_C1_TUBE_03 = 0.0;
.global _tube_sat_target_C1_TUBE_03;
.var _tube_sat_target_C1_TUBE_03 = 0.0;
.global _tube_sat_step_C1_TUBE_03;
.var _tube_sat_step_C1_TUBE_03 = 0.0;
.global _tube_sat_frames_C1_TUBE_03;
.var _tube_sat_frames_C1_TUBE_03 = 0;
.global _buf_C1_TUBE_03;
.var _buf_C1_TUBE_03;
...
_C1_TUBE_03_process:
    ...
    i3 = BLK_CHAIN_B_P1;
    i4 = BLK_CHAIN_A_P1;
    i7 = _tube_on_C1_TUBE_03;
    l7 = 0;
    i5 = _buf_C1_COMP_03;
    l5 = 0;
    jump _shk_tube_blk;
_C1_TUBE_03_process.end:
...
_C1_TUBE_03_process_sample:
    ...
    l5 = 0;
    jump _shk_tube_smp;
_C1_TUBE_03_process_sample.end:
#else
.global _C1_TUBE_03_process;
_C1_TUBE_03_process:
    ...
    lcntr = DSP4_BLOCK_SIZE, do .tkb_lp_C1_TUBE_03 until lce;
        r8 = dm(i3, 1);
        mrf = r8 * r8 (ssi);
        call _mrf_rns28;
        r10 = 0x10000000;
...
.tkb_copy_C1_TUBE_03:
    lcntr = DSP4_BLOCK_SIZE, do .tkb_cp_C1_TUBE_03 until lce;
        r0 = dm(i3, 1);
    .tkb_cp_C1_TUBE_03: dm(i4, 1) = r0;
    rts;

.tkb_ref_C1_TUBE_03:
    lcntr = DSP4_BLOCK_SIZE, do .tkb_rl_C1_TUBE_03 until lce;
        r0 = dm(i3, 1);
...
_C1_TUBE_03_process_sample:
    ...
    r15 = 1;
    r4 = r4 - r15;
    if le jump (pc, .no_tramp_C1_TUBE_03);
    dm(_tube_sat_frames_C1_TUBE_03) = r4;
    f3 = dm(_tube_sat_C1_TUBE_03);
    f2 = dm(_tube_sat_step_C1_TUBE_03);
    f3 = f3 + f2;
    dm(_tube_sat_C1_TUBE_03) = f3;
    jump (pc, .tube_go_C1_TUBE_03);
.no_tramp_C1_TUBE_03:
    f3 = dm(_tube_sat_target_C1_TUBE_03);
    dm(_tube_sat_C1_TUBE_03) = f3;
.tube_go_C1_TUBE_03:
    ...
    r2 = dm(_tube_on_C1_TUBE_03);
    r2 = pass r2;
    if eq jump (pc, .tube_bypass_C1_TUBE_03);
    ...
    mrf = r8 * r10 (ssi);
    call _mrf_rns28;              /* y */
    jump (pc, .tube_out_C1_TUBE_03);
.tube_bypass_C1_TUBE_03:
    nop;
.tube_out_C1_TUBE_03:
    dm(_buf_C1_TUBE_03) = r0;
    rts;
_C1_TUBE_03_process.end:
#endif

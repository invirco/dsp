...
.var _filt_hpf_A_C1_FILT_17[5] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#elif DSP4_BQ_GUARD
.global _filt_hpf_A_C1_FILT_17;
.var _filt_hpf_A_C1_FILT_17[5 + 1] = 0, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#else
.global _filt_hpf_A_C1_FILT_17;
...
.var _filt_lpf_A_C1_FILT_17[5] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#else
.global _filt_lpf_A_C1_FILT_17;
...
.var _filt_hpf_B_C1_FILT_17[5] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#elif DSP4_BQ_GUARD
.global _filt_hpf_B_C1_FILT_17;
.var _filt_hpf_B_C1_FILT_17[5 + 1] = 0, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#else
.global _filt_hpf_B_C1_FILT_17;
...
.var _filt_lpf_B_C1_FILT_17[5] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#else
.global _filt_lpf_B_C1_FILT_17;
...
.var _hpf_coeffs_next_C1_FILT_17[5] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#else
.global _hpf_coeffs_next_C1_FILT_17;
...
.var _lpf_coeffs_next_C1_FILT_17[5] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#else
.global _lpf_coeffs_next_C1_FILT_17;
...
#if DSP4_BQ_GUARD
.global _filt_hrw_C1_FILT_17;
.var _filt_hrw_C1_FILT_17 = 0;        /* 0 idle, 1 asked, 2 re-ask */
.global _filt_hrl_C1_FILT_17;
.var _filt_hrl_C1_FILT_17[2];       /* (block, stages) pairs */
#endif
...
_C1_FILT_17_process_sample:
    ...
    l5 = 0;
    jump _shk_filt_smp;
_C1_FILT_17_process_sample.end:
#else
.global _C1_FILT_17_process;
_C1_FILT_17_process:
...
#if DSP4_BQ_GUARD
    r4 = dm(_filt_hrw_C1_FILT_17);
    r4 = pass r4;
    if ne jump (pc, .filt_hrp_C1_FILT_17);   /* already converted */
#endif
...
.filt_nolpf_C1_FILT_17:
    #if DSP4_BQ_GUARD
    .filt_hrp_C1_FILT_17:      /* re-entry: converted, still asking */
    r0 = _filt_hrw_C1_FILT_17;
    r1 = _filt_hrl_C1_FILT_17;
    r2 = _filt_active_C1_FILT_17;
    r3 = _filt_hpf_A_C1_FILT_17;
    r4 = _filt_hpf_B_C1_FILT_17;
    r5 = 2;
    call _bq_hr_ask;
    r0 = pass r0;

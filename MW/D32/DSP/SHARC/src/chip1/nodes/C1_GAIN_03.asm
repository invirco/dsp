 ...
 * C1_MTR_03. The block path never stores it -- it hands
 * the finished accumulators over instead. */
.global _mtr_wide_C1_GAIN_03;
.var _mtr_wide_C1_GAIN_03;
...
.cvt_C1_GAIN_03:
    ...
    call _gsimd_enter;
    lcntr = DSP4_BLOCK_HALF, do .gk_lp_C1_GAIN_03 until lce;
...
.gk_lp_C1_GAIN_03:
     ...
     * put the PEx copy here and the PEy copy in _buf_C1_GAIN_03. */
    modify(i1, -1);
    r0 = dm(i1, 0);
...
.gk_lp_C1_GAIN_03:
     ...
     * mic-pre tap the D20 ruling keeps GAIN a separate node for. */
    i4 = BLK_TAP_TRIM_P1;
    r0 = _mtr_acc_C1_MTR_03;
    call _gsimd_gain_blk;
    /* The linkage scalars carry the LAST sample of the block, and
     * PEy computed it. Read it back out of the block rather than
     * out of a register: a direct store with PEYEN still up would
     * have put the PEx copy here and the PEy copy in _buf_C1_GAIN_03.

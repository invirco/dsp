...
#include "lib/dyn_lut.h"
         ...
         * is state and not a sign extension. Filled by C1_GAIN_19 under block
         * kernels and by this node's own per-sample body otherwise. */
        .global _mtr_acc_C1_MTR_19;
        .var _mtr_acc_C1_MTR_19[5];          /* mx mn ssq_lo ssq_hi ssq_ex     */
        ...
        .global _mtr_cgr_C1_MTR_19;
        .var _mtr_cgr_C1_MTR_19 = 0.0;   /* comp gain reduction, dB */

        .section/pm seg_pmco;
        .extern _mtr_fold;
        .extern _mtr_load_fold;
        .extern _sample_idx;
        .extern _mtr_wide_C1_GAIN_19;
        ...
        _C1_MTR_19_process:
            ...
            comp(f0, f1);
            if lt r0 = r1;
            dm(_mtr_cgr_C1_MTR_19) = r0;
/* WIDE WORD, 'acc' shape. C1_GAIN_19 accumulated this block's peak,
...
rts;
             ...
             *
             * Source: _mtr_wide_C1_GAIN_19, the Q8.24 word C1_GAIN_19 publishes from its
             * product register before it rounds or saturates. */
            r0 = dm(_mtr_wide_C1_GAIN_19);
            r4 = dm(_sample_idx);
            r1 = 0;
            comp(r4, r1);

...
.global _rx_slot_C1_IN_23;
.var _rx_slot_C1_IN_23;
#if DSP4_BLOCK_KERNELS
/* *** `_buf_C1_IN_23` IS NOT A BUFFER IN THIS BUILD. ***
...
_C1_IN_23_process:
    ...
    lcntr = r5; do .in_sig_C1_IN_23 until lce;
...
#endif
    r5 = DSP4_BLOCK_SIZE;
    lcntr = r5; do .in_lp_C1_IN_23 until lce;
        r2 = dm(i0, m0);
        r2 = ashift r2 by -3;
        dm(i1, 1) = r2;
.in_lp_C1_IN_23:

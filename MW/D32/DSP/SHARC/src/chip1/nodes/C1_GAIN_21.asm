...
/* SPI page=1 addr=2880 */

#include "blk_pool.h"

.section/dm seg_dmda;
.extern _buf_C1_IN_21;
.global _gain_coeff_C1_GAIN_21;
.var _gain_coeff_C1_GAIN_21 = 1.0;            /* FLOAT (ramped) */
.global _gain_target_C1_GAIN_21;
.var _gain_target_C1_GAIN_21 = 1.0;
.global _gain_step_C1_GAIN_21;
.var _gain_step_C1_GAIN_21 = 0.0;
.global _gain_frames_C1_GAIN_21;
.var _gain_frames_C1_GAIN_21 = 0;
.global _gain_q_C1_GAIN_21;
.var _gain_q_C1_GAIN_21 = 0x10000000;          /* Q4.28 shadow */
.global _mute_C1_GAIN_21;
.var _mute_C1_GAIN_21 = 0;
.global _polarity_C1_GAIN_21;
.var _polarity_C1_GAIN_21 = 0;
.global _tap_post_trim_C1_GAIN_21;
.var _tap_post_trim_C1_GAIN_21;
 ...
 * sample of the block. */
.global _buf_C1_GAIN_21;
.var _buf_C1_GAIN_21;
/* The Q8.24 word the PER-SAMPLE path publishes for
 * C1_MTR_21. The block path never stores it -- it hands
 * the finished accumulators over instead. */
.global _mtr_wide_C1_GAIN_21;
.var _mtr_wide_C1_GAIN_21;
...
#endif
.extern _mtr_acc_C1_MTR_21;
.extern _mtr_flush;
.global _C1_GAIN_21_process;
_C1_GAIN_21_process:
    ...
    r1 = 0;
    comp(r4, r1);
    if ne jump (pc, .apply_C1_GAIN_21);
#endif

    r4 = dm(_gain_frames_C1_GAIN_21);
    r1 = 0;
    comp(r4, r1);
    if le jump (pc, .snap_C1_GAIN_21);
    ...
    r5 = DSP4_BLOCK_SIZE;
    r4 = r4 - r5;
    dm(_gain_frames_C1_GAIN_21) = r4;
    f1 = dm(_gain_coeff_C1_GAIN_21);
    f2 = dm(_gain_step_C1_GAIN_21);
    r5 = DSP4_BLOCK_F32;              /* BLOCK_SIZE as float */
    f5 = r5;
    f2 = f2 * f5;
    f1 = f1 + f2;
    dm(_gain_coeff_C1_GAIN_21) = f1;
    jump (pc, .cvt_C1_GAIN_21);
.snap_C1_GAIN_21:
    f1 = dm(_gain_target_C1_GAIN_21);
    dm(_gain_coeff_C1_GAIN_21) = f1;
.cvt_C1_GAIN_21:
    ...
    r3 = dm(_polarity_C1_GAIN_21);
    r4 = 0;
    comp(r3, r4);
    if ne r1 = -r1;
    r2 = dm(_mute_C1_GAIN_21);
    comp(r2, r4);
    if ne r1 = r4;
    dm(_gain_q_C1_GAIN_21) = r1;
    ...
    call _gsimd_enter;
    lcntr = DSP4_BLOCK_HALF, do .gk_lp_C1_GAIN_21 until lce;
...
.gk_lp_C1_GAIN_21:
     ...
     * put the PEx copy here and the PEy copy in _buf_C1_GAIN_21. */
    modify(i1, -1);
    r0 = dm(i1, 0);
    dm(_tap_post_trim_C1_GAIN_21) = r0;   /* linkage scalars */
     ...
     * on stale flags. */
    r5 = DSP4_BLOCK_HALF;
    lcntr = r5; do .gk_lp_C1_GAIN_21 until lce;
        r0 = dm(i0, 1);                   /* xA */
        r3 = dm(i0, 1);                   /* xB */
        mrf = r0 * r1 (ssi);
        mrb = r3 * r1 (ssi);
...
.gk_lp_C1_GAIN_21:
        dm(i4, 1) = r3;
    dm(_tap_post_trim_C1_GAIN_21) = r3;   /* linkage scalars */
    dm(_buf_C1_GAIN_21) = r3;
    rts;
#else
    r5 = DSP4_BLOCK_SIZE;
    lcntr = r5; do .gk_lp_C1_GAIN_21 until lce;
...
.gk_lp_C1_GAIN_21:
     ...
     * mic-pre tap the D20 ruling keeps GAIN a separate node for. */
    i4 = BLK_TAP_TRIM_P1;
    r0 = _mtr_acc_C1_MTR_21;
    call _gsimd_gain_blk;
    /* The linkage scalars carry the LAST sample of the block, and
     * PEy computed it. Read it back out of the block rather than
     * out of a register: a direct store with PEYEN still up would
     * have put the PEx copy here and the PEy copy in _buf_C1_GAIN_21.
...
.apply_C1_GAIN_21:
    ...
    r0 = dm(_buf_C1_IN_21);
    r1 = dm(_gain_q_C1_GAIN_21);
    mrf = r0 * r1 (ssi);
    r12 = mr1f;                           /* WIDE post-trim, Q8.24 */
    dm(_mtr_wide_C1_GAIN_21) = r12;
    call _mrf_rns28;                      /* r0 = sat(rns(x*g,28)) */

    dm(_tap_post_trim_C1_GAIN_21) = r0;
    dm(_buf_C1_GAIN_21) = r0;
    rts;
#endif
_C1_GAIN_21_process.end:

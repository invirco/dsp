...
/* SPI page=1 addr=4464 */

#include "blk_pool.h"

.section/dm seg_dmda;
.extern _buf_C1_IN_32;
.global _gain_coeff_C1_GAIN_32;
.var _gain_coeff_C1_GAIN_32 = 1.0;            /* FLOAT (ramped) */
.global _gain_target_C1_GAIN_32;
.var _gain_target_C1_GAIN_32 = 1.0;
.global _gain_step_C1_GAIN_32;
.var _gain_step_C1_GAIN_32 = 0.0;
.global _gain_frames_C1_GAIN_32;
.var _gain_frames_C1_GAIN_32 = 0;
.global _gain_q_C1_GAIN_32;
.var _gain_q_C1_GAIN_32 = 0x10000000;          /* Q4.28 shadow */
.global _mute_C1_GAIN_32;
.var _mute_C1_GAIN_32 = 0;
.global _polarity_C1_GAIN_32;
 ...
 * C1_MTR_32. The block path never stores it -- it hands
 * the finished accumulators over instead. */
.global _mtr_wide_C1_GAIN_32;
.var _mtr_wide_C1_GAIN_32;
...
_C1_GAIN_32_process:
    ...
    r5 = DSP4_BLOCK_SIZE;
    r4 = r4 - r5;
    dm(_gain_frames_C1_GAIN_32) = r4;
    f1 = dm(_gain_coeff_C1_GAIN_32);
    f2 = dm(_gain_step_C1_GAIN_32);
    r5 = DSP4_BLOCK_F32;              /* BLOCK_SIZE as float */
    f5 = r5;
    f2 = f2 * f5;
    f1 = f1 + f2;
    dm(_gain_coeff_C1_GAIN_32) = f1;
    jump (pc, .cvt_C1_GAIN_32);
.snap_C1_GAIN_32:
    f1 = dm(_gain_target_C1_GAIN_32);
    dm(_gain_coeff_C1_GAIN_32) = f1;
.cvt_C1_GAIN_32:
    ...
    call _gsimd_enter;
    lcntr = DSP4_BLOCK_HALF, do .gk_lp_C1_GAIN_32 until lce;
...
.gk_lp_C1_GAIN_32:
     ...
     * put the PEx copy here and the PEy copy in _buf_C1_GAIN_32. */
    modify(i1, -1);
    r0 = dm(i1, 0);
    dm(_tap_post_trim_C1_GAIN_32) = r0;   /* linkage scalars */
...
.gk_lp_C1_GAIN_32:
        dm(i4, 1) = r3;
    dm(_tap_post_trim_C1_GAIN_32) = r3;   /* linkage scalars */
    dm(_buf_C1_GAIN_32) = r3;
    rts;
#else
    r5 = DSP4_BLOCK_SIZE;
    lcntr = r5; do .gk_lp_C1_GAIN_32 until lce;
...
.gk_lp_C1_GAIN_32:
     ...
     * mic-pre tap the D20 ruling keeps GAIN a separate node for. */
    i4 = BLK_TAP_TRIM;
    r0 = _mtr_acc_C1_MTR_32;
    call _gsimd_gain_blk;
    /* The linkage scalars carry the LAST sample of the block, and
     * PEy computed it. Read it back out of the block rather than
     * out of a register: a direct store with PEYEN still up would
     * have put the PEx copy here and the PEy copy in _buf_C1_GAIN_32.

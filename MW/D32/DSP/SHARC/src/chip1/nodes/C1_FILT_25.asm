...
.var _filt_hpf_A_C1_FILT_25[5] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#elif DSP4_BQ_GUARD
.global _filt_hpf_A_C1_FILT_25;
...
.var _filt_lpf_A_C1_FILT_25[5] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#else
.global _filt_lpf_A_C1_FILT_25;
...
.var _filt_hpf_B_C1_FILT_25[5] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#elif DSP4_BQ_GUARD
.global _filt_hpf_B_C1_FILT_25;
...
.var _filt_lpf_B_C1_FILT_25[5] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#else
.global _filt_lpf_B_C1_FILT_25;
.var _filt_lpf_B_C1_FILT_25[5] = 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#endif
.global _filt_state_B_C1_FILT_25;
.var _filt_state_B_C1_FILT_25[12];
...
.var _hpf_coeffs_next_C1_FILT_25[5] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#else
.global _hpf_coeffs_next_C1_FILT_25;
...
.var _lpf_coeffs_next_C1_FILT_25[5] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#else
.global _lpf_coeffs_next_C1_FILT_25;
...
_C1_FILT_25_process_sample:
    ...
    l5 = 0;
    jump _shk_filt_smp;
_C1_FILT_25_process_sample.end:
#else
.global _C1_FILT_25_process;
_C1_FILT_25_process:
    ...
    i3 = BLK_CHAIN_B_P1;
    i4 = BLK_CHAIN_B_P1;
    lcntr = DSP4_BLOCK_SIZE, do .fkb_xl_C1_FILT_25 until lce;
        r0 = dm(i3, 1);
...
_C1_FILT_25_process_sample:
    ...
    r4 = pass r4;
    if ne jump (pc, .filt_xfade_C1_FILT_25);
...
.filt_xfade_C1_FILT_25:
    ...
    r4 = dm(_filt_active_C1_FILT_25);
    r4 = pass r4;
    if eq jump (pc, .filt_bl_C1_FILT_25);
    r5 = r14;
    r14 = r0;
    r0 = r5;
.filt_bl_C1_FILT_25:
    f4 = dm(_filt_xfade_alpha_C1_FILT_25);
    ...
    f4 = dm(_filt_xfade_alpha_C1_FILT_25);
    f5 = dm(_filt_xfade_step_C1_FILT_25);
    f4 = f4 + f5;
    dm(_filt_xfade_alpha_C1_FILT_25) = f4;
    r5 = 0x3F800000;
    f5 = r5;
    comp(f4, f5);
    if lt rts;
...
_filt_start_xfade_C1_FILT_25:
    ...
    r4 = dm(_filt_active_C1_FILT_25);
    r4 = pass r4;
    if ne jump (pc, .filt_st_a_C1_FILT_25);
    i0 = _filt_hpf_A_C1_FILT_25;       /* active = A (hpf+lpf adjacent) */
    i1 = _filt_hpf_B_C1_FILT_25;
    i2 = _filt_state_B_C1_FILT_25;
    jump (pc, .filt_st_go_C1_FILT_25);
.filt_st_a_C1_FILT_25:
    i0 = _filt_hpf_B_C1_FILT_25;
...
.filt_cph_C1_FILT_25:
    ...
    r4 = dm(_filt_active_C1_FILT_25);
    r4 = pass r4;
    if ne jump (pc, .filt_st2a_C1_FILT_25);
    i0 = _filt_lpf_A_C1_FILT_25;
    i1 = _filt_lpf_B_C1_FILT_25;
    jump (pc, .filt_st2go_C1_FILT_25);
.filt_st2a_C1_FILT_25:
    i0 = _filt_lpf_B_C1_FILT_25;
    i1 = _filt_lpf_A_C1_FILT_25;
.filt_st2go_C1_FILT_25:
    r5 = 5;
    lcntr = r5, do .filt_cpl_C1_FILT_25 until lce;
        r4 = dm(i0, 1);
.filt_cpl_C1_FILT_25:
        dm(i1, 1) = r4;
    ...
    r4 = dm(_hpf_swap_pending_C1_FILT_25);
    r4 = pass r4;
    if eq jump (pc, .filt_nohpf_C1_FILT_25);
    r4 = 0;
    dm(_hpf_swap_pending_C1_FILT_25) = r4;
    i0 = _hpf_coeffs_next_C1_FILT_25;
    r4 = dm(_filt_active_C1_FILT_25);
    r4 = pass r4;
    if ne jump (pc, .filt_cvha_C1_FILT_25);
    i1 = _filt_hpf_B_C1_FILT_25;
    jump (pc, .filt_cvhgo_C1_FILT_25);
...
.filt_nohpf_C1_FILT_25:
    ...
    r4 = pass r4;
    if eq jump (pc, .filt_nolpf_C1_FILT_25);
    r4 = 0;
    dm(_lpf_swap_pending_C1_FILT_25) = r4;
    i0 = _lpf_coeffs_next_C1_FILT_25;
    r4 = dm(_filt_active_C1_FILT_25);
    r4 = pass r4;
    if ne jump (pc, .filt_cvla_C1_FILT_25);
    i1 = _filt_lpf_B_C1_FILT_25;
    jump (pc, .filt_cvlgo_C1_FILT_25);
.filt_cvla_C1_FILT_25:
    i1 = _filt_lpf_A_C1_FILT_25;
.filt_cvlgo_C1_FILT_25:
    r4 = 1;
    call _bq_fx_convert_N;
.filt_nolpf_C1_FILT_25:
    ...
    r4 = dm(_filt_active_C1_FILT_25);
    r4 = pass r4;
    if ne jump (pc, .filt_zsa_C1_FILT_25);
    i2 = _filt_state_B_C1_FILT_25;
    jump (pc, .filt_zsgo_C1_FILT_25);
.filt_zsa_C1_FILT_25:
    i2 = _filt_state_A_C1_FILT_25;
.filt_zsgo_C1_FILT_25:
    r4 = 0;
    r5 = 12;
    lcntr = r5, do .filt_zst_C1_FILT_25 until lce;
.filt_zst_C1_FILT_25:
        dm(i2, 1) = r4;

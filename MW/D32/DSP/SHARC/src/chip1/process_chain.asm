...
.extern _C1_XIN_CODEC_02_process;
...
.extern _C1_BUS_MTX_01_process;
.extern _C1_BUS_MTX_01_SEND_process;
.extern _C1_BUS_MTX_02_process;
.extern _C1_BUS_MTX_02_SEND_process;
.extern _C1_BUS_MTX_03_process;
.extern _C1_BUS_MTX_03_SEND_process;
.extern _C1_BUS_MTX_04_process;
.extern _C1_BUS_MTX_04_SEND_process;
...
.extern _C1_TEST_MEAS_process;
.extern _C1_TEST_OSC_process;
 ...
 * 410 positions against 442 strip-ordered ones, because each
...
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _rx_slot_C1_XIN_CODEC_01;
    r1 = _buf_C1_XIN_CODEC_01;
#endif
    call _scope_inject_blk;
#endif
#if (DSP4_NODE_LIMIT == 0 || 289 < DSP4_NODE_LIMIT)
    call _C1_XIN_CODEC_02_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
...
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _rx_slot_C1_XIN_MEMS;
    r1 = _buf_C1_XIN_MEMS;
#endif
    call _scope_inject_blk;
#endif
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_GATE
    /* nodes 295..302 are D32-only */
    r2 = dm(_product_id);
    r3 = 0;
    comp(r2, r3);
...
#endif
#if DSP4_CHAN_MASK
    /* aux 1: entries 320..321, gate group 49 */
    r2 = dm(_mask_on + 49);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 2: entries 322..323, gate group 50 */
    r2 = dm(_mask_on + 50);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 3: entries 324..325, gate group 51 */
    r2 = dm(_mask_on + 51);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 4: entries 326..327, gate group 52 */
    r2 = dm(_mask_on + 52);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 5: entries 328..329, gate group 53 */
    r2 = dm(_mask_on + 53);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 6: entries 330..331, gate group 54 */
    r2 = dm(_mask_on + 54);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 7: entries 332..333, gate group 55 */
    r2 = dm(_mask_on + 55);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 8: entries 334..335, gate group 56 */
    r2 = dm(_mask_on + 56);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 9: entries 336..337, gate group 57 */
    r2 = dm(_mask_on + 57);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 10: entries 338..339, gate group 58 */
    r2 = dm(_mask_on + 58);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 11: entries 340..341, gate group 59 */
    r2 = dm(_mask_on + 59);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 12: entries 342..343, gate group 60 */
    r2 = dm(_mask_on + 60);
    r2 = pass r2;
...
.bqgrunm60_end:
    ...
    call _C1_BUS_MTX_01_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C1_BUS_MTX_01;
    r1 = _buf_C1_BUS_MTX_01;
    call _scope_tap;
#endif
#endif
#if (DSP4_NODE_LIMIT == 0 || 357 < DSP4_NODE_LIMIT)
    call _C1_BUS_MTX_01_SEND_process;
#endif
#if (DSP4_NODE_LIMIT == 0 || 358 < DSP4_NODE_LIMIT)
    call _C1_BUS_MTX_02_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C1_BUS_MTX_02;
    r1 = _buf_C1_BUS_MTX_02;
    call _scope_tap;
#endif
#endif
#if (DSP4_NODE_LIMIT == 0 || 359 < DSP4_NODE_LIMIT)
    call _C1_BUS_MTX_02_SEND_process;
#endif
#if (DSP4_NODE_LIMIT == 0 || 360 < DSP4_NODE_LIMIT)
    call _C1_BUS_MTX_03_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C1_BUS_MTX_03;
    r1 = _buf_C1_BUS_MTX_03;
    call _scope_tap;
#endif
#endif
#if (DSP4_NODE_LIMIT == 0 || 361 < DSP4_NODE_LIMIT)
    call _C1_BUS_MTX_03_SEND_process;
#endif
#if (DSP4_NODE_LIMIT == 0 || 362 < DSP4_NODE_LIMIT)
    call _C1_BUS_MTX_04_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C1_BUS_MTX_04;
    r1 = _buf_C1_BUS_MTX_04;
    call _scope_tap;
#endif
#endif
#if (DSP4_NODE_LIMIT == 0 || 363 < DSP4_NODE_LIMIT)
    call _C1_BUS_MTX_04_SEND_process;
#endif
...
#endif
#if DSP4_CHAN_MASK
    /* aux 1: entries 352..353, gate group 49 */
    r2 = dm(_mask_on + 49);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 2: entries 354..355, gate group 50 */
    r2 = dm(_mask_on + 50);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 3: entries 356..357, gate group 51 */
    r2 = dm(_mask_on + 51);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 4: entries 358..359, gate group 52 */
    r2 = dm(_mask_on + 52);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 5: entries 360..361, gate group 53 */
    r2 = dm(_mask_on + 53);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 6: entries 362..363, gate group 54 */
    r2 = dm(_mask_on + 54);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 7: entries 364..365, gate group 55 */
    r2 = dm(_mask_on + 55);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 8: entries 366..367, gate group 56 */
    r2 = dm(_mask_on + 56);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 9: entries 368..369, gate group 57 */
    r2 = dm(_mask_on + 57);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 10: entries 370..371, gate group 58 */
    r2 = dm(_mask_on + 58);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 11: entries 372..373, gate group 59 */
    r2 = dm(_mask_on + 59);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 12: entries 374..375, gate group 60 */
    r2 = dm(_mask_on + 60);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 1: entries 384..385, gate group 49 */
    r2 = dm(_mask_on + 49);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 2: entries 386..387, gate group 50 */
    r2 = dm(_mask_on + 50);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 3: entries 388..389, gate group 51 */
    r2 = dm(_mask_on + 51);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 4: entries 390..391, gate group 52 */
    r2 = dm(_mask_on + 52);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 5: entries 392..393, gate group 53 */
    r2 = dm(_mask_on + 53);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 6: entries 394..395, gate group 54 */
    r2 = dm(_mask_on + 54);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 7: entries 396..397, gate group 55 */
    r2 = dm(_mask_on + 55);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 8: entries 398..399, gate group 56 */
    r2 = dm(_mask_on + 56);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 9: entries 400..401, gate group 57 */
    r2 = dm(_mask_on + 57);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 10: entries 402..403, gate group 58 */
    r2 = dm(_mask_on + 58);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 11: entries 404..405, gate group 59 */
    r2 = dm(_mask_on + 59);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 12: entries 406..407, gate group 60 */
    r2 = dm(_mask_on + 60);
    r2 = pass r2;
...
.sgrunm44_end:
    ...
    call _C1_XS_XFER_PI_L_process;
#endif
#if (DSP4_NODE_LIMIT == 0 || 431 < DSP4_NODE_LIMIT)
    call _C1_XS_XFER_PI_R_process;
#endif
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_GATE
    /* nodes 432..439 are D32-only */
    r2 = dm(_product_id);
    r3 = 0;
    comp(r2, r3);
    if ne jump (pc, .sgrun1_end);
#endif
#if (DSP4_NODE_LIMIT == 0 || 432 < DSP4_NODE_LIMIT)
    call _C1_XS_XFER_SNAKE_01_process;
#endif
#if (DSP4_NODE_LIMIT == 0 || 433 < DSP4_NODE_LIMIT)
    call _C1_XS_XFER_SNAKE_02_process;
#endif
#if (DSP4_NODE_LIMIT == 0 || 434 < DSP4_NODE_LIMIT)
    call _C1_XS_XFER_SNAKE_03_process;
#endif
#if (DSP4_NODE_LIMIT == 0 || 435 < DSP4_NODE_LIMIT)
    call _C1_XS_XFER_SNAKE_04_process;
#endif
#if (DSP4_NODE_LIMIT == 0 || 436 < DSP4_NODE_LIMIT)
    call _C1_XS_XFER_SNAKE_05_process;
#endif
#if (DSP4_NODE_LIMIT == 0 || 437 < DSP4_NODE_LIMIT)
    call _C1_XS_XFER_SNAKE_06_process;
#endif
#if (DSP4_NODE_LIMIT == 0 || 438 < DSP4_NODE_LIMIT)
    call _C1_XS_XFER_SNAKE_07_process;
#endif
#if (DSP4_NODE_LIMIT == 0 || 439 < DSP4_NODE_LIMIT)
    call _C1_XS_XFER_SNAKE_08_process;
#endif
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_GATE
.sgrun1_end:
    ...
    call _C1_TEST_MEAS_process;
#endif
#if (DSP4_NODE_LIMIT == 0 || 441 < DSP4_NODE_LIMIT)
    call _C1_TEST_OSC_process;
#endif
#endif

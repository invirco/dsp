...
/* ---- Block processing ---- */
/* Generated by tools/dsp/dsp_codegen.py -- see dsp_block.h. */
#include "dsp_block.h"
...
_spi2_rx_work:
    ...
    r5 = dm(_spi_dispatch_c1_spms);   /* samples per millisecond, float32 */
    f4 = f4 * f5;
...
.spi_ramp_go:
    ...
    r3 = lshift r3 by DSP4_BLOCK_SHIFT;   /* × BLOCK_SIZE */
...
.spi_mark_dirty:
     ...
     *
     * _spi_dispatch_c1_dirty has the same length and indexing as the
...
.spi_read:
    ...
    r6 = dm(_spi_dispatch_c1_spms);
    f6 = RECIPS f6;                   /* seed 1/spms */
    r7 = dm(_spi_dispatch_c1_spms);
    f8 = f7 * f6;
    r9 = 0x40000000;                  /* 2.0f */
    f8 = f9 - f8;
    f6 = f6 * f8;                     /* ~16-bit */

 ...
 *
 * Chip 1 receives SPI traffic from H1S1 MCU on SPI1 (CS1).
 ...
 * spi_handler.asm instance. H1S1 selects the target chip via CS line.
 *
 ...
 *
 * This handler runs as SPI1 RX interrupt on Chip 1 only.
 *

 ...
 *
 * Chip 2 receives SPI traffic from H1S1 MCU on SPI1 (CS2).
 * Protocol: 32-bit address + 32-bit coefficient word per write.
 *
 * Address space: 0x0000–0x0FFF → Chip 2 parameter RAM only.
 * H1S1 selects this chip by asserting CS2; Chip 1 uses CS1 independently.
 *
 ...
 *
 * This handler runs as SPI1 RX interrupt on Chip 2 only.
 *

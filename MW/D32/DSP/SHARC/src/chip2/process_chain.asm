 ...
 * number in both builds. 245 positions
 * against 259 scalar ones.
...
.c2brun2_end:
    ...
    /* aux 1: entries 178..178, gate group 0 */
    r2 = dm(_mask_on + 0);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 2: entries 179..179, gate group 1 */
    r2 = dm(_mask_on + 1);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 3: entries 180..180, gate group 2 */
    r2 = dm(_mask_on + 2);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 4: entries 181..181, gate group 3 */
    r2 = dm(_mask_on + 3);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 5: entries 182..182, gate group 4 */
    r2 = dm(_mask_on + 4);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 6: entries 183..183, gate group 5 */
    r2 = dm(_mask_on + 5);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 7: entries 184..184, gate group 6 */
    r2 = dm(_mask_on + 6);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 8: entries 185..185, gate group 7 */
    r2 = dm(_mask_on + 7);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 9: entries 186..186, gate group 8 */
    r2 = dm(_mask_on + 8);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 10: entries 187..187, gate group 9 */
    r2 = dm(_mask_on + 9);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 11: entries 188..188, gate group 10 */
    r2 = dm(_mask_on + 10);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 12: entries 189..189, gate group 11 */
    r2 = dm(_mask_on + 11);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 1: entries 207..209, gate group 18 */
    r2 = dm(_mask_on + 18);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 2: entries 210..212, gate group 19 */
    r2 = dm(_mask_on + 19);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 3: entries 213..215, gate group 20 */
    r2 = dm(_mask_on + 20);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 4: entries 216..218, gate group 21 */
    r2 = dm(_mask_on + 21);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 1: entries 218..218, gate group 0 */
    r2 = dm(_mask_on + 0);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 2: entries 219..219, gate group 1 */
    r2 = dm(_mask_on + 1);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 3: entries 220..220, gate group 2 */
    r2 = dm(_mask_on + 2);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 4: entries 221..221, gate group 3 */
    r2 = dm(_mask_on + 3);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 5: entries 222..222, gate group 4 */
    r2 = dm(_mask_on + 4);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 6: entries 223..223, gate group 5 */
    r2 = dm(_mask_on + 5);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 7: entries 224..224, gate group 6 */
    r2 = dm(_mask_on + 6);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 8: entries 225..225, gate group 7 */
    r2 = dm(_mask_on + 7);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 9: entries 226..226, gate group 8 */
    r2 = dm(_mask_on + 8);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 10: entries 227..227, gate group 9 */
    r2 = dm(_mask_on + 9);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 11: entries 228..228, gate group 10 */
    r2 = dm(_mask_on + 10);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 12: entries 229..229, gate group 11 */
    r2 = dm(_mask_on + 11);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 1: entries 247..249, gate group 18 */
    r2 = dm(_mask_on + 18);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 2: entries 250..252, gate group 19 */
    r2 = dm(_mask_on + 19);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 3: entries 253..255, gate group 20 */
    r2 = dm(_mask_on + 20);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 4: entries 256..258, gate group 21 */
    r2 = dm(_mask_on + 21);
    r2 = pass r2;

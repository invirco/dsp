...
.extern _buf_C2_MIX_AUX_01;
.extern _buf_C2_MIX_AUX_02;
.extern _buf_C2_MIX_AUX_03;
.extern _buf_C2_MIX_AUX_04;
.extern _buf_C2_MIX_AUX_05;
.extern _buf_C2_MIX_AUX_06;
.extern _buf_C2_MIX_AUX_07;
.extern _buf_C2_MIX_AUX_08;
.extern _buf_C2_MIX_AUX_09;
.extern _buf_C2_MIX_AUX_10;
.extern _buf_C2_MIX_AUX_11;
.extern _buf_C2_MIX_AUX_12;
.extern _buf_C2_MIX_MAIN_L;
.extern _buf_C2_MIX_MAIN_R;
.extern _buf_C2_MON;
.extern _buf_C2_MON_DLY;
.extern _buf_C2_MTX_FDR_01;
.extern _buf_C2_MTX_FDR_02;
.extern _buf_C2_MTX_FDR_03;
.extern _buf_C2_MTX_FDR_04;
.extern _buf_C2_MTX_OUT_01;
.extern _buf_C2_MTX_OUT_02;
.extern _buf_C2_MTX_OUT_03;
.extern _buf_C2_MTX_OUT_04;
...
.extern _buf_C2_RECV_MTX_01;
.extern _buf_C2_RECV_MTX_02;
.extern _buf_C2_RECV_MTX_03;
.extern _buf_C2_RECV_MTX_04;
...
.extern _C2_MIX_AUX_04_process;
.extern _C2_MIX_AUX_05_process;
.extern _C2_MIX_AUX_06_process;
.extern _C2_MIX_AUX_07_process;
.extern _C2_MIX_AUX_08_process;
.extern _C2_MIX_AUX_09_process;
.extern _C2_MIX_AUX_10_process;
.extern _C2_MIX_AUX_11_process;
.extern _C2_MIX_AUX_12_process;
...
.extern _C2_HPT_01_process;
.extern _C2_SPKR_OUT_process;
...
.extern _C2_RECV_MTX_01_process;
.extern _C2_MTX_FDR_01_process;
.extern _C2_MTX_OUT_01_process;
.extern _C2_RECV_MTX_02_process;
.extern _C2_MTX_FDR_02_process;
.extern _C2_MTX_OUT_02_process;
.extern _C2_RECV_MTX_03_process;
.extern _C2_MTX_FDR_03_process;
.extern _C2_MTX_OUT_03_process;
.extern _C2_RECV_MTX_04_process;
.extern _C2_MTX_FDR_04_process;
.extern _C2_MTX_OUT_04_process;
 ...
 * number in both builds. 246 positions
 * against 260 scalar ones.
...
#endif
#if DSP4_CHAN_MASK
    /* aux 1: entries 59..59, gate group 0 */
    r2 = dm(_mask_on + 0);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 2: entries 60..60, gate group 1 */
    r2 = dm(_mask_on + 1);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 3: entries 61..61, gate group 2 */
    r2 = dm(_mask_on + 2);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 4: entries 62..62, gate group 3 */
    r2 = dm(_mask_on + 3);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 5: entries 63..63, gate group 4 */
    r2 = dm(_mask_on + 4);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 6: entries 64..64, gate group 5 */
    r2 = dm(_mask_on + 5);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 7: entries 65..65, gate group 6 */
    r2 = dm(_mask_on + 6);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 8: entries 66..66, gate group 7 */
    r2 = dm(_mask_on + 7);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 9: entries 67..67, gate group 8 */
    r2 = dm(_mask_on + 8);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 10: entries 68..68, gate group 9 */
    r2 = dm(_mask_on + 9);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 11: entries 69..69, gate group 10 */
    r2 = dm(_mask_on + 10);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 12: entries 70..70, gate group 11 */
    r2 = dm(_mask_on + 11);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 1: entries 71..71, gate group 0 */
    r2 = dm(_mask_on + 0);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 2: entries 72..72, gate group 1 */
    r2 = dm(_mask_on + 1);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 1+2: entries 73..76, gate group 12 */
    r2 = dm(_mask_on + 12);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 1: entries 77..78, gate group 0 */
    r2 = dm(_mask_on + 0);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 2: entries 79..80, gate group 1 */
    r2 = dm(_mask_on + 1);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 3: entries 81..81, gate group 2 */
    r2 = dm(_mask_on + 2);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 4: entries 82..82, gate group 3 */
    r2 = dm(_mask_on + 3);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 3+4: entries 83..86, gate group 13 */
    r2 = dm(_mask_on + 13);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 3: entries 87..88, gate group 2 */
    r2 = dm(_mask_on + 2);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 4: entries 89..90, gate group 3 */
    r2 = dm(_mask_on + 3);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 5: entries 91..91, gate group 4 */
    r2 = dm(_mask_on + 4);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 6: entries 92..92, gate group 5 */
    r2 = dm(_mask_on + 5);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 5+6: entries 93..96, gate group 14 */
    r2 = dm(_mask_on + 14);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 5: entries 97..98, gate group 4 */
    r2 = dm(_mask_on + 4);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 6: entries 99..100, gate group 5 */
    r2 = dm(_mask_on + 5);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 7: entries 101..101, gate group 6 */
    r2 = dm(_mask_on + 6);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 8: entries 102..102, gate group 7 */
    r2 = dm(_mask_on + 7);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 7+8: entries 103..106, gate group 15 */
    r2 = dm(_mask_on + 15);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 7: entries 107..108, gate group 6 */
    r2 = dm(_mask_on + 6);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 8: entries 109..110, gate group 7 */
    r2 = dm(_mask_on + 7);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 9: entries 111..111, gate group 8 */
    r2 = dm(_mask_on + 8);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 10: entries 112..112, gate group 9 */
    r2 = dm(_mask_on + 9);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 9+10: entries 113..116, gate group 16 */
    r2 = dm(_mask_on + 16);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 9: entries 117..118, gate group 8 */
    r2 = dm(_mask_on + 8);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 10: entries 119..120, gate group 9 */
    r2 = dm(_mask_on + 9);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 11: entries 121..121, gate group 10 */
    r2 = dm(_mask_on + 10);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 12: entries 122..122, gate group 11 */
    r2 = dm(_mask_on + 11);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 11+12: entries 123..126, gate group 17 */
    r2 = dm(_mask_on + 17);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 11: entries 127..128, gate group 10 */
    r2 = dm(_mask_on + 10);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 12: entries 129..130, gate group 11 */
    r2 = dm(_mask_on + 11);
    r2 = pass r2;
...
.c2brun2_end:
    ...
    /* aux 1: entries 179..179, gate group 0 */
    r2 = dm(_mask_on + 0);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 2: entries 180..180, gate group 1 */
    r2 = dm(_mask_on + 1);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 3: entries 181..181, gate group 2 */
    r2 = dm(_mask_on + 2);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 4: entries 182..182, gate group 3 */
    r2 = dm(_mask_on + 3);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 5: entries 183..183, gate group 4 */
    r2 = dm(_mask_on + 4);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 6: entries 184..184, gate group 5 */
    r2 = dm(_mask_on + 5);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 7: entries 185..185, gate group 6 */
    r2 = dm(_mask_on + 6);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 8: entries 186..186, gate group 7 */
    r2 = dm(_mask_on + 7);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 9: entries 187..187, gate group 8 */
    r2 = dm(_mask_on + 8);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 10: entries 188..188, gate group 9 */
    r2 = dm(_mask_on + 9);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 11: entries 189..189, gate group 10 */
    r2 = dm(_mask_on + 10);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 12: entries 190..190, gate group 11 */
    r2 = dm(_mask_on + 11);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 1: entries 208..210, gate group 18 */
    r2 = dm(_mask_on + 18);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 2: entries 211..213, gate group 19 */
    r2 = dm(_mask_on + 19);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 3: entries 214..216, gate group 20 */
    r2 = dm(_mask_on + 20);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 4: entries 217..219, gate group 21 */
    r2 = dm(_mask_on + 21);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 1: entries 71..74, gate group 0 */
    r2 = dm(_mask_on + 0);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 2: entries 75..78, gate group 1 */
    r2 = dm(_mask_on + 1);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 1+2: entries 79..79, gate group 12 */
    r2 = dm(_mask_on + 12);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 1: entries 80..81, gate group 0 */
    r2 = dm(_mask_on + 0);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 2: entries 82..83, gate group 1 */
    r2 = dm(_mask_on + 1);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 3: entries 84..87, gate group 2 */
    r2 = dm(_mask_on + 2);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 4: entries 88..91, gate group 3 */
    r2 = dm(_mask_on + 3);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 3+4: entries 92..92, gate group 13 */
    r2 = dm(_mask_on + 13);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 3: entries 93..94, gate group 2 */
    r2 = dm(_mask_on + 2);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 4: entries 95..96, gate group 3 */
    r2 = dm(_mask_on + 3);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 5: entries 97..100, gate group 4 */
    r2 = dm(_mask_on + 4);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 6: entries 101..104, gate group 5 */
    r2 = dm(_mask_on + 5);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 5+6: entries 105..105, gate group 14 */
    r2 = dm(_mask_on + 14);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 5: entries 106..107, gate group 4 */
    r2 = dm(_mask_on + 4);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 6: entries 108..109, gate group 5 */
    r2 = dm(_mask_on + 5);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 7: entries 110..113, gate group 6 */
    r2 = dm(_mask_on + 6);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 8: entries 114..117, gate group 7 */
    r2 = dm(_mask_on + 7);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 7+8: entries 118..118, gate group 15 */
    r2 = dm(_mask_on + 15);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 7: entries 119..120, gate group 6 */
    r2 = dm(_mask_on + 6);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 8: entries 121..122, gate group 7 */
    r2 = dm(_mask_on + 7);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 9: entries 123..126, gate group 8 */
    r2 = dm(_mask_on + 8);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 10: entries 127..130, gate group 9 */
    r2 = dm(_mask_on + 9);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 9+10: entries 131..131, gate group 16 */
    r2 = dm(_mask_on + 16);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 9: entries 132..133, gate group 8 */
    r2 = dm(_mask_on + 8);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 10: entries 134..135, gate group 9 */
    r2 = dm(_mask_on + 9);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 11: entries 136..139, gate group 10 */
    r2 = dm(_mask_on + 10);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 12: entries 140..143, gate group 11 */
    r2 = dm(_mask_on + 11);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 11+12: entries 144..144, gate group 17 */
    r2 = dm(_mask_on + 17);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 11: entries 145..146, gate group 10 */
    r2 = dm(_mask_on + 10);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 12: entries 147..148, gate group 11 */
    r2 = dm(_mask_on + 11);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 1: entries 205..205, gate group 0 */
    r2 = dm(_mask_on + 0);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 2: entries 206..206, gate group 1 */
    r2 = dm(_mask_on + 1);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 3: entries 207..207, gate group 2 */
    r2 = dm(_mask_on + 2);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 4: entries 208..208, gate group 3 */
    r2 = dm(_mask_on + 3);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 5: entries 209..209, gate group 4 */
    r2 = dm(_mask_on + 4);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 6: entries 210..210, gate group 5 */
    r2 = dm(_mask_on + 5);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 7: entries 211..211, gate group 6 */
    r2 = dm(_mask_on + 6);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 8: entries 212..212, gate group 7 */
    r2 = dm(_mask_on + 7);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 9: entries 213..213, gate group 8 */
    r2 = dm(_mask_on + 8);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 10: entries 214..214, gate group 9 */
    r2 = dm(_mask_on + 9);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 11: entries 215..215, gate group 10 */
    r2 = dm(_mask_on + 10);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 12: entries 216..216, gate group 11 */
    r2 = dm(_mask_on + 11);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 1: entries 234..236, gate group 18 */
    r2 = dm(_mask_on + 18);
    r2 = pass r2;
    if eq jump (pc, .c2grunm66_end);
#endif
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 2: entries 237..239, gate group 19 */
    r2 = dm(_mask_on + 19);
    r2 = pass r2;
    if eq jump (pc, .c2grunm67_end);
#endif
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 3: entries 240..242, gate group 20 */
    r2 = dm(_mask_on + 20);
    r2 = pass r2;
    if eq jump (pc, .c2grunm68_end);
#endif
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 4: entries 243..245, gate group 21 */
    r2 = dm(_mask_on + 21);
    r2 = pass r2;
    if eq jump (pc, .c2grunm69_end);
#endif
...
#endif
#if DSP4_CHAN_MASK
    /* aux 1: entries 71..77, gate group 0 */
    r2 = dm(_mask_on + 0);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 2: entries 78..84, gate group 1 */
    r2 = dm(_mask_on + 1);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 3: entries 85..91, gate group 2 */
    r2 = dm(_mask_on + 2);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 4: entries 92..98, gate group 3 */
    r2 = dm(_mask_on + 3);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 5: entries 99..105, gate group 4 */
    r2 = dm(_mask_on + 4);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 6: entries 106..112, gate group 5 */
    r2 = dm(_mask_on + 5);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 7: entries 113..119, gate group 6 */
    r2 = dm(_mask_on + 6);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 8: entries 120..126, gate group 7 */
    r2 = dm(_mask_on + 7);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 9: entries 127..133, gate group 8 */
    r2 = dm(_mask_on + 8);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 10: entries 134..140, gate group 9 */
    r2 = dm(_mask_on + 9);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 11: entries 141..147, gate group 10 */
    r2 = dm(_mask_on + 10);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK
    /* aux 12: entries 148..154, gate group 11 */
    r2 = dm(_mask_on + 11);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 1: entries 219..219, gate group 0 */
    r2 = dm(_mask_on + 0);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 2: entries 220..220, gate group 1 */
    r2 = dm(_mask_on + 1);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 3: entries 221..221, gate group 2 */
    r2 = dm(_mask_on + 2);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 4: entries 222..222, gate group 3 */
    r2 = dm(_mask_on + 3);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 5: entries 223..223, gate group 4 */
    r2 = dm(_mask_on + 4);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 6: entries 224..224, gate group 5 */
    r2 = dm(_mask_on + 5);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 7: entries 225..225, gate group 6 */
    r2 = dm(_mask_on + 6);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 8: entries 226..226, gate group 7 */
    r2 = dm(_mask_on + 7);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 9: entries 227..227, gate group 8 */
    r2 = dm(_mask_on + 8);
    r2 = pass r2;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 10: entries 228..228, gate group 9 */
    r2 = dm(_mask_on + 9);
    r2 = pass r2;
    if eq jump (pc, .sgrunm45_end);
#endif
#if (DSP4_NODE_LIMIT2 == 0 || 228 < DSP4_NODE_LIMIT2)
#if !DSP4_BLOCK_KERNELS
    call _C2_MTR_AUX_10_process;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 11: entries 229..229, gate group 10 */
    r2 = dm(_mask_on + 10);
    r2 = pass r2;
    if eq jump (pc, .sgrunm46_end);
#endif
#if (DSP4_NODE_LIMIT2 == 0 || 229 < DSP4_NODE_LIMIT2)
#if !DSP4_BLOCK_KERNELS
    call _C2_MTR_AUX_11_process;
...
#endif
#if DSP4_CHAN_MASK && !DSP4_BLOCK_KERNELS
    /* aux 12: entries 230..230, gate group 11 */
    r2 = dm(_mask_on + 11);
    r2 = pass r2;
    if eq jump (pc, .sgrunm47_end);
#endif
#if (DSP4_NODE_LIMIT2 == 0 || 230 < DSP4_NODE_LIMIT2)
#if !DSP4_BLOCK_KERNELS
    call _C2_MTR_AUX_12_process;
...
#endif
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_GATE
    /* nodes 247..247 are D24-only */
    r2 = dm(_product_id);
    r3 = 1;
    comp(r2, r3);
    if ne jump (pc, .sgrun3_end);
#endif
#if (DSP4_NODE_LIMIT2 == 0 || 247 < DSP4_NODE_LIMIT2)
    call _C2_CODEC_AUX_OUT_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C2_CODEC_AUX_OUT;
    r1 = _blk_C2_CODEC_AUX_OUT;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 1: entries 248..250, gate group 18 */
    r2 = dm(_mask_on + 18);
    r2 = pass r2;
    if eq jump (pc, .sgrunm48_end);
#endif
...
#endif
#endif
#if (DSP4_NODE_LIMIT2 == 0 || 249 < DSP4_NODE_LIMIT2)
    call _C2_MTX_FDR_01_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C2_MTX_FDR_01;
    r1 = _blk_C2_MTX_FDR_01;
...
#endif
#endif
#if (DSP4_NODE_LIMIT2 == 0 || 250 < DSP4_NODE_LIMIT2)
    call _C2_MTX_OUT_01_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C2_MTX_OUT_01;
    r1 = _blk_C2_MTX_OUT_01;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 2: entries 251..253, gate group 19 */
    r2 = dm(_mask_on + 19);
    r2 = pass r2;
    if eq jump (pc, .sgrunm49_end);
#endif
#if (DSP4_NODE_LIMIT2 == 0 || 251 < DSP4_NODE_LIMIT2)
    call _C2_RECV_MTX_02_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C2_RECV_MTX_02;
    r1 = _blk_C2_RECV_MTX_02;
...
#endif
#endif
#if (DSP4_NODE_LIMIT2 == 0 || 252 < DSP4_NODE_LIMIT2)
    call _C2_MTX_FDR_02_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C2_MTX_FDR_02;
    r1 = _blk_C2_MTX_FDR_02;
...
#endif
#endif
#if (DSP4_NODE_LIMIT2 == 0 || 253 < DSP4_NODE_LIMIT2)
    call _C2_MTX_OUT_02_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C2_MTX_OUT_02;
    r1 = _blk_C2_MTX_OUT_02;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 3: entries 254..256, gate group 20 */
    r2 = dm(_mask_on + 20);
    r2 = pass r2;
    if eq jump (pc, .sgrunm50_end);
#endif
#if (DSP4_NODE_LIMIT2 == 0 || 254 < DSP4_NODE_LIMIT2)
    call _C2_RECV_MTX_03_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C2_RECV_MTX_03;
    r1 = _blk_C2_RECV_MTX_03;
...
#endif
#endif
#if (DSP4_NODE_LIMIT2 == 0 || 255 < DSP4_NODE_LIMIT2)
    call _C2_MTX_FDR_03_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C2_MTX_FDR_03;
    r1 = _blk_C2_MTX_FDR_03;
...
#endif
#endif
#if (DSP4_NODE_LIMIT2 == 0 || 256 < DSP4_NODE_LIMIT2)
    call _C2_MTX_OUT_03_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C2_MTX_OUT_03;
    r1 = _blk_C2_MTX_OUT_03;
...
#endif
#if DSP4_CHAN_MASK
    /* matrix 4: entries 257..259, gate group 21 */
    r2 = dm(_mask_on + 21);
    r2 = pass r2;
    if eq jump (pc, .sgrunm51_end);
#endif
#if (DSP4_NODE_LIMIT2 == 0 || 257 < DSP4_NODE_LIMIT2)
    call _C2_RECV_MTX_04_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C2_RECV_MTX_04;
    r1 = _blk_C2_RECV_MTX_04;
...
#endif
#endif
#if (DSP4_NODE_LIMIT2 == 0 || 258 < DSP4_NODE_LIMIT2)
    call _C2_MTX_FDR_04_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C2_MTX_FDR_04;
    r1 = _blk_C2_MTX_FDR_04;
...
#endif
#endif
#if (DSP4_NODE_LIMIT2 == 0 || 259 < DSP4_NODE_LIMIT2)
    call _C2_MTX_OUT_04_process;
#if DSP4_BLOCK_KERNELS && DSP4_SCOPE_BLK_TAP
    r0 = _buf_C2_MTX_OUT_04;
    r1 = _blk_C2_MTX_OUT_04;

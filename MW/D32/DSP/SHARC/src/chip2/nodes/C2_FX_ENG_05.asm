...
.var _fx_predelay_C2_FX_ENG_05;
.global _fx_delay_ms_C2_FX_ENG_05;
.var _fx_delay_ms_C2_FX_ENG_05;
.global _fx_feedback_C2_FX_ENG_05;
.var _fx_feedback_C2_FX_ENG_05;
.global _fx_balance_C2_FX_ENG_05;
.var _fx_balance_C2_FX_ENG_05;
.global _fx_damp_C2_FX_ENG_05;
.var _fx_damp_C2_FX_ENG_05;
.global _fx_eq_lo_C2_FX_ENG_05;
.var _fx_eq_lo_C2_FX_ENG_05;
.global _fx_eq_mid_C2_FX_ENG_05;
.var _fx_eq_mid_C2_FX_ENG_05;
.global _fx_eq_hi_C2_FX_ENG_05;
.var _fx_eq_hi_C2_FX_ENG_05;
.global _fx_hpf_coeffs_C2_FX_ENG_05;
.var _fx_hpf_coeffs_C2_FX_ENG_05[5];
.global _fx_mod_rate_C2_FX_ENG_05;
.var _fx_mod_rate_C2_FX_ENG_05;
.global _fx_mod_level_C2_FX_ENG_05;
.var _fx_mod_level_C2_FX_ENG_05;
.global _fx_lfo_shape_C2_FX_ENG_05;
.var _fx_lfo_shape_C2_FX_ENG_05 = 0;      /* 0=sine, 1=triangle */
.global _fx_width_C2_FX_ENG_05;
.var _fx_width_C2_FX_ENG_05;
.global _fx_mix_C2_FX_ENG_05;
.var _fx_mix_C2_FX_ENG_05;
.global _fx_mix_target_C2_FX_ENG_05;
.var _fx_mix_target_C2_FX_ENG_05;
.global _fx_mix_step_C2_FX_ENG_05;
.var _fx_mix_step_C2_FX_ENG_05 = 0.0;
.global _fx_mix_frames_C2_FX_ENG_05;
.var _fx_mix_frames_C2_FX_ENG_05 = 0;
.global _fx_duck_on_C2_FX_ENG_05;
.var _fx_duck_on_C2_FX_ENG_05 = 0;
.global _fx_duck_sens_C2_FX_ENG_05;
.var _fx_duck_sens_C2_FX_ENG_05;

/* LFO state */
.global _fx_lfo_phase_C2_FX_ENG_05;
.var _fx_lfo_phase_C2_FX_ENG_05 = 0.0;
...
.global _fx_rv_comb_lpfs_C2_FX_ENG_05;
.var _fx_rv_comb_lpfs_C2_FX_ENG_05[8];
.global _fx_rv_comb_lens_C2_FX_ENG_05;
.var _fx_rv_comb_lens_C2_FX_ENG_05[8] = 1557, 1617, 1491, 1422, 1277, 1356, 1188, 1116;
.global _fx_rv_comb_ofs_C2_FX_ENG_05;
.var _fx_rv_comb_ofs_C2_FX_ENG_05[8] = 0, 1557, 3174, 4665, 6087, 7364, 8720, 9908;
.global _fx_rv_ap_wptrs_C2_FX_ENG_05;
.var _fx_rv_ap_wptrs_C2_FX_ENG_05[4];
.global _fx_rv_ap_lens_C2_FX_ENG_05;
...
.global _buf_L_C2_FX_ENG_05;
.var _buf_L_C2_FX_ENG_05;
.global _buf_R_C2_FX_ENG_05;
.var _buf_R_C2_FX_ENG_05;
.global _buf_C2_FX_ENG_05;
.var _buf_C2_FX_ENG_05;

        #if DSP4_BLOCK_KERNELS
        .extern _blk_C2_RECV_FX_05;
        #endif
        #if DSP4_BLOCK_KERNELS
        .global _blk_C2_FX_ENG_05;
        .var _blk_C2_FX_ENG_05[DSP4_BLOCK_SIZE];
        .global _bw_k_C2_FX_ENG_05;
        .var _bw_k_C2_FX_ENG_05;        /* the caller's _sample_idx */
        .global _bw_s0_C2_FX_ENG_05;
        .var _bw_s0_C2_FX_ENG_05;       /* walking source pointer */
        .global _bw_d0_C2_FX_ENG_05;
        .var _bw_d0_C2_FX_ENG_05;       /* walking sink pointer */
        #endif

.section/pm seg_pmco;
.global _C2_FX_ENG_05_process;
_C2_FX_ENG_05_process:
        #if DSP4_BLOCK_KERNELS
            /* ---- PARK: _fx_on_C2_FX_ENG_05 is off ---- */
            r5 = dm(_fx_on_C2_FX_ENG_05);
            r5 = pass r5;
            if ne jump (pc, .bwrun_C2_FX_ENG_05);
            l0 = 0;
            r0 = 0;
            i0 = _blk_C2_FX_ENG_05;
            lcntr = DSP4_BLOCK_SIZE, do .bwpk_C2_FX_ENG_05 until lce;
            .bwpk_C2_FX_ENG_05: dm(i0, 1) = r0;
        ...
        .bwrun_C2_FX_ENG_05:
             ...
             */
            i4 = _blk_C2_RECV_FX_05;
            r3 = i4;
            dm(_bw_s0_C2_FX_ENG_05) = r3;
            i4 = _blk_C2_FX_ENG_05;
            r3 = i4;
            dm(_bw_d0_C2_FX_ENG_05) = r3;
            r5 = dm(_sample_idx);
            dm(_bw_k_C2_FX_ENG_05) = r5;
            r5 = 0;
            dm(_sample_idx) = r5;
            /* sample 0, peeled: the block-rate guard fires here */
                r3 = dm(_bw_s0_C2_FX_ENG_05);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_RECV_FX_05) = r0;
                r3 = r3 + 1;
                dm(_bw_s0_C2_FX_ENG_05) = r3;
                call _C2_FX_ENG_05_process_sample;
                r0 = dm(_buf_C2_FX_ENG_05);
                r3 = dm(_bw_d0_C2_FX_ENG_05);
                i4 = r3;
                dm(i4, 0) = r0;
                r3 = r3 + 1;
                dm(_bw_d0_C2_FX_ENG_05) = r3;
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_FX_ENG_05 until lce;
                r3 = dm(_bw_s0_C2_FX_ENG_05);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_RECV_FX_05) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_FX_ENG_05: dm(_bw_d0_C2_FX_ENG_05) = r3;
            r5 = dm(_bw_k_C2_FX_ENG_05);
            dm(_sample_idx) = r5;
            rts;
     ...
     * could write it, `_fx_on_C2_FX_ENG_05` was declared right above --
    ...
    r1 = dm(_fx_on_C2_FX_ENG_05);
    r1 = pass r1;
    if eq jump (pc, .fx_off_C2_FX_ENG_05);
    ...
    f2 = dm(_fx_mix_step_C2_FX_ENG_05);
    f1 = f1 + f2;
    dm(_fx_mix_C2_FX_ENG_05) = f1;
    jump (pc, .fx_dispatch_C2_FX_ENG_05);
.no_fxramp_C2_FX_ENG_05:
    f1 = dm(_fx_mix_target_C2_FX_ENG_05);
    dm(_fx_mix_C2_FX_ENG_05) = f1;
.fx_dispatch_C2_FX_ENG_05:

    /* Load input */
    r0 = dm(_buf_C2_RECV_FX_05);
...
/* ===================== REVERB ===================== */
.fx_reverb_C2_FX_ENG_05:
    /* Freeverb: 8 parallel comb-LPF + 4 series allpass */
    r14 = 0x00000000;  /* 0.0 IEEE 754 */                   /* comb sum accumulator */
    i3 = _fx_rv_comb_wptrs_C2_FX_ENG_05;
    i4 = _fx_rv_comb_lens_C2_FX_ENG_05;
    i5 = _fx_rv_comb_ofs_C2_FX_ENG_05;
    i6 = _fx_rv_comb_lpfs_C2_FX_ENG_05;
    f10 = dm(_fx_feedback_C2_FX_ENG_05); /* comb feedback */
    f11 = dm(_fx_damp_C2_FX_ENG_05);     /* damp1 */
    r12 = 0x3F800000;  /* 1.0 IEEE 754 */
    f12 = f12 - f11;             /* damp2 = 1 - damp1 */
    r5 = 8;
    lcntr = r5; do .rv_comb_C2_FX_ENG_05 until lce;
    ...
    /* 4 series allpass */
    i3 = _fx_rv_ap_wptrs_C2_FX_ENG_05;
    i4 = _fx_rv_ap_lens_C2_FX_ENG_05;
    i5 = _fx_rv_ap_ofs_C2_FX_ENG_05;
    r10 = 0x3F000000;  /* 0.5 IEEE 754 */                   /* allpass feedback */
    r5 = 4;
    lcntr = r5; do .rv_ap_C2_FX_ENG_05 until lce;
        r1 = dm(i3, 0);
        r2 = dm(i4, 1);
        r3 = dm(i5, 1);
        r4 = r3 + r1;
...
.fx_off_C2_FX_ENG_05:
     ...
     * second `dm(_buf_C2_FX_ENG_05) = r0;` anywhere in the body would
     * make that match ambiguous and stop the generator. */
    r1 = 0;
    dm(_buf_C2_FX_ENG_05) = r1;
    dm(_buf_L_C2_FX_ENG_05) = r1;
    dm(_buf_R_C2_FX_ENG_05) = r1;
    rts;

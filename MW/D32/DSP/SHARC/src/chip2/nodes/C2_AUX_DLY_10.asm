...
.section/dm seg_dmda;
.global _dly_write_ptr_C2_AUX_DLY_10;
.var _dly_write_ptr_C2_AUX_DLY_10 = 0;
.global _dly_read_offset_C2_AUX_DLY_10;
.var _dly_read_offset_C2_AUX_DLY_10 = 0;      /* in samples; 0 = no delay */
.global _dly_pool_slot_C2_AUX_DLY_10;
.var _dly_pool_slot_C2_AUX_DLY_10 = -1; /* reserved for future reassignment */
.global _dly_max_C2_AUX_DLY_10;
.var _dly_max_C2_AUX_DLY_10 = 12000;
.global _tap_pre_fader_C2_AUX_DLY_10;
.var _tap_pre_fader_C2_AUX_DLY_10;   /* pre-fader tap */
...
_C2_AUX_DLY_10_process:
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_AUX_DLY_10 until lce;
                r3 = dm(_bw_s0_C2_AUX_DLY_10);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_AUX_LIM_10) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_AUX_DLY_10: dm(_bw_d0_C2_AUX_DLY_10) = r3;
    ...
    i0 = _dly_buf_C2_AUX_DLY_10;
    r1 = dm(_dly_write_ptr_C2_AUX_DLY_10);
    m0 = r1;
    modify(i0, m0);
    dm(i0, 0) = r0;

    /* Read from (write_ptr - read_offset) with wrap */
    r2 = dm(_dly_read_offset_C2_AUX_DLY_10);
    r1 = r1 - r2;
    r3 = dm(_dly_max_C2_AUX_DLY_10);
    if lt r1 = r1 + r3;
    i0 = _dly_buf_C2_AUX_DLY_10;
    m0 = r1;
    modify(i0, m0);
    ...
    comp(r1, r3);
    if ge r1 = r1 - r3;
    dm(_dly_write_ptr_C2_AUX_DLY_10) = r1;

    dm(_tap_pre_fader_C2_AUX_DLY_10) = r0;
    dm(_buf_C2_AUX_DLY_10) = r0;
    rts;
_C2_AUX_DLY_10_process.end:

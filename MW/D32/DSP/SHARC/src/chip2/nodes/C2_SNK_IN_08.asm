/*----------------------------------------------------------------------
 * Snake Return 8 Input (AUX_INPUT)
 * Node ID:    C2_SNK_IN_08
 * Chip:       2
 * Channels:   1
 * SPI Page:   1
 * SPI Addr:   1875
...
/* SPI page=1 addr=1875 */

.section/dm seg_dmda;
.extern _buf_C2_XR_SNAKE_08;
.global _auxin_on_C2_SNK_IN_08;
.var _auxin_on_C2_SNK_IN_08 = 0;
.global _auxin_level_C2_SNK_IN_08;
.var _auxin_level_C2_SNK_IN_08 = 1.0;
.global _auxin_level_target_C2_SNK_IN_08;
.var _auxin_level_target_C2_SNK_IN_08 = 1.0;
.global _auxin_level_step_C2_SNK_IN_08;
.var _auxin_level_step_C2_SNK_IN_08 = 0.0;
.global _auxin_level_frames_C2_SNK_IN_08;
.var _auxin_level_frames_C2_SNK_IN_08 = 0;
.global _auxin_q_C2_SNK_IN_08;
.var _auxin_q_C2_SNK_IN_08 = 0;                  /* Q4.28 coeff x assign */
 ...
 * back in. */
.global _auxin_byp_C2_SNK_IN_08;
.var _auxin_byp_C2_SNK_IN_08 = 0;
#endif
.global _buf_C2_SNK_IN_08;
.var _buf_C2_SNK_IN_08;

        #if DSP4_BLOCK_KERNELS
        .extern _blk_C2_XR_SNAKE_08;
        #endif
        #if DSP4_BLOCK_KERNELS
        .global _blk_C2_SNK_IN_08;
        .var _blk_C2_SNK_IN_08[DSP4_BLOCK_SIZE];
        .global _bw_k_C2_SNK_IN_08;
        .var _bw_k_C2_SNK_IN_08;        /* the caller's _sample_idx */
        .global _bw_s0_C2_SNK_IN_08;
        .var _bw_s0_C2_SNK_IN_08;       /* walking source pointer */
        .global _bw_d0_C2_SNK_IN_08;
        .var _bw_d0_C2_SNK_IN_08;       /* walking sink pointer */
        #endif

.section/pm seg_pmco;
.extern _sample_idx;
.extern _mrf_rns28;
.global _C2_SNK_IN_08_process;
_C2_SNK_IN_08_process:
        #if DSP4_BLOCK_KERNELS
        #if DSP4_AUXIN_BYPASS
            /* ---- PARK: _auxin_on_C2_SNK_IN_08 is off ---- */
            r5 = dm(_auxin_on_C2_SNK_IN_08);
            r5 = pass r5;
            if ne jump (pc, .bwrun_C2_SNK_IN_08);
            r0 = 1;
            dm(_auxin_byp_C2_SNK_IN_08) = r0;
            l0 = 0;
            r0 = 0;
            i0 = _blk_C2_SNK_IN_08;
            lcntr = DSP4_BLOCK_SIZE, do .bwpk_C2_SNK_IN_08 until lce;
            .bwpk_C2_SNK_IN_08: dm(i0, 1) = r0;
        ...
        .bwrun_C2_SNK_IN_08:
             ...
             */
            i4 = _blk_C2_XR_SNAKE_08;
            r3 = i4;
            dm(_bw_s0_C2_SNK_IN_08) = r3;
            i4 = _blk_C2_SNK_IN_08;
            r3 = i4;
            dm(_bw_d0_C2_SNK_IN_08) = r3;
            r5 = dm(_sample_idx);
            dm(_bw_k_C2_SNK_IN_08) = r5;
            r5 = 0;
            dm(_sample_idx) = r5;
            /* sample 0, peeled: the block-rate guard fires here */
                r3 = dm(_bw_s0_C2_SNK_IN_08);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_XR_SNAKE_08) = r0;
                r3 = r3 + 1;
                dm(_bw_s0_C2_SNK_IN_08) = r3;
                call _C2_SNK_IN_08_process_sample;
                r0 = dm(_buf_C2_SNK_IN_08);
                r3 = dm(_bw_d0_C2_SNK_IN_08);
                i4 = r3;
                dm(i4, 0) = r0;
                r3 = r3 + 1;
                dm(_bw_d0_C2_SNK_IN_08) = r3;
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_SNK_IN_08 until lce;
                r3 = dm(_bw_s0_C2_SNK_IN_08);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_XR_SNAKE_08) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_SNK_IN_08: dm(_bw_d0_C2_SNK_IN_08) = r3;
            r5 = dm(_bw_k_C2_SNK_IN_08);
            dm(_sample_idx) = r5;
            rts;

        .global _C2_SNK_IN_08_process_sample;
        _C2_SNK_IN_08_process_sample:
        #endif
    ...
    r1 = 0;
    comp(r4, r1);
    if ne jump (pc, .auxin_apply_C2_SNK_IN_08);
#if DSP4_BLOCK_KERNELS && DSP4_AUXIN_BYPASS
    ...
    r2 = pass r2;
    if eq jump (pc, .auxin_live_C2_SNK_IN_08);
    r2 = 0;
    dm(_auxin_byp_C2_SNK_IN_08) = r2;
    dm(_auxin_level_frames_C2_SNK_IN_08) = r2;
.auxin_live_C2_SNK_IN_08:
#endif
    r4 = dm(_auxin_level_frames_C2_SNK_IN_08);
    r15 = DSP4_BLOCK_SIZE;
    r4 = r4 - r15;
    if le jump (pc, .no_auxramp_C2_SNK_IN_08);
    dm(_auxin_level_frames_C2_SNK_IN_08) = r4;
    f1 = dm(_auxin_level_C2_SNK_IN_08);
    f2 = dm(_auxin_level_step_C2_SNK_IN_08);
    r15 = DSP4_BLOCK_F32;             /* BLOCK_SIZE as float */
    f15 = r15;
    f2 = f2 * f15;
    f1 = f1 + f2;
    dm(_auxin_level_C2_SNK_IN_08) = f1;
    jump (pc, .auxin_go_C2_SNK_IN_08);
.no_auxramp_C2_SNK_IN_08:
    f1 = dm(_auxin_level_target_C2_SNK_IN_08);
    dm(_auxin_level_C2_SNK_IN_08) = f1;
.auxin_go_C2_SNK_IN_08:
    r2 = 0x4D800000;
    f2 = r2;
    f1 = f1 * f2;
    r1 = fix f1;
    ...
    r2 = pass r2;
    if eq r1 = r3;
    dm(_auxin_q_C2_SNK_IN_08) = r1;

.auxin_apply_C2_SNK_IN_08:
    r0 = dm(_buf_C2_XR_SNAKE_08);
    r1 = dm(_auxin_q_C2_SNK_IN_08);
    mrf = r0 * r1 (ssi);
    call _mrf_rns28;
    dm(_buf_C2_SNK_IN_08) = r0;
    rts;
_C2_SNK_IN_08_process.end:

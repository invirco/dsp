...
.var _mtr_acc_C2_MTR_GRP_02[4];          /* mx mn ssq_lo ssq_hi            */
#endif
...
_C2_MTR_GRP_02_process:
     ...
     *
     * LIMITATION, recorded: C2_GRP_COMP_02 publishes no
     * block under DSP4_BLOCK_KERNELS, only the
     * scalar _buf_C2_GRP_COMP_02 holding the LAST sample,

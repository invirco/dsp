...
.extern _buf_C2_FX_ENG_02;
        ...
        .global _fdr_dca_sel_C2_FX_FDR_02;
        .var _fdr_dca_sel_C2_FX_FDR_02 = 0;              /* 0 = no DCA assigned */
        .global _fdr_dca_gain_C2_FX_FDR_02;
        .var _fdr_dca_gain_C2_FX_FDR_02 = 1.0;           /* resolved master gain */
        ...
        .global _fdr_busy_C2_FX_FDR_02;
        .global _fdr_busy_C2_FX_FDR_02;
        .var _fdr_busy_C2_FX_FDR_02 = 0;
        #endif
        ...
        .global _mtr_wide_C2_FX_FDR_02;
        .var _mtr_wide_C2_FX_FDR_02;

        .section/pm seg_pmco;
        .extern _sample_idx;
        .extern _mrf_rns28;
        .extern _mtr_acc_C2_MTR_FX_02;
        .extern _mtr_flush;
        ...
        _C2_FX_FDR_02_process:
            ...
            r1 = dm(_fdr_pan_frames_C2_FX_FDR_02);
            r1 = max(r1, r4);
            r5 = 0;
            r1 = max(r1, r5);
            dm(_fdr_busy_C2_FX_FDR_02) = r1;
        #endif
        ...
        .cvt_C2_FX_FDR_02:
             ...
             * construction. */
            r14 = DSP4_BLOCK_HALF;
            lcntr = r14; do .fdr_lp_C2_FX_FDR_02 until lce;
                r0 = dm(i0, 1);                 /* xA */
                r3 = dm(i0, 1);                 /* xB */
                mrf = r0 * r1 (ssi);
                mrb = r3 * r1 (ssi);
        ...
        .fdr_lp_C2_FX_FDR_02:
                dm(i1, 1) = r3;
            dm(_tap_post_fader_C2_FX_FDR_02) = r3;   /* linkage scalars */
            dm(_buf_C2_FX_FDR_02) = r3;
            rts;
        #else
            r14 = DSP4_BLOCK_SIZE;
        .fdr_lp_C2_FX_FDR_02:
        ...
        .fdr_lp_C2_FX_FDR_02:
                dm(i1, 1) = r0;
            dm(_tap_post_fader_C2_FX_FDR_02) = r0;   /* linkage scalars */
            dm(_buf_C2_FX_FDR_02) = r0;
            /* the last sample's meter ops, outside the loop */
            r13 = max(r13, r6);
            mrf = mrf + r6 * r6 (ssi);
            r15 = min(r15, r6);
            r0 = _mtr_acc_C2_MTR_FX_02;
            call _mtr_flush;
            rts;
        #endif
#else

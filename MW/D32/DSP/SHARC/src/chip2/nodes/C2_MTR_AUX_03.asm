...
#include "dsp_block.h"
        ...
        /* SPI page=1 addr=1780 */

        #include "blk_pool.h"

        .section/dm seg_dmda;
        /* ORDER IS LOAD-BEARING: _mtr_fold takes the address of
         * _mtr_peak_C2_MTR_AUX_03 and reaches the rest by offset. The three float
         * words keep their names and their SPI dispatch entries. */
        .global _mtr_peak_C2_MTR_AUX_03;
        .var _mtr_peak_C2_MTR_AUX_03 = 0.0;      /* +0 linear peak, host contract */
        .global _mtr_rms_C2_MTR_AUX_03;
        .var _mtr_rms_C2_MTR_AUX_03 = 0.0;       /* +1 linear TRUE rms            */
        .global _mtr_gr_C2_MTR_AUX_03;
        .var _mtr_gr_C2_MTR_AUX_03 = 0.0;        /* +2 gain reduction -- see below */
        .global _mtr_st_C2_MTR_AUX_03;
        .var _mtr_st_C2_MTR_AUX_03[4];           /* +3 pk_lo pk_hi ms_lo ms_hi     */
         ...
         * is state and not a sign extension. Filled by C2_AUX_OUT_03 under block
         * kernels and by this node's own per-sample body otherwise. */
        .global _mtr_acc_C2_MTR_AUX_03;
        .var _mtr_acc_C2_MTR_AUX_03[5];          /* mx mn ssq_lo ssq_hi ssq_ex     */

        .section/pm seg_pmco;
        .extern _mtr_fold;
        .extern _sample_idx;
        .extern _mtr_wide_C2_AUX_OUT_03;
...
/* WIDE WORD, 'scalar' shape. C2_AUX_OUT_03 has no accumulator at this
...
r0 = _mtr_peak_C2_MTR_AUX_03;
             ...
             *
             * Source: _mtr_wide_C2_AUX_OUT_03, the Q8.24 word C2_AUX_OUT_03 publishes. */
            r0 = dm(_mtr_wide_C2_AUX_OUT_03);
            r4 = dm(_sample_idx);
            r1 = 0;
            comp(r4, r1);
            if ne jump (pc, .mtacc_C2_MTR_AUX_03);
            /* first sample of the block: seed rather than accumulate */
            dm(_mtr_acc_C2_MTR_AUX_03 + 0) = r0;
            dm(_mtr_acc_C2_MTR_AUX_03 + 1) = r0;
            mrf = 0;
            mrf = mrf + r0 * r0 (ssi);
            r2 = mr0f;
            dm(_mtr_acc_C2_MTR_AUX_03 + 2) = r2;
            r2 = mr1f;
            dm(_mtr_acc_C2_MTR_AUX_03 + 3) = r2;
            r2 = mr2f;
            dm(_mtr_acc_C2_MTR_AUX_03 + 4) = r2;
            rts;
        .mtacc_C2_MTR_AUX_03:
            r2 = dm(_mtr_acc_C2_MTR_AUX_03 + 0);
            r2 = max(r2, r0);
            dm(_mtr_acc_C2_MTR_AUX_03 + 0) = r2;
            r2 = dm(_mtr_acc_C2_MTR_AUX_03 + 1);
            r2 = min(r2, r0);
            dm(_mtr_acc_C2_MTR_AUX_03 + 1) = r2;
            r2 = dm(_mtr_acc_C2_MTR_AUX_03 + 2);
            mr0f = r2;
            r3 = dm(_mtr_acc_C2_MTR_AUX_03 + 3);
            mr1f = r3;
            r2 = dm(_mtr_acc_C2_MTR_AUX_03 + 4);
            mr2f = r2;
            mrf = mrf + r0 * r0 (ssi);
            r2 = mr0f;
            dm(_mtr_acc_C2_MTR_AUX_03 + 2) = r2;
            ...
            comp(r4, r1);
            if ne rts;
            r8 = dm(_mtr_acc_C2_MTR_AUX_03 + 0);
            r9 = dm(_mtr_acc_C2_MTR_AUX_03 + 1);
            r0 = _mtr_peak_C2_MTR_AUX_03;
            call _mtr_fold;
            rts;
        #endif
        ...
        /* _mtr_gr_C2_MTR_AUX_03 IS STILL NOT WRITTEN, and that is recorded defect

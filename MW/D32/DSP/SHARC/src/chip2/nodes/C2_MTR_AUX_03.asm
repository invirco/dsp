...
.var _mtr_acc_C2_MTR_AUX_03[4];          /* mx mn ssq_lo ssq_hi            */
#endif
...
_C2_MTR_AUX_03_process:
     ...
     *
     * LIMITATION, recorded: C2_AUX_OUT_03 publishes no
     * block under DSP4_BLOCK_KERNELS, only the
     * scalar _buf_C2_AUX_OUT_03 holding the LAST sample,

...
.extern _buf_C2_RECV_GRP_01;
        ...
        .var _fdr_gq_C2_GRP_FDR_01 = 0x10000000;          /* Q4.28 level */
        ...
        #if DSP4_BLOCK_KERNELS
        .extern _blk_C2_RECV_GRP_01;
        .global _blk_C2_GRP_FDR_01;
        .var _blk_C2_GRP_FDR_01[DSP4_BLOCK_SIZE];
        #endif
        ...
        .cvt_C2_GRP_FDR_01:
            ...
            l2 = 0;
            l3 = 0;
            i0 = _blk_C2_RECV_GRP_01;                 /* input  */
            i1 = _blk_C2_GRP_FDR_01;                 /* mono   */
        #if DSP4_STRIP_FUSED

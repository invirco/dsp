...
#if DSP4_BQ_FLOAT
.global _eq_coeffs_A_C2_AUX_EQ_01;
.var _eq_coeffs_A_C2_AUX_EQ_01[20] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#elif DSP4_BQ_GUARD
.global _eq_coeffs_A_C2_AUX_EQ_01;
.var _eq_coeffs_A_C2_AUX_EQ_01[20 + 1] = 0, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#else
.global _eq_coeffs_A_C2_AUX_EQ_01;
.var _eq_coeffs_A_C2_AUX_EQ_01[20] = 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#endif
.global _eq_state_A_C2_AUX_EQ_01;
.var _eq_state_A_C2_AUX_EQ_01[24];
#if DSP4_BQ_FLOAT
.global _eq_coeffs_B_C2_AUX_EQ_01;
.var _eq_coeffs_B_C2_AUX_EQ_01[20] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#elif DSP4_BQ_GUARD
.global _eq_coeffs_B_C2_AUX_EQ_01;
.var _eq_coeffs_B_C2_AUX_EQ_01[20 + 1] = 0, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#else
.global _eq_coeffs_B_C2_AUX_EQ_01;
.var _eq_coeffs_B_C2_AUX_EQ_01[20] = 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#endif
.global _eq_state_B_C2_AUX_EQ_01;
.var _eq_state_B_C2_AUX_EQ_01[24];
...
#if DSP4_BQ_FLOAT
.global _eq_coeffs_next_C2_AUX_EQ_01;
.var _eq_coeffs_next_C2_AUX_EQ_01[20] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#else
.global _eq_coeffs_next_C2_AUX_EQ_01;
.var _eq_coeffs_next_C2_AUX_EQ_01[20];
#endif
.global _eq_swap_pending_C2_AUX_EQ_01;
.var _eq_swap_pending_C2_AUX_EQ_01 = 0;
#if DSP4_BQ_GUARD
.global _eq_hrw_C2_AUX_EQ_01;
.var _eq_hrw_C2_AUX_EQ_01 = 0;        /* 0 idle, 1 asked, 2 re-ask */
.global _eq_hrl_C2_AUX_EQ_01;
.var _eq_hrl_C2_AUX_EQ_01[2];       /* (block, stages) pairs */
#endif

.global _eq_active_C2_AUX_EQ_01;
.var _eq_active_C2_AUX_EQ_01 = 0;            /* 0 = A active, 1 = B */
.global _eq_xfade_alpha_C2_AUX_EQ_01;
.var _eq_xfade_alpha_C2_AUX_EQ_01 = 0.0;     /* float control */
.global _eq_xfade_step_C2_AUX_EQ_01;
.var _eq_xfade_step_C2_AUX_EQ_01 = 0.0;

.global _tap_post_eq_C2_AUX_EQ_01;
.var _tap_post_eq_C2_AUX_EQ_01;              /* Q4.28 post-EQ tap */
.global _buf_C2_AUX_EQ_01;
.var _buf_C2_AUX_EQ_01;

        #if DSP4_BLOCK_KERNELS
        .extern _blk_C2_AUX_FDR_01;
        #endif
        #if DSP4_BLOCK_KERNELS
        .global _blk_C2_AUX_EQ_01;
        .var _blk_C2_AUX_EQ_01[DSP4_BLOCK_SIZE];
        .global _bw_k_C2_AUX_EQ_01;
        .var _bw_k_C2_AUX_EQ_01;        /* the caller's _sample_idx */
        .global _bw_s0_C2_AUX_EQ_01;
        .var _bw_s0_C2_AUX_EQ_01;       /* walking source pointer */
        .global _bw_d0_C2_AUX_EQ_01;
        .var _bw_d0_C2_AUX_EQ_01;       /* walking sink pointer */
        #endif
...
.extern _bq_hr_node1;
#endif
.global _C2_AUX_EQ_01_process;
_C2_AUX_EQ_01_process:
        #if DSP4_BLOCK_KERNELS
    ...
    r4 = dm(_eq_swap_pending_C2_AUX_EQ_01);
    r5 = dm(_eq_xfade_step_C2_AUX_EQ_01);
    r4 = r4 or r5;
#if DSP4_BQ_GUARD
    r5 = dm(_eq_hrw_C2_AUX_EQ_01);
    r4 = r4 or r5;      /* a sizing in flight is a transient too */
#endif
    r4 = pass r4;
    if ne jump (pc, .eqkb_tr_C2_AUX_EQ_01);
    ...
    lcntr = DSP4_BLOCK_SIZE, do .eqkb_cp_C2_AUX_EQ_01 until lce;
        r0 = dm(i3, 1);
    .eqkb_cp_C2_AUX_EQ_01: dm(i4, 1) = r0;

    r4 = dm(_eq_active_C2_AUX_EQ_01);
    r4 = pass r4;
    if ne jump (pc, .eqkb_b_C2_AUX_EQ_01);
    i0 = _eq_coeffs_A_C2_AUX_EQ_01;
    i1 = _eq_state_A_C2_AUX_EQ_01;
    jump (pc, .eqkb_go_C2_AUX_EQ_01);
.eqkb_b_C2_AUX_EQ_01:
    i0 = _eq_coeffs_B_C2_AUX_EQ_01;
    i1 = _eq_state_B_C2_AUX_EQ_01;
.eqkb_go_C2_AUX_EQ_01:
    i2 = _blk_C2_AUX_EQ_01;
    r4 = 4;
...
.eqkb_tr_C2_AUX_EQ_01:
             ...
             */
            i4 = _blk_C2_AUX_FDR_01;
            r3 = i4;
            dm(_bw_s0_C2_AUX_EQ_01) = r3;
            i4 = _blk_C2_AUX_EQ_01;
            r3 = i4;
            dm(_bw_d0_C2_AUX_EQ_01) = r3;
            r5 = dm(_sample_idx);
            dm(_bw_k_C2_AUX_EQ_01) = r5;
            r5 = 0;
            dm(_sample_idx) = r5;
            /* sample 0, peeled: the block-rate guard fires here */
                r3 = dm(_bw_s0_C2_AUX_EQ_01);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_AUX_FDR_01) = r0;
                r3 = r3 + 1;
                dm(_bw_s0_C2_AUX_EQ_01) = r3;
                call _C2_AUX_EQ_01_process_sample;
                r0 = dm(_buf_C2_AUX_EQ_01);
                r3 = dm(_bw_d0_C2_AUX_EQ_01);
                i4 = r3;
                dm(i4, 0) = r0;
                r3 = r3 + 1;
                dm(_bw_d0_C2_AUX_EQ_01) = r3;
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_AUX_EQ_01 until lce;
                r3 = dm(_bw_s0_C2_AUX_EQ_01);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_AUX_FDR_01) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_AUX_EQ_01: dm(_bw_d0_C2_AUX_EQ_01) = r3;
            r5 = dm(_bw_k_C2_AUX_EQ_01);
            dm(_sample_idx) = r5;
            rts;

        .global _C2_AUX_EQ_01_process_sample;
        _C2_AUX_EQ_01_process_sample:
        #endif
    ...
    #endif
    r4 = pass r4;
    if ne call _eq_start_xfade_C2_AUX_EQ_01;

    /* crossfading? (float 0.0 is all-zero bits) */
    r4 = dm(_eq_xfade_step_C2_AUX_EQ_01);
    r4 = pass r4;
    if ne jump (pc, .eq_xfade_C2_AUX_EQ_01);

    /* ===== steady state: active instance only ===== */
    r0 = dm(_buf_C2_AUX_FDR_01);
    r4 = dm(_eq_active_C2_AUX_EQ_01);
    r4 = pass r4;
    if ne jump (pc, .eq_ss_b_C2_AUX_EQ_01);
    i0 = _eq_coeffs_A_C2_AUX_EQ_01;
    i1 = _eq_state_A_C2_AUX_EQ_01;
    jump (pc, .eq_ss_go_C2_AUX_EQ_01);
.eq_ss_b_C2_AUX_EQ_01:
    i0 = _eq_coeffs_B_C2_AUX_EQ_01;
    i1 = _eq_state_B_C2_AUX_EQ_01;
.eq_ss_go_C2_AUX_EQ_01:
    r4 = 4;
...
.eq_xfade_C2_AUX_EQ_01:
    ...
    r4 = dm(_eq_active_C2_AUX_EQ_01);
    r4 = pass r4;
    if eq jump (pc, .eq_bl_C2_AUX_EQ_01);     /* active A -> new is B (r0) */
    r5 = r14;                      /* new = ya */
    r14 = r0;                      /* old = yb */
    r0 = r5;
.eq_bl_C2_AUX_EQ_01:
    f4 = dm(_eq_xfade_alpha_C2_AUX_EQ_01);
    ...
    f4 = dm(_eq_xfade_alpha_C2_AUX_EQ_01);
    f5 = dm(_eq_xfade_step_C2_AUX_EQ_01);
    f4 = f4 + f5;
    dm(_eq_xfade_alpha_C2_AUX_EQ_01) = f4;
    r5 = 0x3F800000;               /* 1.0f */
    f5 = r5;
    comp(f4, f5);
    if lt rts;
    ...
    r5 = 1;
    r4 = r4 xor r5;
    dm(_eq_active_C2_AUX_EQ_01) = r4;
    r4 = 0;
    dm(_eq_xfade_step_C2_AUX_EQ_01) = r4;
    dm(_eq_xfade_alpha_C2_AUX_EQ_01) = r4;
    rts;

    /* ===== stage new coeffs into the dormant instance ===== */
_eq_start_xfade_C2_AUX_EQ_01:
    #if DSP4_BQ_GUARD
    /* Convert, size, and hold the fade until H is written. */
    r0 = _eq_hrw_C2_AUX_EQ_01;
    r1 = _eq_hrl_C2_AUX_EQ_01;
    r2 = _eq_active_C2_AUX_EQ_01;
    r3 = _eq_coeffs_A_C2_AUX_EQ_01;
    r4 = _eq_coeffs_B_C2_AUX_EQ_01;
    r5 = _eq_state_A_C2_AUX_EQ_01;
    r6 = _eq_state_B_C2_AUX_EQ_01;
    r7 = _eq_coeffs_next_C2_AUX_EQ_01;
    r8 = 4;
    call _bq_hr_node1;      /* i2 = dormant state on success */
    r0 = pass r0;
    if eq rts;              /* not sized yet; back next block */
    r4 = 0;
    dm(_eq_swap_pending_C2_AUX_EQ_01) = r4;
    #endif
#if !DSP4_BQ_GUARD
    r4 = 0;
    dm(_eq_swap_pending_C2_AUX_EQ_01) = r4;
    i0 = _eq_coeffs_next_C2_AUX_EQ_01;    /* float staged */
    r4 = dm(_eq_active_C2_AUX_EQ_01);
    r4 = pass r4;
    if ne jump (pc, .eq_st_a_C2_AUX_EQ_01);
    i1 = _eq_coeffs_B_C2_AUX_EQ_01;       /* dormant = B */
    i2 = _eq_state_B_C2_AUX_EQ_01;
    jump (pc, .eq_st_go_C2_AUX_EQ_01);
.eq_st_a_C2_AUX_EQ_01:
    i1 = _eq_coeffs_A_C2_AUX_EQ_01;
    i2 = _eq_state_A_C2_AUX_EQ_01;
.eq_st_go_C2_AUX_EQ_01:
    r4 = 4;
    ...
    r4 = 0;
    r5 = 24;
    lcntr = r5, do .eq_zst_C2_AUX_EQ_01 until lce;
.eq_zst_C2_AUX_EQ_01:
        dm(i2, 1) = r4;
    /* start ramp: step = 1/XFADE_SAMPLES (float control) */
    f0 = 0.001736111111111111;
    dm(_eq_xfade_step_C2_AUX_EQ_01) = f0;
    r4 = 0;
    dm(_eq_xfade_alpha_C2_AUX_EQ_01) = r4;
    rts;
_C2_AUX_EQ_01_process.end:

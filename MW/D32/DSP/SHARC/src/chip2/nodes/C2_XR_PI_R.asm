...
.global _blk_C2_XR_PI_R;
.var _blk_C2_XR_PI_R[DSP4_BLOCK_SIZE];
...
_C2_XR_PI_R_process:
    ...
    lcntr = r5; do .icr_sig_C2_XR_PI_R until lce;
...
.icr_lp_C2_XR_PI_R:
    ...
    r2 = -r0;
    r3 = dm(_rx_ic_slot_C2_XR_PI_R);  /* production read, still paid */
    r3 = pass r1;

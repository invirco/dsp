/*----------------------------------------------------------------------
 * Aux 8 AntiFB (ANTI_FB)
 * Node ID:    C2_AUX_AFB_08
 * Chip:       2
 * Channels:   1
 * SPI Page:   1
 * SPI Addr:   689
...
.extern _sample_idx;
.global _afb_on_C2_AUX_AFB_08;
.var _afb_on_C2_AUX_AFB_08 = 0;
.global _afb_ctrl_on_C2_AUX_AFB_08;
.var _afb_ctrl_on_C2_AUX_AFB_08 = 0;   /* the AUTOMATIC detector's switch — no
                        * detector exists; read by nothing, and
                        * that is deliberate (afb_design_fx.asm) */
.global _afb_notch_freq_C2_AUX_AFB_08;
.var _afb_notch_freq_C2_AUX_AFB_08[6];
.global _afb_notch_gain_C2_AUX_AFB_08;
.var _afb_notch_gain_C2_AUX_AFB_08[6];
.global _afb_notch_q_C2_AUX_AFB_08;
.var _afb_notch_q_C2_AUX_AFB_08[6];
.global _afb_dirty_C2_AUX_AFB_08;
.var _afb_dirty_C2_AUX_AFB_08 = 0;     /* set by the SPI handler; cleared by the design */

#if DSP4_BQ_FLOAT
.global _afb_coeffs_A_C2_AUX_AFB_08;
.var _afb_coeffs_A_C2_AUX_AFB_08[30] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#elif DSP4_BQ_GUARD
.global _afb_coeffs_A_C2_AUX_AFB_08;
...
#endif
.global _afb_state_A_C2_AUX_AFB_08;
.var _afb_state_A_C2_AUX_AFB_08[36];
#if DSP4_BQ_FLOAT
.global _afb_coeffs_B_C2_AUX_AFB_08;
.var _afb_coeffs_B_C2_AUX_AFB_08[30] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#elif DSP4_BQ_GUARD
.global _afb_coeffs_B_C2_AUX_AFB_08;
.var _afb_coeffs_B_C2_AUX_AFB_08[30 + 1] = 0, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#else
.global _afb_coeffs_B_C2_AUX_AFB_08;
.var _afb_coeffs_B_C2_AUX_AFB_08[30] = 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#endif
.global _afb_state_B_C2_AUX_AFB_08;
.var _afb_state_B_C2_AUX_AFB_08[36];

/* SPI staging (FLOAT RBJ words — wire format unchanged) */
#if DSP4_BQ_FLOAT
.global _afb_coeffs_next_C2_AUX_AFB_08;
.var _afb_coeffs_next_C2_AUX_AFB_08[30] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#else
.global _afb_coeffs_next_C2_AUX_AFB_08;
.var _afb_coeffs_next_C2_AUX_AFB_08[30];
#endif
.global _afb_swap_pending_C2_AUX_AFB_08;
.var _afb_swap_pending_C2_AUX_AFB_08 = 0;
#if DSP4_BQ_GUARD
.global _afb_hrw_C2_AUX_AFB_08;
.var _afb_hrw_C2_AUX_AFB_08 = 0;        /* 0 idle, 1 asked, 2 re-ask */
.global _afb_hrl_C2_AUX_AFB_08;
.var _afb_hrl_C2_AUX_AFB_08[2];       /* (block, stages) pairs */
#endif

.global _afb_active_C2_AUX_AFB_08;
.var _afb_active_C2_AUX_AFB_08 = 0;
.global _afb_xfade_alpha_C2_AUX_AFB_08;
.var _afb_xfade_alpha_C2_AUX_AFB_08 = 0.0;
.global _afb_xfade_step_C2_AUX_AFB_08;
.var _afb_xfade_step_C2_AUX_AFB_08 = 0.0;


.global _buf_C2_AUX_AFB_08;
.var _buf_C2_AUX_AFB_08;

        #if DSP4_BLOCK_KERNELS
        .extern _blk_C2_AUX_GEQ_08;
        #endif
        #if DSP4_BLOCK_KERNELS
        .global _blk_C2_AUX_AFB_08;
        .var _blk_C2_AUX_AFB_08[DSP4_BLOCK_SIZE];
        .global _bw_k_C2_AUX_AFB_08;
        .var _bw_k_C2_AUX_AFB_08;        /* the caller's _sample_idx */
        .global _bw_s0_C2_AUX_AFB_08;
        .var _bw_s0_C2_AUX_AFB_08;       /* walking source pointer */
        .global _bw_d0_C2_AUX_AFB_08;
        .var _bw_d0_C2_AUX_AFB_08;       /* walking sink pointer */
        #endif
...
#endif
.global _C2_AUX_AFB_08_process;
_C2_AUX_AFB_08_process:
#if DSP4_AFB_DESIGN
    /* ---- notch design (control rate; lib/afb_design_fx.asm) ---- */
    r4 = dm(_afb_dirty_C2_AUX_AFB_08);
    r4 = pass r4;
    if ne call _afb_redesign_C2_AUX_AFB_08;
#endif
#if DSP4_BLOCK_KERNELS
    ...
    r4 = dm(_afb_swap_pending_C2_AUX_AFB_08);
    r5 = dm(_afb_xfade_step_C2_AUX_AFB_08);
    r4 = r4 or r5;
#if DSP4_BQ_GUARD
    r5 = dm(_afb_hrw_C2_AUX_AFB_08);
    r4 = r4 or r5;      /* a sizing in flight is a transient too */
#endif
    r4 = pass r4;
    if ne jump (pc, .afbkb_tr_C2_AUX_AFB_08);
    ...
    i3 = _blk_C2_AUX_GEQ_08;
    i4 = _blk_C2_AUX_AFB_08;
    lcntr = DSP4_BLOCK_SIZE, do .afbkb_cp_C2_AUX_AFB_08 until lce;
        r0 = dm(i3, 1);
    .afbkb_cp_C2_AUX_AFB_08: dm(i4, 1) = r0;

    r4 = dm(_afb_active_C2_AUX_AFB_08);
    r4 = pass r4;
    if ne jump (pc, .afbkb_b_C2_AUX_AFB_08);
    i0 = _afb_coeffs_A_C2_AUX_AFB_08;
    i1 = _afb_state_A_C2_AUX_AFB_08;
    jump (pc, .afbkb_go_C2_AUX_AFB_08);
.afbkb_b_C2_AUX_AFB_08:
    i0 = _afb_coeffs_B_C2_AUX_AFB_08;
    i1 = _afb_state_B_C2_AUX_AFB_08;
.afbkb_go_C2_AUX_AFB_08:
    i2 = _blk_C2_AUX_AFB_08;
    r4 = 6;
...
.afbkb_tr_C2_AUX_AFB_08:
            ...
            r3 = i4;
            dm(_bw_s0_C2_AUX_AFB_08) = r3;
            i4 = _blk_C2_AUX_AFB_08;
            r3 = i4;
            dm(_bw_d0_C2_AUX_AFB_08) = r3;
            r5 = dm(_sample_idx);
            dm(_bw_k_C2_AUX_AFB_08) = r5;
            r5 = 0;
            dm(_sample_idx) = r5;
            /* sample 0, peeled: the block-rate guard fires here */
                r3 = dm(_bw_s0_C2_AUX_AFB_08);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_AUX_GEQ_08) = r0;
                r3 = r3 + 1;
                dm(_bw_s0_C2_AUX_AFB_08) = r3;
                call _C2_AUX_AFB_08_process_sample;
                r0 = dm(_buf_C2_AUX_AFB_08);
                r3 = dm(_bw_d0_C2_AUX_AFB_08);
                i4 = r3;
                dm(i4, 0) = r0;
                r3 = r3 + 1;
                dm(_bw_d0_C2_AUX_AFB_08) = r3;
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_AUX_AFB_08 until lce;
                r3 = dm(_bw_s0_C2_AUX_AFB_08);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_AUX_GEQ_08) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_AUX_AFB_08: dm(_bw_d0_C2_AUX_AFB_08) = r3;
            r5 = dm(_bw_k_C2_AUX_AFB_08);
            dm(_sample_idx) = r5;
            rts;

        .global _C2_AUX_AFB_08_process_sample;
        _C2_AUX_AFB_08_process_sample:
        #endif
    ...
    #endif
    r4 = pass r4;
    if ne call _afb_start_xfade_C2_AUX_AFB_08;

    r4 = dm(_afb_xfade_step_C2_AUX_AFB_08);
    r4 = pass r4;
    if ne jump (pc, .afb_xfade_C2_AUX_AFB_08);

    /* ===== steady state ===== */
    r0 = dm(_buf_C2_AUX_GEQ_08);
    r4 = dm(_afb_active_C2_AUX_AFB_08);
    r4 = pass r4;
    if ne jump (pc, .afb_ss_b_C2_AUX_AFB_08);
    i0 = _afb_coeffs_A_C2_AUX_AFB_08;
    i1 = _afb_state_A_C2_AUX_AFB_08;
    jump (pc, .afb_ss_go_C2_AUX_AFB_08);
.afb_ss_b_C2_AUX_AFB_08:
    i0 = _afb_coeffs_B_C2_AUX_AFB_08;
    i1 = _afb_state_B_C2_AUX_AFB_08;
.afb_ss_go_C2_AUX_AFB_08:
    r4 = 6;
...
.afb_xfade_C2_AUX_AFB_08:
    ...
    r4 = dm(_afb_active_C2_AUX_AFB_08);
    r4 = pass r4;
    if eq jump (pc, .afb_bl_C2_AUX_AFB_08);
    r5 = r14;                     /* active B: new is A */
    r14 = r0;
    r0 = r5;
.afb_bl_C2_AUX_AFB_08:
    f4 = dm(_afb_xfade_alpha_C2_AUX_AFB_08);
    ...
    f4 = dm(_afb_xfade_alpha_C2_AUX_AFB_08);
    f5 = dm(_afb_xfade_step_C2_AUX_AFB_08);
    f4 = f4 + f5;
    dm(_afb_xfade_alpha_C2_AUX_AFB_08) = f4;
    r5 = 0x3F800000;
    f5 = r5;
    comp(f4, f5);
    if lt rts;
    ...
    r5 = 1;
    r4 = r4 xor r5;
    dm(_afb_active_C2_AUX_AFB_08) = r4;
    r4 = 0;
    dm(_afb_xfade_step_C2_AUX_AFB_08) = r4;
    dm(_afb_xfade_alpha_C2_AUX_AFB_08) = r4;
    rts;

    /* ===== stage new coeffs into dormant ===== */
_afb_start_xfade_C2_AUX_AFB_08:
    #if DSP4_BQ_GUARD
    /* Convert, size, and hold the fade until H is written. */
    r0 = _afb_hrw_C2_AUX_AFB_08;
    r1 = _afb_hrl_C2_AUX_AFB_08;
    r2 = _afb_active_C2_AUX_AFB_08;
    r3 = _afb_coeffs_A_C2_AUX_AFB_08;
    r4 = _afb_coeffs_B_C2_AUX_AFB_08;
    r5 = _afb_state_A_C2_AUX_AFB_08;
    r6 = _afb_state_B_C2_AUX_AFB_08;
    r7 = _afb_coeffs_next_C2_AUX_AFB_08;
    r8 = 6;
    call _bq_hr_node1;      /* i2 = dormant state on success */
    r0 = pass r0;
    if eq rts;              /* not sized yet; back next block */
    r4 = 0;
    dm(_afb_swap_pending_C2_AUX_AFB_08) = r4;
    #endif
#if !DSP4_BQ_GUARD
    r4 = 0;
    dm(_afb_swap_pending_C2_AUX_AFB_08) = r4;
    i0 = _afb_coeffs_next_C2_AUX_AFB_08;
    r4 = dm(_afb_active_C2_AUX_AFB_08);
    r4 = pass r4;
    if ne jump (pc, .afb_st_a_C2_AUX_AFB_08);
    i1 = _afb_coeffs_B_C2_AUX_AFB_08;
    i2 = _afb_state_B_C2_AUX_AFB_08;
    jump (pc, .afb_st_go_C2_AUX_AFB_08);
.afb_st_a_C2_AUX_AFB_08:
    i1 = _afb_coeffs_A_C2_AUX_AFB_08;
    i2 = _afb_state_A_C2_AUX_AFB_08;
.afb_st_go_C2_AUX_AFB_08:
    r4 = 6;
    call _bq_fx_convert_N;
#endif
    r4 = 0;
    r5 = 36;
    lcntr = r5, do .afb_zst_C2_AUX_AFB_08 until lce;
.afb_zst_C2_AUX_AFB_08:
        dm(i2, 1) = r4;
    f0 = 0.001736111111111111;
    dm(_afb_xfade_step_C2_AUX_AFB_08) = f0;
    r4 = 0;
    dm(_afb_xfade_alpha_C2_AUX_AFB_08) = r4;
    rts;
#if DSP4_AFB_DESIGN
_afb_redesign_C2_AUX_AFB_08:
    ...
    r4 = 0;
    dm(_afb_dirty_C2_AUX_AFB_08) = r4;
    i0 = _afb_notch_freq_C2_AUX_AFB_08;
    i1 = _afb_notch_gain_C2_AUX_AFB_08;
    i4 = _afb_notch_q_C2_AUX_AFB_08;
    i2 = _afb_coeffs_next_C2_AUX_AFB_08;
    r13 = dm(_afb_on_C2_AUX_AFB_08);
    r4 = 6;
    call _afb_design_N;
    r4 = 1;
    dm(_afb_swap_pending_C2_AUX_AFB_08) = r4;

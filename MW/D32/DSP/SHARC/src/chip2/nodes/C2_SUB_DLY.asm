...
.var _buf_C2_SUB_DLY;
        ...
        .global _bw_i_C2_SUB_DLY;
        .var _bw_i_C2_SUB_DLY;        /* sample index, across the call */
...
_C2_SUB_DLY_process:
            ...
            r5 = 0;
            dm(_bw_i_C2_SUB_DLY) = r5;
            lcntr = DSP4_BLOCK_SIZE, do .bwlp_C2_SUB_DLY until lce;
                r5 = dm(_bw_i_C2_SUB_DLY);
                dm(_sample_idx) = r5;
                ...
                r5 = dm(_bw_i_C2_SUB_DLY);
                r5 = r5 + 1;
            .bwlp_C2_SUB_DLY: dm(_bw_i_C2_SUB_DLY) = r5;

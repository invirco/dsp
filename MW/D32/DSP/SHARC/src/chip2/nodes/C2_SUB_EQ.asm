...
.var _buf_C2_SUB_EQ;
        ...
        .global _bw_i_C2_SUB_EQ;
        .var _bw_i_C2_SUB_EQ;        /* sample index, across the call */
...
.eqkb_tr_C2_SUB_EQ:
            ...
            r5 = 0;
            dm(_bw_i_C2_SUB_EQ) = r5;
            lcntr = DSP4_BLOCK_SIZE, do .bwlp_C2_SUB_EQ until lce;
                r5 = dm(_bw_i_C2_SUB_EQ);
                dm(_sample_idx) = r5;
                ...
                r5 = dm(_bw_i_C2_SUB_EQ);
                r5 = r5 + 1;
            .bwlp_C2_SUB_EQ: dm(_bw_i_C2_SUB_EQ) = r5;

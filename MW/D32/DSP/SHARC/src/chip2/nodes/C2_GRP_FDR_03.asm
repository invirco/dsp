/*----------------------------------------------------------------------
 * Grp 3 Fader (FADER_PAN)
 * Node ID:    C2_GRP_FDR_03
 * Chip:       2
 * Channels:   1
 * SPI Page:   1
 * SPI Addr:   1200
...
#include "lib/dyn_lut.h"
        ...
        /* SPI page=1 addr=1200 */

        .section/dm seg_dmda;
.extern _buf_C2_RECV_GRP_03;
        .global _fdr_level_C2_GRP_FDR_03;
        .var _fdr_level_C2_GRP_FDR_03 = 1.0;
        .global _fdr_level_target_C2_GRP_FDR_03;
        .var _fdr_level_target_C2_GRP_FDR_03 = 1.0;
        .global _fdr_level_step_C2_GRP_FDR_03;
        .var _fdr_level_step_C2_GRP_FDR_03 = 0.0;
        ...
        .var _fdr_pan_step_C2_GRP_FDR_03 = 0.0;
        .global _fdr_pan_frames_C2_GRP_FDR_03;
        .var _fdr_pan_frames_C2_GRP_FDR_03 = 0;
        ...
        .var _fdr_gq_C2_GRP_FDR_03 = 0x10000000;          /* Q4.28 level */
        ...
        .global _fdr_busy_C2_GRP_FDR_03;
        .global _fdr_busy_C2_GRP_FDR_03;
        .var _fdr_busy_C2_GRP_FDR_03 = 0;
        #endif
        ...
        #if DSP4_BLOCK_KERNELS
        .extern _blk_C2_RECV_GRP_03;
        .global _blk_C2_GRP_FDR_03;
        .var _blk_C2_GRP_FDR_03[DSP4_BLOCK_SIZE];
        #endif
        ...
        _C2_GRP_FDR_03_process:
            ...
            r1 = dm(_fdr_pan_frames_C2_GRP_FDR_03);
            r1 = max(r1, r4);
            r5 = 0;
            r1 = max(r1, r5);
            dm(_fdr_busy_C2_GRP_FDR_03) = r1;
        #endif
        ...
        .cvt_C2_GRP_FDR_03:
            ...
            l2 = 0;
            l3 = 0;
            i0 = _blk_C2_RECV_GRP_03;                 /* input  */
            i1 = _blk_C2_GRP_FDR_03;                 /* mono   */
        #if DSP4_STRIP_FUSED
             ...
             * construction. */
            r14 = DSP4_BLOCK_HALF;
            lcntr = r14; do .fdr_lp_C2_GRP_FDR_03 until lce;
                r0 = dm(i0, 1);                 /* xA */
                r3 = dm(i0, 1);                 /* xB */
                mrf = r0 * r1 (ssi);
                mrb = r3 * r1 (ssi);
                ...
                dm(i1, 1) = r0;
        .fdr_lp_C2_GRP_FDR_03:
                dm(i1, 1) = r3;
            dm(_tap_post_fader_C2_GRP_FDR_03) = r3;   /* linkage scalars */
            dm(_buf_C2_GRP_FDR_03) = r3;
            rts;
        #else
            r14 = DSP4_BLOCK_SIZE;
        .fdr_lp_C2_GRP_FDR_03:
            ...
            r13 = r0;
            r14 = r14 - 1;
            if gt jump (pc, .fdr_lp_C2_GRP_FDR_03);
            dm(_tap_post_fader_C2_GRP_FDR_03) = r13;  /* linkage scalars */
            dm(_buf_C2_GRP_FDR_03) = r13;
            rts;
        #endif
#else
        .apply_C2_GRP_FDR_03:

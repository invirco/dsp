...
.var _rx_ic_slot_C2_RECV_SUB[DSP4_BLOCK_SIZE];
...
.global _blk_C2_RECV_SUB;
.var _blk_C2_RECV_SUB[DSP4_BLOCK_SIZE];
...
_C2_RECV_SUB_process:
    ...
    lcntr = r5; do .icr_sig_C2_RECV_SUB until lce;
...
.icr_lp_C2_RECV_SUB:
    ...
    r2 = -r0;
    r3 = dm(_rx_ic_slot_C2_RECV_SUB);  /* production read, still paid */
    r3 = pass r1;

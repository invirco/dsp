...
.var _mtr_acc_C2_MTR_MAIN_01[4];          /* mx mn ssq_lo ssq_hi            */
#endif
...
_C2_MTR_MAIN_01_process:
     ...
     *
     * LIMITATION, recorded: C2_MAIN_OUT_01 publishes no
     * block under DSP4_BLOCK_KERNELS, only the
     * scalar _buf_C2_MAIN_OUT_01 holding the LAST sample,

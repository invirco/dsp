...
.var _rx_ic_slot_C2_RECV_FX_04[DSP4_BLOCK_SIZE];
...
.global _blk_C2_RECV_FX_04;
.var _blk_C2_RECV_FX_04[DSP4_BLOCK_SIZE];
...
_C2_RECV_FX_04_process:
    ...
    l0 = 0;
    l1 = 0;
    i0 = _rx_ic_slot_C2_RECV_FX_04;
    i1 = _blk_C2_RECV_FX_04;
    ...
    lcntr = r5; do .icr_sig_C2_RECV_FX_04 until lce;
        r0 = dm(i0, 1);           /* production read, still paid */
        r0 = r7;                  /* DISCARD it -- see above */
        dm(i1, 1) = r0;
.icr_sig_C2_RECV_FX_04:
        r7 = -r7;                 /* flip sign, |x| unchanged */
    rts;
#endif
    r5 = DSP4_BLOCK_SIZE;
    lcntr = r5; do .icr_lp_C2_RECV_FX_04 until lce;
        r0 = dm(i0, 1);
        dm(i1, 1) = r0;
.icr_lp_C2_RECV_FX_04:
        nop;
    rts;
#else
#if DSP4_PROFILE_SIGNAL
    ...
    r2 = -r0;
    r3 = dm(_rx_ic_slot_C2_RECV_FX_04);  /* production read, still paid */
    r3 = pass r1;

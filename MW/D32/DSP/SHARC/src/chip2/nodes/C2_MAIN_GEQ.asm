...
.var _buf_C2_MAIN_GEQ;
        ...
        .global _bw_i_C2_MAIN_GEQ;
        .var _bw_i_C2_MAIN_GEQ;        /* sample index, across the call */
...
.geqkb_tr_C2_MAIN_GEQ:
            ...
            r5 = 0;
            dm(_bw_i_C2_MAIN_GEQ) = r5;
            lcntr = DSP4_BLOCK_SIZE, do .bwlp_C2_MAIN_GEQ until lce;
                r5 = dm(_bw_i_C2_MAIN_GEQ);
                dm(_sample_idx) = r5;
                ...
                r5 = dm(_bw_i_C2_MAIN_GEQ);
                r5 = r5 + 1;
            .bwlp_C2_MAIN_GEQ: dm(_bw_i_C2_MAIN_GEQ) = r5;

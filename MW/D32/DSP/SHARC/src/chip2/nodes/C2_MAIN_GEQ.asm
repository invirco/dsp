...
#endif
.global _geq_state_A_C2_MAIN_GEQ;
.var _geq_state_A_C2_MAIN_GEQ[168];
#if DSP4_BQ_FLOAT
.global _geq_coeffs_B_C2_MAIN_GEQ;
.var _geq_coeffs_B_C2_MAIN_GEQ[140] = 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0;
#elif DSP4_BQ_GUARD
.global _geq_coeffs_B_C2_MAIN_GEQ;
...
#endif
.global _geq_state_B_C2_MAIN_GEQ;
.var _geq_state_B_C2_MAIN_GEQ[168];

/* SPI staging (FLOAT RBJ words — wire format unchanged) */
.global _geq_coeffs_next_C2_MAIN_GEQ;
.var _geq_coeffs_next_C2_MAIN_GEQ[140];
.global _geq_swap_pending_C2_MAIN_GEQ;
.var _geq_swap_pending_C2_MAIN_GEQ = 0;
#if DSP4_BQ_GUARD
.global _geq_hrw_C2_MAIN_GEQ;
.var _geq_hrw_C2_MAIN_GEQ = 0;        /* 0 idle, 1 asked, 2 re-ask */
.global _geq_hrl_C2_MAIN_GEQ;
.var _geq_hrl_C2_MAIN_GEQ[2];       /* (block, stages) pairs */
#endif

.global _geq_active_C2_MAIN_GEQ;
.var _geq_active_C2_MAIN_GEQ = 0;
.global _geq_xfade_alpha_C2_MAIN_GEQ;
.var _geq_xfade_alpha_C2_MAIN_GEQ = 0.0;
.global _geq_xfade_step_C2_MAIN_GEQ;
.var _geq_xfade_step_C2_MAIN_GEQ = 0.0;


.global _buf_C2_MAIN_GEQ;
.var _buf_C2_MAIN_GEQ;

        #if DSP4_BLOCK_KERNELS
        .extern _blk_C2_MAIN_FDR;
        #endif
        #if DSP4_BLOCK_KERNELS
        .global _blk_C2_MAIN_GEQ;
        .var _blk_C2_MAIN_GEQ[DSP4_BLOCK_SIZE];
        .global _bw_k_C2_MAIN_GEQ;
        .var _bw_k_C2_MAIN_GEQ;        /* the caller's _sample_idx */
        .global _bw_s0_C2_MAIN_GEQ;
        .var _bw_s0_C2_MAIN_GEQ;       /* walking source pointer */
        .global _bw_d0_C2_MAIN_GEQ;
        .var _bw_d0_C2_MAIN_GEQ;       /* walking sink pointer */
        #endif
...
.extern _bq_hr_node1;
#endif
.global _C2_MAIN_GEQ_process;
_C2_MAIN_GEQ_process:
#if DSP4_BLOCK_KERNELS
    ...
    r4 = dm(_geq_swap_pending_C2_MAIN_GEQ);
    r5 = dm(_geq_xfade_step_C2_MAIN_GEQ);
    r4 = r4 or r5;
#if DSP4_BQ_GUARD
...
#endif
    r4 = pass r4;
    if ne jump (pc, .geqkb_tr_C2_MAIN_GEQ);
    ...
    i3 = _blk_C2_MAIN_FDR;
    i4 = _blk_C2_MAIN_GEQ;
    lcntr = DSP4_BLOCK_SIZE, do .geqkb_cp_C2_MAIN_GEQ until lce;
        r0 = dm(i3, 1);
    .geqkb_cp_C2_MAIN_GEQ: dm(i4, 1) = r0;

    r4 = dm(_geq_active_C2_MAIN_GEQ);
    r4 = pass r4;
    if ne jump (pc, .geqkb_b_C2_MAIN_GEQ);
    i0 = _geq_coeffs_A_C2_MAIN_GEQ;
    i1 = _geq_state_A_C2_MAIN_GEQ;
    jump (pc, .geqkb_go_C2_MAIN_GEQ);
.geqkb_b_C2_MAIN_GEQ:
    i0 = _geq_coeffs_B_C2_MAIN_GEQ;
    i1 = _geq_state_B_C2_MAIN_GEQ;
.geqkb_go_C2_MAIN_GEQ:
    i2 = _blk_C2_MAIN_GEQ;
    r4 = 28;
...
.geqkb_tr_C2_MAIN_GEQ:
            ...
            i4 = _blk_C2_MAIN_FDR;
            r3 = i4;
            dm(_bw_s0_C2_MAIN_GEQ) = r3;
            i4 = _blk_C2_MAIN_GEQ;
            r3 = i4;
            dm(_bw_d0_C2_MAIN_GEQ) = r3;
            r5 = dm(_sample_idx);
            dm(_bw_k_C2_MAIN_GEQ) = r5;
            r5 = 0;
            dm(_sample_idx) = r5;
            /* sample 0, peeled: the block-rate guard fires here */
                r3 = dm(_bw_s0_C2_MAIN_GEQ);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_MAIN_FDR) = r0;
                r3 = r3 + 1;
                dm(_bw_s0_C2_MAIN_GEQ) = r3;
                call _C2_MAIN_GEQ_process_sample;
                r0 = dm(_buf_C2_MAIN_GEQ);
                r3 = dm(_bw_d0_C2_MAIN_GEQ);
                i4 = r3;
                dm(i4, 0) = r0;
                r3 = r3 + 1;
                dm(_bw_d0_C2_MAIN_GEQ) = r3;
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_MAIN_GEQ until lce;
                r3 = dm(_bw_s0_C2_MAIN_GEQ);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_MAIN_FDR) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_MAIN_GEQ: dm(_bw_d0_C2_MAIN_GEQ) = r3;
            r5 = dm(_bw_k_C2_MAIN_GEQ);
            dm(_sample_idx) = r5;
            rts;

        .global _C2_MAIN_GEQ_process_sample;
        _C2_MAIN_GEQ_process_sample:
        #endif
    ...
    #endif
    r4 = pass r4;
    if ne call _geq_start_xfade_C2_MAIN_GEQ;

    r4 = dm(_geq_xfade_step_C2_MAIN_GEQ);
    r4 = pass r4;
    if ne jump (pc, .geq_xfade_C2_MAIN_GEQ);

    /* ===== steady state ===== */
    r0 = dm(_buf_C2_MAIN_FDR);
    r4 = dm(_geq_active_C2_MAIN_GEQ);
    r4 = pass r4;
    if ne jump (pc, .geq_ss_b_C2_MAIN_GEQ);
    i0 = _geq_coeffs_A_C2_MAIN_GEQ;
    i1 = _geq_state_A_C2_MAIN_GEQ;
    jump (pc, .geq_ss_go_C2_MAIN_GEQ);
.geq_ss_b_C2_MAIN_GEQ:
    i0 = _geq_coeffs_B_C2_MAIN_GEQ;
    i1 = _geq_state_B_C2_MAIN_GEQ;
.geq_ss_go_C2_MAIN_GEQ:
    r4 = 28;
...
.geq_xfade_C2_MAIN_GEQ:
    ...
    r4 = dm(_geq_active_C2_MAIN_GEQ);
    r4 = pass r4;
    if eq jump (pc, .geq_bl_C2_MAIN_GEQ);
    r5 = r14;                     /* active B: new is A */
    r14 = r0;
    r0 = r5;
.geq_bl_C2_MAIN_GEQ:
    f4 = dm(_geq_xfade_alpha_C2_MAIN_GEQ);
    ...
    f4 = dm(_geq_xfade_alpha_C2_MAIN_GEQ);
    f5 = dm(_geq_xfade_step_C2_MAIN_GEQ);
    f4 = f4 + f5;
    dm(_geq_xfade_alpha_C2_MAIN_GEQ) = f4;
    r5 = 0x3F800000;
    f5 = r5;
    comp(f4, f5);
    if lt rts;
    ...
    r5 = 1;
    r4 = r4 xor r5;
    dm(_geq_active_C2_MAIN_GEQ) = r4;
    r4 = 0;
    dm(_geq_xfade_step_C2_MAIN_GEQ) = r4;
    dm(_geq_xfade_alpha_C2_MAIN_GEQ) = r4;
    rts;

    /* ===== stage new coeffs into dormant ===== */
_geq_start_xfade_C2_MAIN_GEQ:
    #if DSP4_BQ_GUARD
    /* Convert, size, and hold the fade until H is written. */
    r0 = _geq_hrw_C2_MAIN_GEQ;
    r1 = _geq_hrl_C2_MAIN_GEQ;
    r2 = _geq_active_C2_MAIN_GEQ;
    r3 = _geq_coeffs_A_C2_MAIN_GEQ;
    r4 = _geq_coeffs_B_C2_MAIN_GEQ;
    r5 = _geq_state_A_C2_MAIN_GEQ;
    r6 = _geq_state_B_C2_MAIN_GEQ;
    r7 = _geq_coeffs_next_C2_MAIN_GEQ;
    r8 = 28;
    call _bq_hr_node1;      /* i2 = dormant state on success */
    r0 = pass r0;
    if eq rts;              /* not sized yet; back next block */
    r4 = 0;
    dm(_geq_swap_pending_C2_MAIN_GEQ) = r4;
    #endif
#if !DSP4_BQ_GUARD
    r4 = 0;
    dm(_geq_swap_pending_C2_MAIN_GEQ) = r4;
    i0 = _geq_coeffs_next_C2_MAIN_GEQ;
    r4 = dm(_geq_active_C2_MAIN_GEQ);
    r4 = pass r4;
    if ne jump (pc, .geq_st_a_C2_MAIN_GEQ);
    i1 = _geq_coeffs_B_C2_MAIN_GEQ;
    i2 = _geq_state_B_C2_MAIN_GEQ;
    jump (pc, .geq_st_go_C2_MAIN_GEQ);
.geq_st_a_C2_MAIN_GEQ:
    i1 = _geq_coeffs_A_C2_MAIN_GEQ;
    i2 = _geq_state_A_C2_MAIN_GEQ;
.geq_st_go_C2_MAIN_GEQ:
    r4 = 28;
    call _bq_fx_convert_N;
#endif
    r4 = 0;
    r5 = 168;
    lcntr = r5, do .geq_zst_C2_MAIN_GEQ until lce;
.geq_zst_C2_MAIN_GEQ:
        dm(i2, 1) = r4;

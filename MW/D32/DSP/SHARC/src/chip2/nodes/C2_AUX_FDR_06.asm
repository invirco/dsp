...
.extern _buf_C2_RECV_AUX_06;
        ...
        .global _fdr_dca_sel_C2_AUX_FDR_06;
        .var _fdr_dca_sel_C2_AUX_FDR_06 = 0;              /* 0 = no DCA assigned */
        .global _fdr_dca_gain_C2_AUX_FDR_06;
        .var _fdr_dca_gain_C2_AUX_FDR_06 = 1.0;           /* resolved master gain */
        ...
        .global _fdr_busy_C2_AUX_FDR_06;
        .global _fdr_busy_C2_AUX_FDR_06;
        .var _fdr_busy_C2_AUX_FDR_06 = 0;
        #endif
        ...
        _C2_AUX_FDR_06_process:
            ...
            r1 = dm(_fdr_pan_frames_C2_AUX_FDR_06);
            r1 = max(r1, r4);
            r5 = 0;
            r1 = max(r1, r5);
            dm(_fdr_busy_C2_AUX_FDR_06) = r1;
        #endif
        ...
        .cvt_C2_AUX_FDR_06:
             ...
             * construction. */
            r14 = DSP4_BLOCK_HALF;
            lcntr = r14; do .fdr_lp_C2_AUX_FDR_06 until lce;
                r0 = dm(i0, 1);                 /* xA */
                r3 = dm(i0, 1);                 /* xB */
                mrf = r0 * r1 (ssi);
                mrb = r3 * r1 (ssi);
                ...
                dm(i1, 1) = r0;
        .fdr_lp_C2_AUX_FDR_06:
                dm(i1, 1) = r3;
            dm(_tap_post_fader_C2_AUX_FDR_06) = r3;   /* linkage scalars */
            dm(_buf_C2_AUX_FDR_06) = r3;
            rts;
        #else
            r14 = DSP4_BLOCK_SIZE;
        .fdr_lp_C2_AUX_FDR_06:
            ...
            r13 = r0;
            r14 = r14 - 1;
            if gt jump (pc, .fdr_lp_C2_AUX_FDR_06);
            dm(_tap_post_fader_C2_AUX_FDR_06) = r13;  /* linkage scalars */
            dm(_buf_C2_AUX_FDR_06) = r13;
            rts;
        #endif
#else
        .apply_C2_AUX_FDR_06:

...
.var _fx_type_C2_FX_ENG_06 = 3;  /* the graph's `type=Reverb` */
#else
.global _fx_type_C2_FX_ENG_06;
...
.global _fx_bypassed_C2_FX_ENG_06;
.var _fx_bypassed_C2_FX_ENG_06 = 0;
...
.var _fx_echo_buf_C2_FX_ENG_06[12000];
.section/dm seg_dmda;
...
_C2_FX_ENG_06_process:
        #if DSP4_BLOCK_KERNELS
            /* ---- PARK: _fx_on_C2_FX_ENG_06 is off ---- */
            r5 = dm(_fx_on_C2_FX_ENG_06);
            r5 = pass r5;
            if ne jump (pc, .bwrun_C2_FX_ENG_06);
            l0 = 0;
            r0 = 0;
            i0 = _blk_C2_FX_ENG_06;
            lcntr = DSP4_BLOCK_SIZE, do .bwpk_C2_FX_ENG_06 until lce;
            .bwpk_C2_FX_ENG_06: dm(i0, 1) = r0;
        ...
        .bwrun_C2_FX_ENG_06:
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_FX_ENG_06 until lce;
                r3 = dm(_bw_s0_C2_FX_ENG_06);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_RECV_FX_06) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_FX_ENG_06: dm(_bw_d0_C2_FX_ENG_06) = r3;
     ...
     * could write it, `_fx_on_C2_FX_ENG_06` was declared right above --
    ...
    r1 = dm(_fx_on_C2_FX_ENG_06);
    r1 = pass r1;
    if eq jump (pc, .fx_off_C2_FX_ENG_06);
 ...
 * bypass that parks the Type in _fx_bypassed_C2_FX_ENG_06. Before
...
r1 = 0; comp(r0, r1); if eq jump (pc, .fx_echo_C2_FX_ENG_06);
jump (pc, .fx_bypass_C2_FX_ENG_06);

/* ===================== ECHO ===================== */
.fx_echo_C2_FX_ENG_06:
    r1 = dm(_fx_echo_wptr_C2_FX_ENG_06);
    r2 = dm(_fx_delay_ms_C2_FX_ENG_06);  /* delay in samples (MCU converts) */
    ...
    f5 = dm(_fx_feedback_C2_FX_ENG_06);
    f6 = f13 * f5;
    f7 = f15 + f6;
    i0 = _fx_echo_buf_C2_FX_ENG_06;
    m0 = r1;
...
.fx_bypass_C2_FX_ENG_06:
    ...
    r1 = dm(_fx_type_C2_FX_ENG_06);
    dm(_fx_bypassed_C2_FX_ENG_06) = r1;
    f0 = f15;                    /* dry pass-through */
    jump (pc, .fx_mixed_C2_FX_ENG_06);
...
.fx_mix_C2_FX_ENG_06:
    r1 = 0;
    dm(_fx_bypassed_C2_FX_ENG_06) = r1;  /* an algorithm ran */
.fx_mixed_C2_FX_ENG_06:
    /* f0 = wet, f15 = dry */
...
.fx_off_C2_FX_ENG_06:
     ...
     * second `dm(_buf_C2_FX_ENG_06) = r0;` anywhere in the body would
     * make that match ambiguous and stop the generator. */
    r1 = 0;
    dm(_buf_C2_FX_ENG_06) = r1;
    dm(_buf_L_C2_FX_ENG_06) = r1;
    dm(_buf_R_C2_FX_ENG_06) = r1;
    rts;

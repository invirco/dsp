...
.section/dm seg_dmda;
.global _auxin_on_C2_BT_IN;
.var _auxin_on_C2_BT_IN = 0;
.global _auxin_level_C2_BT_IN;
.var _auxin_level_C2_BT_IN = 1.0;
.global _auxin_level_target_C2_BT_IN;
.var _auxin_level_target_C2_BT_IN = 1.0;
.global _auxin_level_step_C2_BT_IN;
.var _auxin_level_step_C2_BT_IN = 0.0;
.global _auxin_level_frames_C2_BT_IN;
.var _auxin_level_frames_C2_BT_IN = 0;
.global _auxin_q_C2_BT_IN;
.var _auxin_q_C2_BT_IN = 0;                  /* Q4.28 coeff x assign */
 ...
 * back in. */
.global _auxin_byp_C2_BT_IN;
.var _auxin_byp_C2_BT_IN = 0;
#endif
.global _buf_C2_BT_IN;
.var _buf_C2_BT_IN;

        #if DSP4_BLOCK_KERNELS
        .global _blk_C2_BT_IN;
        .var _blk_C2_BT_IN[DSP4_BLOCK_SIZE];
        .global _bw_k_C2_BT_IN;
        .var _bw_k_C2_BT_IN;        /* the caller's _sample_idx */
        .global _bw_d0_C2_BT_IN;
        .var _bw_d0_C2_BT_IN;       /* walking sink pointer */
        #endif

.section/pm seg_pmco;
.extern _sample_idx;
.extern _mrf_rns28;
.global _C2_BT_IN_process;
_C2_BT_IN_process:
        #if DSP4_BLOCK_KERNELS
        #if DSP4_AUXIN_BYPASS
            /* ---- PARK: _auxin_on_C2_BT_IN is off ---- */
            r5 = dm(_auxin_on_C2_BT_IN);
            r5 = pass r5;
            if ne jump (pc, .bwrun_C2_BT_IN);
            r0 = 1;
            dm(_auxin_byp_C2_BT_IN) = r0;
            l0 = 0;
            r0 = 0;
            i0 = _blk_C2_BT_IN;
            lcntr = DSP4_BLOCK_SIZE, do .bwpk_C2_BT_IN until lce;
            .bwpk_C2_BT_IN: dm(i0, 1) = r0;
            dm(_buf_C2_BT_IN) = r0;
            rts;
        .bwrun_C2_BT_IN:
        #endif
            ...
            i4 = _blk_C2_BT_IN;
            r3 = i4;
            dm(_bw_d0_C2_BT_IN) = r3;
            r5 = dm(_sample_idx);
            dm(_bw_k_C2_BT_IN) = r5;
            r5 = 0;
            dm(_sample_idx) = r5;
            /* sample 0, peeled: the block-rate guard fires here */
                call _C2_BT_IN_process_sample;
                r0 = dm(_buf_C2_BT_IN);
                r3 = dm(_bw_d0_C2_BT_IN);
                i4 = r3;
                dm(i4, 0) = r0;
                r3 = r3 + 1;
                dm(_bw_d0_C2_BT_IN) = r3;
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_BT_IN until lce;
                call _C2_BT_IN_process_sample;
                r0 = dm(_buf_C2_BT_IN);
                r3 = dm(_bw_d0_C2_BT_IN);
                i4 = r3;
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_BT_IN: dm(_bw_d0_C2_BT_IN) = r3;
            r5 = dm(_bw_k_C2_BT_IN);
            dm(_sample_idx) = r5;
            rts;

        .global _C2_BT_IN_process_sample;
        _C2_BT_IN_process_sample:
        #endif
    ...
    r1 = 0;
    comp(r4, r1);
    if ne jump (pc, .auxin_apply_C2_BT_IN);
#if DSP4_BLOCK_KERNELS && DSP4_AUXIN_BYPASS
    ...
    r2 = pass r2;
    if eq jump (pc, .auxin_live_C2_BT_IN);
    r2 = 0;
    dm(_auxin_byp_C2_BT_IN) = r2;
    dm(_auxin_level_frames_C2_BT_IN) = r2;
.auxin_live_C2_BT_IN:
#endif
    r4 = dm(_auxin_level_frames_C2_BT_IN);
    r15 = DSP4_BLOCK_SIZE;
    r4 = r4 - r15;
    if le jump (pc, .no_auxramp_C2_BT_IN);
    dm(_auxin_level_frames_C2_BT_IN) = r4;
    f1 = dm(_auxin_level_C2_BT_IN);
    f2 = dm(_auxin_level_step_C2_BT_IN);
    r15 = DSP4_BLOCK_F32;             /* BLOCK_SIZE as float */
    f15 = r15;
    f2 = f2 * f15;
    f1 = f1 + f2;
    dm(_auxin_level_C2_BT_IN) = f1;
    jump (pc, .auxin_go_C2_BT_IN);
.no_auxramp_C2_BT_IN:
    f1 = dm(_auxin_level_target_C2_BT_IN);
    dm(_auxin_level_C2_BT_IN) = f1;
.auxin_go_C2_BT_IN:
    r2 = 0x4D800000;
    f2 = r2;
    ...
    r2 = pass r2;
    if eq r1 = r3;
    dm(_auxin_q_C2_BT_IN) = r1;

.auxin_apply_C2_BT_IN:
    r0 = dm(_buf_C2_BT_IN);
    r1 = dm(_auxin_q_C2_BT_IN);
    mrf = r0 * r1 (ssi);
    call _mrf_rns28;
    dm(_buf_C2_BT_IN) = r0;
    rts;
_C2_BT_IN_process.end:

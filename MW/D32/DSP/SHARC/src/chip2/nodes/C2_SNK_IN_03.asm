 ...
 * back in. */
.global _auxin_byp_C2_SNK_IN_03;
.var _auxin_byp_C2_SNK_IN_03 = 0;
#endif
.global _buf_C2_SNK_IN_03;
.var _buf_C2_SNK_IN_03;

        #if DSP4_BLOCK_KERNELS
        .extern _blk_C2_XR_SNAKE_03;
        #endif
        #if DSP4_BLOCK_KERNELS
        .global _blk_C2_SNK_IN_03;
        .var _blk_C2_SNK_IN_03[DSP4_BLOCK_SIZE];
        .global _bw_k_C2_SNK_IN_03;
        .var _bw_k_C2_SNK_IN_03;        /* the caller's _sample_idx */
        .global _bw_s0_C2_SNK_IN_03;
        .var _bw_s0_C2_SNK_IN_03;       /* walking source pointer */
        .global _bw_d0_C2_SNK_IN_03;
        .var _bw_d0_C2_SNK_IN_03;       /* walking sink pointer */
        #endif
...
_C2_SNK_IN_03_process:
            ...
            /* ---- PARK: _auxin_on_C2_SNK_IN_03 is off ---- */
            r5 = dm(_auxin_on_C2_SNK_IN_03);
            r5 = pass r5;
            if ne jump (pc, .bwrun_C2_SNK_IN_03);
            r0 = 1;
            dm(_auxin_byp_C2_SNK_IN_03) = r0;
            l0 = 0;
            r0 = 0;
            i0 = _blk_C2_SNK_IN_03;
            lcntr = DSP4_BLOCK_SIZE, do .bwpk_C2_SNK_IN_03 until lce;
            .bwpk_C2_SNK_IN_03: dm(i0, 1) = r0;
        ...
        .bwrun_C2_SNK_IN_03:
             ...
             */
            i4 = _blk_C2_XR_SNAKE_03;
            r3 = i4;
            dm(_bw_s0_C2_SNK_IN_03) = r3;
            i4 = _blk_C2_SNK_IN_03;
            r3 = i4;
            dm(_bw_d0_C2_SNK_IN_03) = r3;
            r5 = dm(_sample_idx);
            dm(_bw_k_C2_SNK_IN_03) = r5;
            r5 = 0;
            dm(_sample_idx) = r5;
            /* sample 0, peeled: the block-rate guard fires here */
                r3 = dm(_bw_s0_C2_SNK_IN_03);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_XR_SNAKE_03) = r0;
                r3 = r3 + 1;
                dm(_bw_s0_C2_SNK_IN_03) = r3;
                call _C2_SNK_IN_03_process_sample;
                r0 = dm(_buf_C2_SNK_IN_03);
                r3 = dm(_bw_d0_C2_SNK_IN_03);
                i4 = r3;
                dm(i4, 0) = r0;
                r3 = r3 + 1;
                dm(_bw_d0_C2_SNK_IN_03) = r3;
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_SNK_IN_03 until lce;
                r3 = dm(_bw_s0_C2_SNK_IN_03);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_XR_SNAKE_03) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_SNK_IN_03: dm(_bw_d0_C2_SNK_IN_03) = r3;
            r5 = dm(_bw_k_C2_SNK_IN_03);
            dm(_sample_idx) = r5;
            rts;

        .global _C2_SNK_IN_03_process_sample;
        _C2_SNK_IN_03_process_sample:
        #endif
    ...
    r2 = pass r2;
    if eq jump (pc, .auxin_live_C2_SNK_IN_03);
    r2 = 0;
    dm(_auxin_byp_C2_SNK_IN_03) = r2;
    dm(_auxin_level_frames_C2_SNK_IN_03) = r2;
.auxin_live_C2_SNK_IN_03:
#endif

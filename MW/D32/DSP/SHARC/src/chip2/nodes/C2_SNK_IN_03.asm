...
.var _buf_C2_SNK_IN_03;
        ...
        .global _bw_i_C2_SNK_IN_03;
        .var _bw_i_C2_SNK_IN_03;        /* sample index, across the call */
...
_C2_SNK_IN_03_process:
            ...
            r5 = 0;
            dm(_bw_i_C2_SNK_IN_03) = r5;
            lcntr = DSP4_BLOCK_SIZE, do .bwlp_C2_SNK_IN_03 until lce;
                r5 = dm(_bw_i_C2_SNK_IN_03);
                dm(_sample_idx) = r5;
                ...
                r5 = dm(_bw_i_C2_SNK_IN_03);
                r5 = r5 + 1;
            .bwlp_C2_SNK_IN_03: dm(_bw_i_C2_SNK_IN_03) = r5;

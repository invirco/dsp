/*----------------------------------------------------------------------
 * Aux 11 Fader (FADER_PAN)
 * Node ID:    C2_AUX_FDR_11
 * Chip:       2
 * Channels:   1
 * SPI Page:   1
 * SPI Addr:   870
...
.extern _buf_C2_RECV_AUX_11;
        ...
        .var _fdr_level_target_C2_AUX_FDR_11 = 1.0;
        .global _fdr_level_step_C2_AUX_FDR_11;
        .var _fdr_level_step_C2_AUX_FDR_11 = 0.0;
        .global _fdr_level_frames_C2_AUX_FDR_11;
        .var _fdr_level_frames_C2_AUX_FDR_11 = 0;
        .global _fdr_pan_C2_AUX_FDR_11;
        .var _fdr_pan_C2_AUX_FDR_11 = 0.5;
        .global _fdr_pan_target_C2_AUX_FDR_11;
        .var _fdr_pan_target_C2_AUX_FDR_11 = 0.5;
        .global _fdr_pan_step_C2_AUX_FDR_11;
        .var _fdr_pan_step_C2_AUX_FDR_11 = 0.0;
        .global _fdr_pan_frames_C2_AUX_FDR_11;
        .var _fdr_pan_frames_C2_AUX_FDR_11 = 0;
        .global _fdr_mute_C2_AUX_FDR_11;
        .var _fdr_mute_C2_AUX_FDR_11 = 0;
        ...
        .global _fdr_dca_sel_C2_AUX_FDR_11;
        .var _fdr_dca_sel_C2_AUX_FDR_11 = 0;              /* 0 = no DCA assigned */
        .global _fdr_dca_gain_C2_AUX_FDR_11;
        .var _fdr_dca_gain_C2_AUX_FDR_11 = 1.0;           /* resolved master gain */
        .global _fdr_gq_C2_AUX_FDR_11;
        .var _fdr_gq_C2_AUX_FDR_11 = 0x10000000;          /* Q4.28 level*dca */
        ...
        .global _fdr_busy_C2_AUX_FDR_11;
        .global _fdr_busy_C2_AUX_FDR_11;
        .var _fdr_busy_C2_AUX_FDR_11 = 0;
        #endif

        .global _tap_post_fader_C2_AUX_FDR_11;
        .var _tap_post_fader_C2_AUX_FDR_11;
        ...
        .extern _sample_idx;
        .extern _mrf_rns28;
        .global _C2_AUX_FDR_11_process;
        _C2_AUX_FDR_11_process:
            /* block-rate: float ramps + shadow conversion */
        #if !DSP4_BLOCK_KERNELS
            r4 = dm(_sample_idx);
            r1 = 0;
            comp(r4, r1);
            if ne jump (pc, .apply_C2_AUX_FDR_11);
        #endif
            ...
            r4 = dm(_fdr_level_frames_C2_AUX_FDR_11);
            r1 = dm(_fdr_pan_frames_C2_AUX_FDR_11);
            r1 = max(r1, r4);
            r5 = 0;
            r1 = max(r1, r5);
            dm(_fdr_busy_C2_AUX_FDR_11) = r1;
        #endif
            ...
            r1 = 0;
            comp(r4, r1);
            if le jump (pc, .lsnap_C2_AUX_FDR_11);
            ...
            r5 = DSP4_BLOCK_SIZE;
            r4 = r4 - r5;
            dm(_fdr_level_frames_C2_AUX_FDR_11) = r4;
            f1 = dm(_fdr_level_C2_AUX_FDR_11);
            f2 = dm(_fdr_level_step_C2_AUX_FDR_11);
            r5 = DSP4_BLOCK_F32;              /* BLOCK_SIZE as float */
            f5 = r5;
            f2 = f2 * f5;
            f1 = f1 + f2;
            dm(_fdr_level_C2_AUX_FDR_11) = f1;
            jump (pc, .pramp_C2_AUX_FDR_11);
        .lsnap_C2_AUX_FDR_11:
            f1 = dm(_fdr_level_target_C2_AUX_FDR_11);
            dm(_fdr_level_C2_AUX_FDR_11) = f1;
        .pramp_C2_AUX_FDR_11:
            /* pan ramp */
            r4 = dm(_fdr_pan_frames_C2_AUX_FDR_11);
            r1 = 0;
            comp(r4, r1);
            if le jump (pc, .psnap_C2_AUX_FDR_11);
            /* Consume a BLOCK's worth of frames and apply a BLOCK's
             * worth of step. spi_handler scales every profile frame count
             * by DSP4_BLOCK_SIZE, which is right for the ramps that
             * decrement once per SAMPLE. This one decrements once per
            ...
            r5 = DSP4_BLOCK_SIZE;
            r4 = r4 - r5;
            dm(_fdr_pan_frames_C2_AUX_FDR_11) = r4;
            f1 = dm(_fdr_pan_C2_AUX_FDR_11);
            f2 = dm(_fdr_pan_step_C2_AUX_FDR_11);
            r5 = DSP4_BLOCK_F32;              /* BLOCK_SIZE as float */
            f5 = r5;
            f2 = f2 * f5;
            f1 = f1 + f2;
            dm(_fdr_pan_C2_AUX_FDR_11) = f1;
            jump (pc, .cvt_C2_AUX_FDR_11);
        .psnap_C2_AUX_FDR_11:
            f1 = dm(_fdr_pan_target_C2_AUX_FDR_11);
            dm(_fdr_pan_C2_AUX_FDR_11) = f1;
        .cvt_C2_AUX_FDR_11:
            /* composite = level * dca; Q4.28 shadow(s) */
            f1 = dm(_fdr_level_C2_AUX_FDR_11);
            f2 = dm(_fdr_dca_gain_C2_AUX_FDR_11);
            f1 = f1 * f2;
            r2 = 0x4D800000;
            f2 = r2;
            f3 = f1 * f2;
            ...
            r3 = dm(_fdr_mute_C2_AUX_FDR_11);
            r4 = 0;
            comp(r3, r4);
            if ne r2 = r4;
            dm(_fdr_gq_C2_AUX_FDR_11) = r2;
             ...
             * construction. */
            r14 = DSP4_BLOCK_HALF;
            lcntr = r14; do .fdr_lp_C2_AUX_FDR_11 until lce;
                r0 = dm(i0, 1);                 /* xA */
                r3 = dm(i0, 1);                 /* xB */
                mrf = r0 * r1 (ssi);
                mrb = r3 * r1 (ssi);
                ...
                dm(i1, 1) = r0;
        .fdr_lp_C2_AUX_FDR_11:
                dm(i1, 1) = r3;
            dm(_tap_post_fader_C2_AUX_FDR_11) = r3;   /* linkage scalars */
            dm(_buf_C2_AUX_FDR_11) = r3;
            rts;
        #else
            r14 = DSP4_BLOCK_SIZE;
        .fdr_lp_C2_AUX_FDR_11:
            ...
            r13 = r0;
            r14 = r14 - 1;
            if gt jump (pc, .fdr_lp_C2_AUX_FDR_11);
            dm(_tap_post_fader_C2_AUX_FDR_11) = r13;  /* linkage scalars */
            dm(_buf_C2_AUX_FDR_11) = r13;
            rts;
        #endif
#else
        .apply_C2_AUX_FDR_11:
            ...
            dm(_tap_post_fader_C2_AUX_FDR_11) = r0;
            dm(_buf_C2_AUX_FDR_11) = r0;

            rts;
#endif
        _C2_AUX_FDR_11_process.end:

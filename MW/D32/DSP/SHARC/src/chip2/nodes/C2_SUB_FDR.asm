...
.extern _buf_C2_RECV_SUB;
        ...
        .global _fdr_dca_sel_C2_SUB_FDR;
        .var _fdr_dca_sel_C2_SUB_FDR = 0;              /* 0 = no DCA assigned */
        .global _fdr_dca_gain_C2_SUB_FDR;
        .var _fdr_dca_gain_C2_SUB_FDR = 1.0;           /* resolved master gain */
        ...
        .cvt_C2_SUB_FDR:
             ...
             * construction. */
            r14 = DSP4_BLOCK_HALF;
            lcntr = r14; do .fdr_lp_C2_SUB_FDR until lce;
                r0 = dm(i0, 1);                 /* xA */
                r3 = dm(i0, 1);                 /* xB */
                mrf = r0 * r1 (ssi);
                mrb = r3 * r1 (ssi);
        ...
        .fdr_lp_C2_SUB_FDR:
                dm(i1, 1) = r3;
            dm(_tap_post_fader_C2_SUB_FDR) = r3;   /* linkage scalars */
            dm(_buf_C2_SUB_FDR) = r3;
            rts;
        #else
            r14 = DSP4_BLOCK_SIZE;
        .fdr_lp_C2_SUB_FDR:

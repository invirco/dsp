...
.extern _buf_C2_RECV_SUB;
        ...
        .var _fdr_gq_C2_SUB_FDR = 0x10000000;          /* Q4.28 level */
        ...
        .var _buf_C2_SUB_FDR;
        #if DSP4_BLOCK_KERNELS
        .extern _blk_C2_RECV_SUB;
        .global _blk_C2_SUB_FDR;
        .var _blk_C2_SUB_FDR[DSP4_BLOCK_SIZE];
        #endif
        ...
        .cvt_C2_SUB_FDR:
            ...
            l2 = 0;
            l3 = 0;
            i0 = _blk_C2_RECV_SUB;                 /* input  */
            i1 = _blk_C2_SUB_FDR;                 /* mono   */
        #if DSP4_STRIP_FUSED

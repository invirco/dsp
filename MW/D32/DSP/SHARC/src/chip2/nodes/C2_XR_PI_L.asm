...
.var _rx_ic_slot_C2_XR_PI_L[DSP4_BLOCK_SIZE];
...
.global _blk_C2_XR_PI_L;
.var _blk_C2_XR_PI_L[DSP4_BLOCK_SIZE];
...
_C2_XR_PI_L_process:
    ...
    lcntr = r5; do .icr_sig_C2_XR_PI_L until lce;
...
.icr_lp_C2_XR_PI_L:
    ...
    r2 = -r0;
    r3 = dm(_rx_ic_slot_C2_XR_PI_L);  /* production read, still paid */
    r3 = pass r1;

...
#include "dsp_block.h"
        ...
        /* SPI page=1 addr=1783 */

        #include "blk_pool.h"

        .section/dm seg_dmda;
        /* ORDER IS LOAD-BEARING: _mtr_fold takes the address of
         * _mtr_peak_C2_MTR_AUX_06 and reaches the rest by offset. The three float
         * words keep their names and their SPI dispatch entries. */
        .global _mtr_peak_C2_MTR_AUX_06;
        .var _mtr_peak_C2_MTR_AUX_06 = 0.0;      /* +0 linear peak, host contract */
        .global _mtr_rms_C2_MTR_AUX_06;
        .var _mtr_rms_C2_MTR_AUX_06 = 0.0;       /* +1 linear TRUE rms            */
        .global _mtr_gr_C2_MTR_AUX_06;
        .var _mtr_gr_C2_MTR_AUX_06 = 0.0;        /* +2 gain reduction -- see below */
        .global _mtr_st_C2_MTR_AUX_06;
        .var _mtr_st_C2_MTR_AUX_06[4];           /* +3 pk_lo pk_hi ms_lo ms_hi     */
         ...
         * is state and not a sign extension. Filled by C2_AUX_OUT_06 under block
         * kernels and by this node's own per-sample body otherwise. */
        .global _mtr_acc_C2_MTR_AUX_06;
        .var _mtr_acc_C2_MTR_AUX_06[5];          /* mx mn ssq_lo ssq_hi ssq_ex     */
...
mrf = 0;
lcntr = DSP4_BLOCK_SIZE, do .mtrk_C2_MTR_AUX_06 until lce;
    r0 = dm(i2, m2);
    r8 = max(r8, r0);
    mrf = mrf + r0 * r0 (ssi);
.mtrk_C2_MTR_AUX_06:
    r9 = min(r9, r0);
r0 = _mtr_peak_C2_MTR_AUX_06;
        #if !DSP4_MTR_NOFOLD
            call _mtr_fold;
        #endif
            rts;
             ...
             *
             * Source: _mtr_wide_C2_AUX_OUT_06, the Q8.24 word C2_AUX_OUT_06 publishes. */
            r0 = dm(_mtr_wide_C2_AUX_OUT_06);
            r4 = dm(_sample_idx);
            r1 = 0;
            comp(r4, r1);
            if ne jump (pc, .mtacc_C2_MTR_AUX_06);
            /* first sample of the block: seed rather than accumulate */
            dm(_mtr_acc_C2_MTR_AUX_06 + 0) = r0;
            dm(_mtr_acc_C2_MTR_AUX_06 + 1) = r0;
            mrf = 0;
            mrf = mrf + r0 * r0 (ssi);
            r2 = mr0f;
            dm(_mtr_acc_C2_MTR_AUX_06 + 2) = r2;
            r2 = mr1f;
            dm(_mtr_acc_C2_MTR_AUX_06 + 3) = r2;
            r2 = mr2f;
            dm(_mtr_acc_C2_MTR_AUX_06 + 4) = r2;
            rts;
        .mtacc_C2_MTR_AUX_06:
            r2 = dm(_mtr_acc_C2_MTR_AUX_06 + 0);
            r2 = max(r2, r0);
            dm(_mtr_acc_C2_MTR_AUX_06 + 0) = r2;
            r2 = dm(_mtr_acc_C2_MTR_AUX_06 + 1);
            r2 = min(r2, r0);
            dm(_mtr_acc_C2_MTR_AUX_06 + 1) = r2;
            r2 = dm(_mtr_acc_C2_MTR_AUX_06 + 2);
            mr0f = r2;
            r3 = dm(_mtr_acc_C2_MTR_AUX_06 + 3);
            mr1f = r3;
            r2 = dm(_mtr_acc_C2_MTR_AUX_06 + 4);
            mr2f = r2;
            mrf = mrf + r0 * r0 (ssi);
            r2 = mr0f;
            dm(_mtr_acc_C2_MTR_AUX_06 + 2) = r2;
            ...
            comp(r4, r1);
            if ne rts;
            r8 = dm(_mtr_acc_C2_MTR_AUX_06 + 0);
            r9 = dm(_mtr_acc_C2_MTR_AUX_06 + 1);
            r0 = _mtr_peak_C2_MTR_AUX_06;
            call _mtr_fold;
            rts;
        #endif
        _C2_MTR_AUX_06_process.end:

        /* _mtr_gr_C2_MTR_AUX_06 IS STILL NOT WRITTEN, and that is recorded defect

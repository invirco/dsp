...
.extern _buf_C2_AUX_AFB_05;
         ...
         * gather and a lerp. */
        .global _lim_lut_C2_AUX_LIM_05;
        .var _lim_lut_C2_AUX_LIM_05[DYN_LUT_N];
        .global _lim_lutc_C2_AUX_LIM_05;
        .var _lim_lutc_C2_AUX_LIM_05 = 0;
        .global _lim_lutk_C2_AUX_LIM_05;
        .var _lim_lutk_C2_AUX_LIM_05[4] = 1, 1, 1, 1;
#endif
        ...
        _C2_AUX_LIM_05_process:
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_AUX_LIM_05 until lce;
                r3 = dm(_bw_s0_C2_AUX_LIM_05);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_AUX_AFB_05) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_AUX_LIM_05: dm(_bw_d0_C2_AUX_LIM_05) = r3;
         ...
         * BLOCK-1, would run the whole conversion on every sample. */
             ...
             * only. */
            r0 = _lim_cgp_C2_AUX_LIM_05;
            r1 = _lim_lutk_C2_AUX_LIM_05;
            r2 = _lim_lut_C2_AUX_LIM_05;
            r3 = _lim_lutc_C2_AUX_LIM_05;
            call _dyn_lut_step;
#endif
        .lim_go_C2_AUX_LIM_05:
            ...
            r4 = dm(_lim_lutc_C2_AUX_LIM_05);
            r5 = DYN_LUT_N;
            comp(r4, r5);
            if lt jump (pc, .llutpoly_C2_AUX_LIM_05);
            i0 = _lim_lut_C2_AUX_LIM_05;
            call _dyn_lut_gain;           /* r0 = gain Q4.28 */
            jump (pc, .llutgain_C2_AUX_LIM_05);
        .llutpoly_C2_AUX_LIM_05:
#endif
            i0 = _lim_cgp_C2_AUX_LIM_05;
            call _compgain_fx;
#if DSP4_DYN_LUT
        .llutgain_C2_AUX_LIM_05:
#endif
            r1 = r0;
            r0 = r13;
            mrf = r0 * r1 (ssi);

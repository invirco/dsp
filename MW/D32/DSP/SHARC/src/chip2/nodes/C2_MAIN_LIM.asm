...
.extern _buf_C2_MAIN_COMP;
         ...
         * gather and a lerp. */
        .global _lim_lut_C2_MAIN_LIM;
        .var _lim_lut_C2_MAIN_LIM[DYN_LUT_N];
        .global _lim_lutc_C2_MAIN_LIM;
        .var _lim_lutc_C2_MAIN_LIM = 0;
        .global _lim_lutk_C2_MAIN_LIM;
        .var _lim_lutk_C2_MAIN_LIM[4] = 1, 1, 1, 1;
#endif
        ...
        .var _blk_C2_MAIN_LIM[DSP4_BLOCK_SIZE];
        .global _bw_k_C2_MAIN_LIM;
        ...
        _C2_MAIN_LIM_process:
            ...
            r5 = dm(_sample_idx);
            dm(_bw_k_C2_MAIN_LIM) = r5;
            r5 = 0;
            dm(_sample_idx) = r5;
            /* sample 0, peeled: the block-rate guard fires here */
                r3 = dm(_bw_s0_C2_MAIN_LIM);
                i4 = r3;
                r0 = dm(i4, 0);
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_MAIN_LIM until lce;
                r3 = dm(_bw_s0_C2_MAIN_LIM);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_MAIN_COMP) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_MAIN_LIM: dm(_bw_d0_C2_MAIN_LIM) = r3;
            r5 = dm(_bw_k_C2_MAIN_LIM);
            dm(_sample_idx) = r5;
            rts;

        .global _C2_MAIN_LIM_process_sample;
        _C2_MAIN_LIM_process_sample:
        #endif
         ...
         * BLOCK-1, would run the whole conversion on every sample. */
             ...
             * only. */
            r0 = _lim_cgp_C2_MAIN_LIM;
            r1 = _lim_lutk_C2_MAIN_LIM;
            r2 = _lim_lut_C2_MAIN_LIM;
            r3 = _lim_lutc_C2_MAIN_LIM;
            call _dyn_lut_step;
#endif
        .lim_go_C2_MAIN_LIM:
            ...
            r4 = dm(_lim_lutc_C2_MAIN_LIM);
            r5 = DYN_LUT_N;
            comp(r4, r5);
            if lt jump (pc, .llutpoly_C2_MAIN_LIM);
            i0 = _lim_lut_C2_MAIN_LIM;
            call _dyn_lut_gain;           /* r0 = gain Q4.28 */
            jump (pc, .llutgain_C2_MAIN_LIM);
        .llutpoly_C2_MAIN_LIM:
#endif
            i0 = _lim_cgp_C2_MAIN_LIM;
            call _compgain_fx;
#if DSP4_DYN_LUT
        .llutgain_C2_MAIN_LIM:
#endif
            r1 = r0;
            r0 = r13;
            mrf = r0 * r1 (ssi);

...
.var _buf_C2_MAIN_LIM;
        ...
        .global _bw_i_C2_MAIN_LIM;
        .var _bw_i_C2_MAIN_LIM;        /* sample index, across the call */
...
_C2_MAIN_LIM_process:
            ...
            r5 = 0;
            dm(_bw_i_C2_MAIN_LIM) = r5;
            lcntr = DSP4_BLOCK_SIZE, do .bwlp_C2_MAIN_LIM until lce;
                r5 = dm(_bw_i_C2_MAIN_LIM);
                dm(_sample_idx) = r5;
                ...
                r5 = dm(_bw_i_C2_MAIN_LIM);
                r5 = r5 + 1;
            .bwlp_C2_MAIN_LIM: dm(_bw_i_C2_MAIN_LIM) = r5;

...
.var _rx_ic_slot_C2_RECV_AUX_11[DSP4_BLOCK_SIZE];
...
.global _blk_C2_RECV_AUX_11;
.var _blk_C2_RECV_AUX_11[DSP4_BLOCK_SIZE];
...
_C2_RECV_AUX_11_process:
    ...
    lcntr = r5; do .icr_sig_C2_RECV_AUX_11 until lce;
        r0 = dm(i0, 1);           /* production read, still paid */
        r0 = r7;                  /* DISCARD it -- see above */
        dm(i1, 1) = r0;
.icr_sig_C2_RECV_AUX_11:
...
.icr_lp_C2_RECV_AUX_11:
    ...
    r2 = -r0;
    r3 = dm(_rx_ic_slot_C2_RECV_AUX_11);  /* production read, still paid */
    r3 = pass r1;

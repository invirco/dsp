/*----------------------------------------------------------------------
 * Main Out 2 Lim (LIMITER)
 * Node ID:    C2_MAIN_OLIM_02
 * Chip:       2
 * Channels:   1
 * SPI Page:   1
 * SPI Addr:   1525
...
#include "lib/dyn_lut.h"
        ...
        /* SPI page=1 addr=1525 */

        .section/dm seg_dmda;
.extern _buf_C2_MAIN_OCOMP_02;
        .global _lim_on_C2_MAIN_OLIM_02;
        .var _lim_on_C2_MAIN_OLIM_02 = 1;
        .global _lim_threshold_C2_MAIN_OLIM_02;
        .var _lim_threshold_C2_MAIN_OLIM_02 = -0.5;
        .global _lim_attack_C2_MAIN_OLIM_02;
        .var _lim_attack_C2_MAIN_OLIM_02 = 0.5;
        .global _lim_release_C2_MAIN_OLIM_02;
        .var _lim_release_C2_MAIN_OLIM_02 = 0.001;
        .global _lim_envelope_C2_MAIN_OLIM_02;
        .var _lim_envelope_C2_MAIN_OLIM_02 = 0;
        .global _lim_attq_C2_MAIN_OLIM_02;
        .var _lim_attq_C2_MAIN_OLIM_02 = 0;
        .global _lim_relq_C2_MAIN_OLIM_02;
        .var _lim_relq_C2_MAIN_OLIM_02 = 0;
        .global _lim_cgp_C2_MAIN_OLIM_02;
        .var _lim_cgp_C2_MAIN_OLIM_02[4];
#if DSP4_DYN_LUT
         ...
         * gather and a lerp. */
        .global _lim_lut_C2_MAIN_OLIM_02;
        .var _lim_lut_C2_MAIN_OLIM_02[DYN_LUT_N];
        .global _lim_lutc_C2_MAIN_OLIM_02;
        .var _lim_lutc_C2_MAIN_OLIM_02 = 0;
        .global _lim_lutk_C2_MAIN_OLIM_02;
        .var _lim_lutk_C2_MAIN_OLIM_02[4] = 1, 1, 1, 1;
#endif
        .global _buf_C2_MAIN_OLIM_02;
        .var _buf_C2_MAIN_OLIM_02;

        #if DSP4_BLOCK_KERNELS
        .extern _blk_C2_MAIN_OCOMP_02;
        #endif
        #if DSP4_BLOCK_KERNELS
        .global _blk_C2_MAIN_OLIM_02;
        .var _blk_C2_MAIN_OLIM_02[DSP4_BLOCK_SIZE];
        .global _bw_k_C2_MAIN_OLIM_02;
        .var _bw_k_C2_MAIN_OLIM_02;        /* the caller's _sample_idx */
        .global _bw_s0_C2_MAIN_OLIM_02;
        .var _bw_s0_C2_MAIN_OLIM_02;       /* walking source pointer */
        .global _bw_d0_C2_MAIN_OLIM_02;
        .var _bw_d0_C2_MAIN_OLIM_02;       /* walking sink pointer */
        #endif
...
#endif
        .global _C2_MAIN_OLIM_02_process;
        _C2_MAIN_OLIM_02_process:
        #if DSP4_BLOCK_KERNELS
            ...
            r3 = i4;
            dm(_bw_s0_C2_MAIN_OLIM_02) = r3;
            i4 = _blk_C2_MAIN_OLIM_02;
            r3 = i4;
            dm(_bw_d0_C2_MAIN_OLIM_02) = r3;
            r5 = dm(_sample_idx);
            dm(_bw_k_C2_MAIN_OLIM_02) = r5;
            r5 = 0;
            dm(_sample_idx) = r5;
            /* sample 0, peeled: the block-rate guard fires here */
                r3 = dm(_bw_s0_C2_MAIN_OLIM_02);
                i4 = r3;
                r0 = dm(i4, 0);
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_MAIN_OLIM_02 until lce;
                r3 = dm(_bw_s0_C2_MAIN_OLIM_02);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_MAIN_OCOMP_02) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_MAIN_OLIM_02: dm(_bw_d0_C2_MAIN_OLIM_02) = r3;
            r5 = dm(_bw_k_C2_MAIN_OLIM_02);
            dm(_sample_idx) = r5;
            rts;

        .global _C2_MAIN_OLIM_02_process_sample;
        _C2_MAIN_OLIM_02_process_sample:
        #endif
            r0 = dm(_buf_C2_MAIN_OCOMP_02);
            r2 = dm(_lim_on_C2_MAIN_OLIM_02);
            r3 = 0;
            comp(r2, r3);
            if eq jump (pc, .lim_bypass_C2_MAIN_OLIM_02);
            r13 = r0;
         ...
         * BLOCK-1, would run the whole conversion on every sample. */
            ...
            r1 = 0;
            comp(r4, r1);
            if ne jump (pc, .lim_go_C2_MAIN_OLIM_02);
            r2 = 0x4F000000;              /* 2^31 float */
            f2 = r2;
            f1 = dm(_lim_attack_C2_MAIN_OLIM_02);
            f1 = f1 * f2;
            r1 = fix f1;
            dm(_lim_attq_C2_MAIN_OLIM_02) = r1;
            f1 = dm(_lim_release_C2_MAIN_OLIM_02);
            f1 = f1 * f2;
            r1 = fix f1;
            dm(_lim_relq_C2_MAIN_OLIM_02) = r1;
            r2 = 0x4AAA152D;            /* dB -> Q6.25 log2 */
            f2 = r2;
            f1 = dm(_lim_threshold_C2_MAIN_OLIM_02);
            f1 = f1 * f2;
            r1 = fix f1;
            dm(_lim_cgp_C2_MAIN_OLIM_02) = r1;    /* thr */
            r1 = 0x7FFFFFFF;              /* slope = ~1.0 (brick wall) */
            dm(_lim_cgp_C2_MAIN_OLIM_02 + 1) = r1;
            r1 = 0;
            dm(_lim_cgp_C2_MAIN_OLIM_02 + 2) = r1;
            dm(_lim_cgp_C2_MAIN_OLIM_02 + 3) = r1;
#if DSP4_DYN_LUT
             ...
             * only. */
            r0 = _lim_cgp_C2_MAIN_OLIM_02;
            r1 = _lim_lutk_C2_MAIN_OLIM_02;
            r2 = _lim_lut_C2_MAIN_OLIM_02;
            r3 = _lim_lutc_C2_MAIN_OLIM_02;
            call _dyn_lut_step;
#endif
        .lim_go_C2_MAIN_OLIM_02:

            r0 = abs r13;
            r1 = dm(_lim_envelope_C2_MAIN_OLIM_02);
            r2 = dm(_lim_attq_C2_MAIN_OLIM_02);
            r3 = dm(_lim_relq_C2_MAIN_OLIM_02);
            call _envq_fx;
            dm(_lim_envelope_C2_MAIN_OLIM_02) = r0;
            ...
            r4 = dm(_lim_lutc_C2_MAIN_OLIM_02);
            r5 = DYN_LUT_N;
            comp(r4, r5);
            if lt jump (pc, .llutpoly_C2_MAIN_OLIM_02);
            i0 = _lim_lut_C2_MAIN_OLIM_02;
            call _dyn_lut_gain;           /* r0 = gain Q4.28 */
            jump (pc, .llutgain_C2_MAIN_OLIM_02);
        .llutpoly_C2_MAIN_OLIM_02:
#endif
            i0 = _lim_cgp_C2_MAIN_OLIM_02;
            call _compgain_fx;
#if DSP4_DYN_LUT
        .llutgain_C2_MAIN_OLIM_02:
#endif
            r1 = r0;
            r0 = r13;
            mrf = r0 * r1 (ssi);
            ...
            rts;
        .lim_bypass_C2_MAIN_OLIM_02:
            dm(_buf_C2_MAIN_OLIM_02) = r0;
            rts;
        _C2_MAIN_OLIM_02_process.end:

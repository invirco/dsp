/*----------------------------------------------------------------------
 * Aux 4 AntiFB (ANTI_FB)
 * Node ID:    C2_AUX_AFB_04
 * Chip:       2
 * Channels:   1
 * SPI Page:   1
 * SPI Addr:   317
...
.var _afb_coeffs_A_C2_AUX_AFB_04[30] = 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0;
#elif DSP4_BQ_GUARD
.global _afb_coeffs_A_C2_AUX_AFB_04;
.var _afb_coeffs_A_C2_AUX_AFB_04[30 + 1] = 0, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#else
.global _afb_coeffs_A_C2_AUX_AFB_04;
.var _afb_coeffs_A_C2_AUX_AFB_04[30] = 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#endif
.global _afb_state_A_C2_AUX_AFB_04;
.var _afb_state_A_C2_AUX_AFB_04[36];
#if DSP4_BQ_FLOAT
.global _afb_coeffs_B_C2_AUX_AFB_04;
.var _afb_coeffs_B_C2_AUX_AFB_04[30] = 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0, 0x3F800000, 0, 0, 0, 0;
#elif DSP4_BQ_GUARD
.global _afb_coeffs_B_C2_AUX_AFB_04;
.var _afb_coeffs_B_C2_AUX_AFB_04[30 + 1] = 0, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#else
.global _afb_coeffs_B_C2_AUX_AFB_04;
.var _afb_coeffs_B_C2_AUX_AFB_04[30] = 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#endif
.global _afb_state_B_C2_AUX_AFB_04;
.var _afb_state_B_C2_AUX_AFB_04[36];

/* SPI staging (FLOAT RBJ words — wire format unchanged) */
.global _afb_coeffs_next_C2_AUX_AFB_04;
.var _afb_coeffs_next_C2_AUX_AFB_04[30];
.global _afb_swap_pending_C2_AUX_AFB_04;
.var _afb_swap_pending_C2_AUX_AFB_04 = 0;
#if DSP4_BQ_GUARD
.global _afb_hrw_C2_AUX_AFB_04;
.var _afb_hrw_C2_AUX_AFB_04 = 0;        /* 0 idle, 1 asked, 2 re-ask */
.global _afb_hrl_C2_AUX_AFB_04;
.var _afb_hrl_C2_AUX_AFB_04[2];       /* (block, stages) pairs */
#endif

.global _afb_active_C2_AUX_AFB_04;
.var _afb_active_C2_AUX_AFB_04 = 0;
.global _afb_xfade_alpha_C2_AUX_AFB_04;
.var _afb_xfade_alpha_C2_AUX_AFB_04 = 0.0;
.global _afb_xfade_step_C2_AUX_AFB_04;
.var _afb_xfade_step_C2_AUX_AFB_04 = 0.0;


.global _buf_C2_AUX_AFB_04;
.var _buf_C2_AUX_AFB_04;

        #if DSP4_BLOCK_KERNELS
        .extern _blk_C2_AUX_GEQ_04;
        #endif
        #if DSP4_BLOCK_KERNELS
        .global _blk_C2_AUX_AFB_04;
        .var _blk_C2_AUX_AFB_04[DSP4_BLOCK_SIZE];
        .global _bw_k_C2_AUX_AFB_04;
        .var _bw_k_C2_AUX_AFB_04;        /* the caller's _sample_idx */
        .global _bw_s0_C2_AUX_AFB_04;
        .var _bw_s0_C2_AUX_AFB_04;       /* walking source pointer */
        .global _bw_d0_C2_AUX_AFB_04;
        .var _bw_d0_C2_AUX_AFB_04;       /* walking sink pointer */
        #endif
...
_C2_AUX_AFB_04_process:
    ...
    r4 = dm(_afb_swap_pending_C2_AUX_AFB_04);
    r5 = dm(_afb_xfade_step_C2_AUX_AFB_04);
    r4 = r4 or r5;
#if DSP4_BQ_GUARD
    r5 = dm(_afb_hrw_C2_AUX_AFB_04);
    r4 = r4 or r5;      /* a sizing in flight is a transient too */
#endif
    r4 = pass r4;
    if ne jump (pc, .afbkb_tr_C2_AUX_AFB_04);
    ...
    i3 = _blk_C2_AUX_GEQ_04;
    i4 = _blk_C2_AUX_AFB_04;
    lcntr = DSP4_BLOCK_SIZE, do .afbkb_cp_C2_AUX_AFB_04 until lce;
        r0 = dm(i3, 1);
    .afbkb_cp_C2_AUX_AFB_04: dm(i4, 1) = r0;

    r4 = dm(_afb_active_C2_AUX_AFB_04);
    r4 = pass r4;
    if ne jump (pc, .afbkb_b_C2_AUX_AFB_04);
    i0 = _afb_coeffs_A_C2_AUX_AFB_04;
    i1 = _afb_state_A_C2_AUX_AFB_04;
    jump (pc, .afbkb_go_C2_AUX_AFB_04);
.afbkb_b_C2_AUX_AFB_04:
    i0 = _afb_coeffs_B_C2_AUX_AFB_04;
    i1 = _afb_state_B_C2_AUX_AFB_04;
.afbkb_go_C2_AUX_AFB_04:
    i2 = _blk_C2_AUX_AFB_04;
    r4 = 6;
...
.afbkb_tr_C2_AUX_AFB_04:
            ...
            r3 = i4;
            dm(_bw_s0_C2_AUX_AFB_04) = r3;
            i4 = _blk_C2_AUX_AFB_04;
            r3 = i4;
            dm(_bw_d0_C2_AUX_AFB_04) = r3;
            r5 = dm(_sample_idx);
            dm(_bw_k_C2_AUX_AFB_04) = r5;
            r5 = 0;
            dm(_sample_idx) = r5;
            /* sample 0, peeled: the block-rate guard fires here */
                r3 = dm(_bw_s0_C2_AUX_AFB_04);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_AUX_GEQ_04) = r0;
                r3 = r3 + 1;
                dm(_bw_s0_C2_AUX_AFB_04) = r3;
                call _C2_AUX_AFB_04_process_sample;
                r0 = dm(_buf_C2_AUX_AFB_04);
                r3 = dm(_bw_d0_C2_AUX_AFB_04);
                i4 = r3;
                dm(i4, 0) = r0;
                r3 = r3 + 1;
                dm(_bw_d0_C2_AUX_AFB_04) = r3;
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_AUX_AFB_04 until lce;
                r3 = dm(_bw_s0_C2_AUX_AFB_04);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_AUX_GEQ_04) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_AUX_AFB_04: dm(_bw_d0_C2_AUX_AFB_04) = r3;
            r5 = dm(_bw_k_C2_AUX_AFB_04);
            dm(_sample_idx) = r5;
            rts;

        .global _C2_AUX_AFB_04_process_sample;
        _C2_AUX_AFB_04_process_sample:
        #endif
    ...
    #endif
    r4 = pass r4;
    if ne call _afb_start_xfade_C2_AUX_AFB_04;

    r4 = dm(_afb_xfade_step_C2_AUX_AFB_04);
    r4 = pass r4;
    if ne jump (pc, .afb_xfade_C2_AUX_AFB_04);

    /* ===== steady state ===== */
    r0 = dm(_buf_C2_AUX_GEQ_04);
    r4 = dm(_afb_active_C2_AUX_AFB_04);
    r4 = pass r4;
    if ne jump (pc, .afb_ss_b_C2_AUX_AFB_04);
    i0 = _afb_coeffs_A_C2_AUX_AFB_04;
    i1 = _afb_state_A_C2_AUX_AFB_04;
    jump (pc, .afb_ss_go_C2_AUX_AFB_04);
.afb_ss_b_C2_AUX_AFB_04:
    i0 = _afb_coeffs_B_C2_AUX_AFB_04;
    i1 = _afb_state_B_C2_AUX_AFB_04;
.afb_ss_go_C2_AUX_AFB_04:
    r4 = 6;
...
.afb_xfade_C2_AUX_AFB_04:
    ...
    r4 = dm(_afb_active_C2_AUX_AFB_04);
    r4 = pass r4;
    if eq jump (pc, .afb_bl_C2_AUX_AFB_04);
    r5 = r14;                     /* active B: new is A */
    r14 = r0;
    r0 = r5;
.afb_bl_C2_AUX_AFB_04:
    f4 = dm(_afb_xfade_alpha_C2_AUX_AFB_04);
    ...
    f4 = dm(_afb_xfade_alpha_C2_AUX_AFB_04);
    f5 = dm(_afb_xfade_step_C2_AUX_AFB_04);
    f4 = f4 + f5;
    dm(_afb_xfade_alpha_C2_AUX_AFB_04) = f4;
    r5 = 0x3F800000;
    f5 = r5;
    comp(f4, f5);
    if lt rts;
    ...
    r5 = 1;
    r4 = r4 xor r5;
    dm(_afb_active_C2_AUX_AFB_04) = r4;
    r4 = 0;
    dm(_afb_xfade_step_C2_AUX_AFB_04) = r4;
    dm(_afb_xfade_alpha_C2_AUX_AFB_04) = r4;
    rts;

    /* ===== stage new coeffs into dormant ===== */
_afb_start_xfade_C2_AUX_AFB_04:
    #if DSP4_BQ_GUARD
    /* Convert, size, and hold the fade until H is written. */
    r0 = _afb_hrw_C2_AUX_AFB_04;
    r1 = _afb_hrl_C2_AUX_AFB_04;
    r2 = _afb_active_C2_AUX_AFB_04;
    r3 = _afb_coeffs_A_C2_AUX_AFB_04;
    r4 = _afb_coeffs_B_C2_AUX_AFB_04;
    r5 = _afb_state_A_C2_AUX_AFB_04;
    r6 = _afb_state_B_C2_AUX_AFB_04;
    r7 = _afb_coeffs_next_C2_AUX_AFB_04;
    r8 = 6;
    ...
    r4 = 0;
    dm(_afb_swap_pending_C2_AUX_AFB_04) = r4;
    i0 = _afb_coeffs_next_C2_AUX_AFB_04;
    r4 = dm(_afb_active_C2_AUX_AFB_04);
    r4 = pass r4;
    if ne jump (pc, .afb_st_a_C2_AUX_AFB_04);
    i1 = _afb_coeffs_B_C2_AUX_AFB_04;
    i2 = _afb_state_B_C2_AUX_AFB_04;
    jump (pc, .afb_st_go_C2_AUX_AFB_04);
.afb_st_a_C2_AUX_AFB_04:
    i1 = _afb_coeffs_A_C2_AUX_AFB_04;
    i2 = _afb_state_A_C2_AUX_AFB_04;
.afb_st_go_C2_AUX_AFB_04:
    r4 = 6;
    call _bq_fx_convert_N;
#endif
    r4 = 0;
    r5 = 36;
    lcntr = r5, do .afb_zst_C2_AUX_AFB_04 until lce;
.afb_zst_C2_AUX_AFB_04:
        dm(i2, 1) = r4;
    f0 = 0.001736111111111111;
    dm(_afb_xfade_step_C2_AUX_AFB_04) = f0;
    r4 = 0;
    dm(_afb_xfade_alpha_C2_AUX_AFB_04) = r4;
    rts;

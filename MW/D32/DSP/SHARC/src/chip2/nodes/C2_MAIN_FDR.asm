...
#include "dsp_block.h"
        ...
        /* SPI page=1 addr=1343 */

        .section/dm seg_dmda;
.extern _buf_C2_MIX_MAIN_L;
        .global _fdr_level_C2_MAIN_FDR;
        .var _fdr_level_C2_MAIN_FDR = 1.0;
        .global _fdr_level_target_C2_MAIN_FDR;
        .var _fdr_level_target_C2_MAIN_FDR = 1.0;
        .global _fdr_level_step_C2_MAIN_FDR;
        .var _fdr_level_step_C2_MAIN_FDR = 0.0;
        .global _fdr_level_frames_C2_MAIN_FDR;
        .var _fdr_level_frames_C2_MAIN_FDR = 0;
        .global _fdr_pan_C2_MAIN_FDR;
        .var _fdr_pan_C2_MAIN_FDR = 0.5;
        .global _fdr_pan_target_C2_MAIN_FDR;
        .var _fdr_pan_target_C2_MAIN_FDR = 0.5;
        .global _fdr_pan_step_C2_MAIN_FDR;
        .var _fdr_pan_step_C2_MAIN_FDR = 0.0;
        .global _fdr_pan_frames_C2_MAIN_FDR;
        .var _fdr_pan_frames_C2_MAIN_FDR = 0;
        .global _fdr_mute_C2_MAIN_FDR;
        .var _fdr_mute_C2_MAIN_FDR = 0;
        ...
        .global _fdr_dca_sel_C2_MAIN_FDR;
        .var _fdr_dca_sel_C2_MAIN_FDR = 0;              /* 0 = no DCA assigned */
        .global _fdr_dca_gain_C2_MAIN_FDR;
        .var _fdr_dca_gain_C2_MAIN_FDR = 1.0;           /* resolved master gain */
        .global _fdr_gq_C2_MAIN_FDR;
        .var _fdr_gq_C2_MAIN_FDR = 0x10000000;          /* Q4.28 level*dca */
        ...
        .global _fdr_busy_C2_MAIN_FDR;
        .global _fdr_busy_C2_MAIN_FDR;
        .var _fdr_busy_C2_MAIN_FDR = 0;
        #endif

        .global _tap_post_fader_C2_MAIN_FDR;
        ...
        .extern _sample_idx;
        .extern _mrf_rns28;
        .global _C2_MAIN_FDR_process;
        _C2_MAIN_FDR_process:
            /* block-rate: float ramps + shadow conversion */
        #if !DSP4_BLOCK_KERNELS
            r4 = dm(_sample_idx);
            r1 = 0;
            comp(r4, r1);
            if ne jump (pc, .apply_C2_MAIN_FDR);
        #endif
            ...
            r4 = dm(_fdr_level_frames_C2_MAIN_FDR);
            r1 = dm(_fdr_pan_frames_C2_MAIN_FDR);
            r1 = max(r1, r4);
            r5 = 0;
            r1 = max(r1, r5);
            dm(_fdr_busy_C2_MAIN_FDR) = r1;
        #endif
        ...
        .lsnap_C2_MAIN_FDR:
            f1 = dm(_fdr_level_target_C2_MAIN_FDR);
            dm(_fdr_level_C2_MAIN_FDR) = f1;
        .pramp_C2_MAIN_FDR:
            /* pan ramp */
            r4 = dm(_fdr_pan_frames_C2_MAIN_FDR);
            r1 = 0;
            comp(r4, r1);
        ...
        .psnap_C2_MAIN_FDR:
            f1 = dm(_fdr_pan_target_C2_MAIN_FDR);
            dm(_fdr_pan_C2_MAIN_FDR) = f1;
        .cvt_C2_MAIN_FDR:
            /* composite = level * dca; Q4.28 shadow(s) */
            f1 = dm(_fdr_level_C2_MAIN_FDR);
            f2 = dm(_fdr_dca_gain_C2_MAIN_FDR);
            f1 = f1 * f2;
            r2 = 0x4D800000;
            f2 = r2;
            f3 = f1 * f2;
             ...
             * construction. */
            r14 = DSP4_BLOCK_HALF;
            lcntr = r14; do .fdr_lp_C2_MAIN_FDR until lce;
                r0 = dm(i0, 1);                 /* xA */
                r3 = dm(i0, 1);                 /* xB */
                mrf = r0 * r1 (ssi);
                mrb = r3 * r1 (ssi);
        ...
        .fdr_lp_C2_MAIN_FDR:
                dm(i1, 1) = r3;
            dm(_tap_post_fader_C2_MAIN_FDR) = r3;   /* linkage scalars */
            dm(_buf_C2_MAIN_FDR) = r3;
            rts;
        #else
            r14 = DSP4_BLOCK_SIZE;
        .fdr_lp_C2_MAIN_FDR:
            ...
            r13 = r0;
            r14 = r14 - 1;
            if gt jump (pc, .fdr_lp_C2_MAIN_FDR);
            dm(_tap_post_fader_C2_MAIN_FDR) = r13;  /* linkage scalars */
            dm(_buf_C2_MAIN_FDR) = r13;
            rts;
        #endif
#else
        .apply_C2_MAIN_FDR:

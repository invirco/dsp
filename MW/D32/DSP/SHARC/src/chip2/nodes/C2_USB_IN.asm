...
.var _buf_C2_USB_IN;
        ...
        .global _bw_i_C2_USB_IN;
        .var _bw_i_C2_USB_IN;        /* sample index, across the call */
...
_C2_USB_IN_process:
            ...
            r5 = 0;
            dm(_bw_i_C2_USB_IN) = r5;
            lcntr = DSP4_BLOCK_SIZE, do .bwlp_C2_USB_IN until lce;
                r5 = dm(_bw_i_C2_USB_IN);
                dm(_sample_idx) = r5;
                ...
                r5 = dm(_bw_i_C2_USB_IN);
                r5 = r5 + 1;
            .bwlp_C2_USB_IN: dm(_bw_i_C2_USB_IN) = r5;

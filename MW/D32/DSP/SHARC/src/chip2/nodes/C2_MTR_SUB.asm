...
.var _mtr_acc_C2_MTR_SUB[4];          /* mx mn ssq_lo ssq_hi            */
#endif
...
_C2_MTR_SUB_process:
     ...
     *
     * LIMITATION, recorded: C2_SUB_OUT publishes no
     * block under DSP4_BLOCK_KERNELS, only the
     * scalar _buf_C2_SUB_OUT holding the LAST sample,

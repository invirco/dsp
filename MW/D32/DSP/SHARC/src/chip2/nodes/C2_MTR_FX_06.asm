...
.var _mtr_peak_C2_MTR_FX_06 = 0.0;
.global _mtr_rms_C2_MTR_FX_06;
.var _mtr_rms_C2_MTR_FX_06 = 0.0;
.global _mtr_gr_C2_MTR_FX_06;
.var _mtr_gr_C2_MTR_FX_06 = 0.0;         /* gain reduction (gate or comp) */
...
_C2_MTR_FX_06_process:
    ...
    l2 = 0;
    i2 = BLK_CHAIN_B;
    lcntr = 32, do .mtrk_C2_MTR_FX_06 until lce;
        r0 = dm(i2, 1);
        call _mtr_step_C2_MTR_FX_06;
    .mtrk_C2_MTR_FX_06: nop;
    rts;

_mtr_step_C2_MTR_FX_06:
#endif
    /* Read source tap */
#if !DSP4_BLOCK_KERNELS
    ...
    f1 = dm(_mtr_peak_C2_MTR_FX_06);
    comp(f0, f1);
    if le jump (pc, .mtr_decay_C2_MTR_FX_06);
    dm(_mtr_peak_C2_MTR_FX_06) = f0;
    rts;
.mtr_decay_C2_MTR_FX_06:
    /* Decay: peak *= 0.9995 (~150ms to -60dB at 1500 Hz frame rate) */
    r2 = 0x3F7FDF3B;  /* 0.9995 IEEE 754 */
    f1 = f1 * f2;
    dm(_mtr_peak_C2_MTR_FX_06) = f1;

    /* RMS: single-pole IIR on x² */
    f3 = dm(_mtr_rms_C2_MTR_FX_06);
    f4 = f0 * f0;             /* x² */
    r5 = 0x3C23D70A;  /* 0.01 IEEE 754 */
    f6 = f4 - f3;
    f6 = f5 * f6;
    f3 = f3 + f6;
    dm(_mtr_rms_C2_MTR_FX_06) = f3;
    rts;

...
.var _afb_ctrl_on_C2_AUX_AFB_01 = 0;   /* the AUTOMATIC detector's switch — no
...
.global _afb_dirty_C2_AUX_AFB_01;
.var _afb_dirty_C2_AUX_AFB_01 = 0;     /* set by the SPI handler; cleared by the design */

#if DSP4_BQ_FLOAT
.global _afb_coeffs_A_C2_AUX_AFB_01;
.var _afb_coeffs_A_C2_AUX_AFB_01[30] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#elif DSP4_BQ_GUARD
.global _afb_coeffs_A_C2_AUX_AFB_01;
.var _afb_coeffs_A_C2_AUX_AFB_01[30 + 1] = 0, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#else
.global _afb_coeffs_A_C2_AUX_AFB_01;
.var _afb_coeffs_A_C2_AUX_AFB_01[30] = 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000, 0x10000000, 0x10000000, 0xF0000000, 0x20000000, 0x10000000;
#endif
...
.var _afb_coeffs_next_C2_AUX_AFB_01[30] = 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000, 0x3F800000, 0x40000000, 0xBF800000, 0x40000000, 0x3F800000;
#else
.global _afb_coeffs_next_C2_AUX_AFB_01;
...
#if DSP4_BQ_GUARD
.global _afb_hrw_C2_AUX_AFB_01;
.var _afb_hrw_C2_AUX_AFB_01 = 0;        /* 0 idle, 1 asked, 2 re-ask */
.global _afb_hrl_C2_AUX_AFB_01;
.var _afb_hrl_C2_AUX_AFB_01[2];       /* (block, stages) pairs */
#endif
...
.var _buf_C2_AUX_AFB_01;
        ...
        #endif
        #if DSP4_BLOCK_KERNELS
        .global _blk_C2_AUX_AFB_01;
        .var _blk_C2_AUX_AFB_01[DSP4_BLOCK_SIZE];
        .global _bw_k_C2_AUX_AFB_01;
        .var _bw_k_C2_AUX_AFB_01;        /* the caller's _sample_idx */
        .global _bw_s0_C2_AUX_AFB_01;
        .var _bw_s0_C2_AUX_AFB_01;       /* walking source pointer */
        .global _bw_d0_C2_AUX_AFB_01;
        .var _bw_d0_C2_AUX_AFB_01;       /* walking sink pointer */
        #endif
...
_C2_AUX_AFB_01_process:
    ...
    r4 = dm(_afb_dirty_C2_AUX_AFB_01);
    r4 = pass r4;
    ...
    r5 = dm(_afb_xfade_step_C2_AUX_AFB_01);
    r4 = r4 or r5;
#if DSP4_BQ_GUARD
    r5 = dm(_afb_hrw_C2_AUX_AFB_01);
    r4 = r4 or r5;      /* a sizing in flight is a transient too */
#endif
    r4 = pass r4;
    if ne jump (pc, .afbkb_tr_C2_AUX_AFB_01);
    ...
    lcntr = DSP4_BLOCK_SIZE, do .afbkb_cp_C2_AUX_AFB_01 until lce;
        r0 = dm(i3, 1);
    .afbkb_cp_C2_AUX_AFB_01: dm(i4, 1) = r0;

    r4 = dm(_afb_active_C2_AUX_AFB_01);
    r4 = pass r4;
    if ne jump (pc, .afbkb_b_C2_AUX_AFB_01);
    i0 = _afb_coeffs_A_C2_AUX_AFB_01;
    i1 = _afb_state_A_C2_AUX_AFB_01;
    jump (pc, .afbkb_go_C2_AUX_AFB_01);
.afbkb_b_C2_AUX_AFB_01:
    i0 = _afb_coeffs_B_C2_AUX_AFB_01;
    i1 = _afb_state_B_C2_AUX_AFB_01;
.afbkb_go_C2_AUX_AFB_01:
...
.afbkb_tr_C2_AUX_AFB_01:
            ...
            r3 = i4;
            dm(_bw_s0_C2_AUX_AFB_01) = r3;
            i4 = _blk_C2_AUX_AFB_01;
            r3 = i4;
            dm(_bw_d0_C2_AUX_AFB_01) = r3;
            r5 = dm(_sample_idx);
            dm(_bw_k_C2_AUX_AFB_01) = r5;
            r5 = 0;
            dm(_sample_idx) = r5;
            /* sample 0, peeled: the block-rate guard fires here */
                r3 = dm(_bw_s0_C2_AUX_AFB_01);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_AUX_GEQ_01) = r0;
                r3 = r3 + 1;
                dm(_bw_s0_C2_AUX_AFB_01) = r3;
                call _C2_AUX_AFB_01_process_sample;
                r0 = dm(_buf_C2_AUX_AFB_01);
                r3 = dm(_bw_d0_C2_AUX_AFB_01);
                i4 = r3;
                dm(i4, 0) = r0;
                r3 = r3 + 1;
                dm(_bw_d0_C2_AUX_AFB_01) = r3;
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_AUX_AFB_01 until lce;
                r3 = dm(_bw_s0_C2_AUX_AFB_01);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_AUX_GEQ_01) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_AUX_AFB_01: dm(_bw_d0_C2_AUX_AFB_01) = r3;
            r5 = dm(_bw_k_C2_AUX_AFB_01);
            dm(_sample_idx) = r5;
            rts;

        .global _C2_AUX_AFB_01_process_sample;
        _C2_AUX_AFB_01_process_sample:
        #endif
...
_afb_start_xfade_C2_AUX_AFB_01:
    ...
    r0 = _afb_hrw_C2_AUX_AFB_01;
    r1 = _afb_hrl_C2_AUX_AFB_01;
    r2 = _afb_active_C2_AUX_AFB_01;
    r3 = _afb_coeffs_A_C2_AUX_AFB_01;
    r4 = _afb_coeffs_B_C2_AUX_AFB_01;
    r5 = _afb_state_A_C2_AUX_AFB_01;
    r6 = _afb_state_B_C2_AUX_AFB_01;
    r7 = _afb_coeffs_next_C2_AUX_AFB_01;
    r8 = 6;
...
_afb_redesign_C2_AUX_AFB_01:
    ...
    r4 = 0;
    dm(_afb_dirty_C2_AUX_AFB_01) = r4;
    i0 = _afb_notch_freq_C2_AUX_AFB_01;
    i1 = _afb_notch_gain_C2_AUX_AFB_01;
    i4 = _afb_notch_q_C2_AUX_AFB_01;
    i2 = _afb_coeffs_next_C2_AUX_AFB_01;
    r13 = dm(_afb_on_C2_AUX_AFB_01);
    r4 = 6;
    call _afb_design_N;
    r4 = 1;
    dm(_afb_swap_pending_C2_AUX_AFB_01) = r4;

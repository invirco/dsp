/*----------------------------------------------------------------------
 * Matrix 2 Recv (INTERCHIP_RECV)
 * Node ID:    C2_RECV_MTX_02
 * Chip:       2
 * Channels:   1
 * SPI Page:   -1
 * SPI Addr:   -1
...
/* INTERCHIP_RECV: mix-fabric line 2 slot 6 (global slot 38, signal BUS_MTX_02) */
...
.global _rx_ic_slot_C2_RECV_MTX_02;
.var _rx_ic_slot_C2_RECV_MTX_02[DSP4_BLOCK_SIZE];
...
.global _blk_C2_RECV_MTX_02;
.var _blk_C2_RECV_MTX_02[DSP4_BLOCK_SIZE];
.global _buf_C2_RECV_MTX_02;
.var _buf_C2_RECV_MTX_02;
#else
.global _rx_ic_slot_C2_RECV_MTX_02;
.var _rx_ic_slot_C2_RECV_MTX_02;
.global _buf_C2_RECV_MTX_02;
.var _buf_C2_RECV_MTX_02;
#endif

.section/pm seg_pmco;
.global _C2_RECV_MTX_02_process;
_C2_RECV_MTX_02_process:
#if DSP4_BLOCK_KERNELS
    l0 = 0;
    l1 = 0;
    i0 = _rx_ic_slot_C2_RECV_MTX_02;
    i1 = _blk_C2_RECV_MTX_02;
    ...
    lcntr = r5; do .icr_sig_C2_RECV_MTX_02 until lce;
        r0 = dm(i0, 1);           /* production read, still paid */
        r0 = r7;                  /* DISCARD it -- see above */
        dm(i1, 1) = r0;
.icr_sig_C2_RECV_MTX_02:
        r7 = -r7;                 /* flip sign, |x| unchanged */
    rts;
#endif
    r5 = DSP4_BLOCK_SIZE;
    lcntr = r5; do .icr_lp_C2_RECV_MTX_02 until lce;
        r0 = dm(i0, 1);
        dm(i1, 1) = r0;
.icr_lp_C2_RECV_MTX_02:
        nop;
    rts;
#else
#if DSP4_PROFILE_SIGNAL
    ...
    r2 = -r0;
    r3 = dm(_rx_ic_slot_C2_RECV_MTX_02);  /* production read, still paid */
    r3 = pass r1;
    if ne r0 = r2;                /* odd sample: -0.5 */
    dm(_buf_C2_RECV_MTX_02) = r0;
    rts;
#endif
    r0 = dm(_rx_ic_slot_C2_RECV_MTX_02);
    dm(_buf_C2_RECV_MTX_02) = r0;
    rts;
#endif
_C2_RECV_MTX_02_process.end:

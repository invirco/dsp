...
_C2_FX_ENG_04_process:
        #if DSP4_BLOCK_KERNELS
            /* ---- PARK: _fx_on_C2_FX_ENG_04 is off ---- */
            r5 = dm(_fx_on_C2_FX_ENG_04);
            r5 = pass r5;
            if ne jump (pc, .bwrun_C2_FX_ENG_04);
            l0 = 0;
            r0 = 0;
            i0 = _blk_C2_FX_ENG_04;
            lcntr = DSP4_BLOCK_SIZE, do .bwpk_C2_FX_ENG_04 until lce;
            .bwpk_C2_FX_ENG_04: dm(i0, 1) = r0;
     ...
     * could write it, `_fx_on_C2_FX_ENG_04` was declared right above --
    ...
    r1 = dm(_fx_on_C2_FX_ENG_04);
    r1 = pass r1;
    if eq jump (pc, .fx_off_C2_FX_ENG_04);
...
.fx_off_C2_FX_ENG_04:
     ...
     * second `dm(_buf_C2_FX_ENG_04) = r0;` anywhere in the body would
     * make that match ambiguous and stop the generator. */
    r1 = 0;
    dm(_buf_C2_FX_ENG_04) = r1;
    dm(_buf_L_C2_FX_ENG_04) = r1;
    dm(_buf_R_C2_FX_ENG_04) = r1;
    rts;

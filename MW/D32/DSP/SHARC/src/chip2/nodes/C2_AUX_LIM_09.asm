...
.extern _buf_C2_AUX_AFB_09;
        ...
        .var _lim_threshold_C2_AUX_LIM_09 = -0.5;
        .global _lim_attack_C2_AUX_LIM_09;
        .var _lim_attack_C2_AUX_LIM_09 = 0.5;
        .global _lim_release_C2_AUX_LIM_09;
        .var _lim_release_C2_AUX_LIM_09 = 0.001;
        .global _lim_envelope_C2_AUX_LIM_09;
        .var _lim_envelope_C2_AUX_LIM_09 = 0;
        .global _lim_attq_C2_AUX_LIM_09;
        .var _lim_attq_C2_AUX_LIM_09 = 0;
        .global _lim_relq_C2_AUX_LIM_09;
        .var _lim_relq_C2_AUX_LIM_09 = 0;
        .global _lim_cgp_C2_AUX_LIM_09;
        .var _lim_cgp_C2_AUX_LIM_09[4];
#if DSP4_DYN_LUT
         ...
         * gather and a lerp. */
        .global _lim_lut_C2_AUX_LIM_09;
        .var _lim_lut_C2_AUX_LIM_09[DYN_LUT_N];
        .global _lim_lutc_C2_AUX_LIM_09;
        .var _lim_lutc_C2_AUX_LIM_09 = 0;
        .global _lim_lutk_C2_AUX_LIM_09;
        .var _lim_lutk_C2_AUX_LIM_09[4] = 1, 1, 1, 1;
#endif
        ...
        #endif
        #if DSP4_BLOCK_KERNELS
        .global _blk_C2_AUX_LIM_09;
        .var _blk_C2_AUX_LIM_09[DSP4_BLOCK_SIZE];
        .global _bw_k_C2_AUX_LIM_09;
        .var _bw_k_C2_AUX_LIM_09;        /* the caller's _sample_idx */
        .global _bw_s0_C2_AUX_LIM_09;
        .var _bw_s0_C2_AUX_LIM_09;       /* walking source pointer */
        .global _bw_d0_C2_AUX_LIM_09;
        .var _bw_d0_C2_AUX_LIM_09;       /* walking sink pointer */
        #endif
        ...
        _C2_AUX_LIM_09_process:
            ...
            r3 = i4;
            dm(_bw_s0_C2_AUX_LIM_09) = r3;
            i4 = _blk_C2_AUX_LIM_09;
            r3 = i4;
            dm(_bw_d0_C2_AUX_LIM_09) = r3;
            r5 = dm(_sample_idx);
            dm(_bw_k_C2_AUX_LIM_09) = r5;
            r5 = 0;
            dm(_sample_idx) = r5;
            /* sample 0, peeled: the block-rate guard fires here */
                r3 = dm(_bw_s0_C2_AUX_LIM_09);
                i4 = r3;
                r0 = dm(i4, 0);
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_AUX_LIM_09 until lce;
                r3 = dm(_bw_s0_C2_AUX_LIM_09);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_AUX_AFB_09) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_AUX_LIM_09: dm(_bw_d0_C2_AUX_LIM_09) = r3;
            r5 = dm(_bw_k_C2_AUX_LIM_09);
            dm(_sample_idx) = r5;
            rts;

        .global _C2_AUX_LIM_09_process_sample;
        _C2_AUX_LIM_09_process_sample:
        #endif
         ...
         * BLOCK-1, would run the whole conversion on every sample. */
            ...
            r1 = 0;
            comp(r4, r1);
            if ne jump (pc, .lim_go_C2_AUX_LIM_09);
            r2 = 0x4F000000;              /* 2^31 float */
            f2 = r2;
            f1 = dm(_lim_attack_C2_AUX_LIM_09);
            f1 = f1 * f2;
            r1 = fix f1;
            dm(_lim_attq_C2_AUX_LIM_09) = r1;
            f1 = dm(_lim_release_C2_AUX_LIM_09);
            f1 = f1 * f2;
            r1 = fix f1;
            dm(_lim_relq_C2_AUX_LIM_09) = r1;
            r2 = 0x4AAA152D;            /* dB -> Q6.25 log2 */
            f2 = r2;
            f1 = dm(_lim_threshold_C2_AUX_LIM_09);
            f1 = f1 * f2;
            r1 = fix f1;
            dm(_lim_cgp_C2_AUX_LIM_09) = r1;    /* thr */
            r1 = 0x7FFFFFFF;              /* slope = ~1.0 (brick wall) */
            dm(_lim_cgp_C2_AUX_LIM_09 + 1) = r1;
            r1 = 0;
            dm(_lim_cgp_C2_AUX_LIM_09 + 2) = r1;
            dm(_lim_cgp_C2_AUX_LIM_09 + 3) = r1;
#if DSP4_DYN_LUT
             ...
             * only. */
            r0 = _lim_cgp_C2_AUX_LIM_09;
            r1 = _lim_lutk_C2_AUX_LIM_09;
            r2 = _lim_lut_C2_AUX_LIM_09;
            r3 = _lim_lutc_C2_AUX_LIM_09;
            call _dyn_lut_step;
#endif
        .lim_go_C2_AUX_LIM_09:

            r0 = abs r13;
            r1 = dm(_lim_envelope_C2_AUX_LIM_09);
            r2 = dm(_lim_attq_C2_AUX_LIM_09);
            r3 = dm(_lim_relq_C2_AUX_LIM_09);
            call _envq_fx;
            dm(_lim_envelope_C2_AUX_LIM_09) = r0;
            ...
            r4 = dm(_lim_lutc_C2_AUX_LIM_09);
            r5 = DYN_LUT_N;
            comp(r4, r5);
            if lt jump (pc, .llutpoly_C2_AUX_LIM_09);
            i0 = _lim_lut_C2_AUX_LIM_09;
            call _dyn_lut_gain;           /* r0 = gain Q4.28 */
            jump (pc, .llutgain_C2_AUX_LIM_09);
        .llutpoly_C2_AUX_LIM_09:
#endif
            i0 = _lim_cgp_C2_AUX_LIM_09;
            call _compgain_fx;
#if DSP4_DYN_LUT
        .llutgain_C2_AUX_LIM_09:
#endif
            r1 = r0;
            r0 = r13;
            mrf = r0 * r1 (ssi);

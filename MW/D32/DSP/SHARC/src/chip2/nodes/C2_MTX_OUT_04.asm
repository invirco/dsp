/*----------------------------------------------------------------------
 * Matrix 4 Out (OUTPUT_TDM)
 * Node ID:    C2_MTX_OUT_04
 * Chip:       2
 * Channels:   1
 * SPI Page:   1
 * SPI Addr:   2022
 ...
 * half. */
.global _tx_out_slot_C2_MTX_OUT_04;
.var _tx_out_slot_C2_MTX_OUT_04[DSP4_BLOCK_SIZE];
.global _blk_C2_MTX_OUT_04;
.var _blk_C2_MTX_OUT_04[DSP4_BLOCK_SIZE];
.extern _blk_C2_MTX_FDR_04;
#else
.global _tx_out_slot_C2_MTX_OUT_04;
.var _tx_out_slot_C2_MTX_OUT_04;
#endif
.global _buf_C2_MTX_OUT_04;
.var _buf_C2_MTX_OUT_04;

.section/pm seg_pmco;
.global _C2_MTX_OUT_04_process;
_C2_MTX_OUT_04_process:
#if DSP4_BLOCK_KERNELS
    l0 = 0;
    l1 = 0;
    l2 = 0;
    l3 = 0;
    i0 = _blk_C2_MTX_FDR_04;
    i1 = _tx_out_slot_C2_MTX_OUT_04;
    i2 = _blk_C2_MTX_OUT_04;
    lcntr = DSP4_BLOCK_SIZE, do .otk_C2_MTX_OUT_04 until lce;
        r0 = dm(i0, 1);
        dm(i1, 1) = r0;
    .otk_C2_MTX_OUT_04: dm(i2, 1) = r0;
    ...
    dm(_buf_C2_MTX_OUT_04) = r0;
    rts;
#else
    r0 = dm(_buf_C2_MTX_FDR_04);
    dm(_tx_out_slot_C2_MTX_OUT_04) = r0;
    dm(_buf_C2_MTX_OUT_04) = r0;
    rts;
#endif
_C2_MTX_OUT_04_process.end:

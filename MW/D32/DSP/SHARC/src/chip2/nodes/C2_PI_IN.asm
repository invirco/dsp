...
.global _auxin_q_C2_PI_IN;
.var _auxin_q_C2_PI_IN = 0;                  /* Q4.28 coeff x assign */
 ...
 * back in. */
.global _auxin_byp_C2_PI_IN;
.var _auxin_byp_C2_PI_IN = 0;
#endif
.global _buf_C2_PI_IN;
.var _buf_C2_PI_IN;

        #if DSP4_BLOCK_KERNELS
        .extern _blk_C2_XR_PI_L;
        .extern _blk_C2_XR_PI_R;
        #endif
        #if DSP4_BLOCK_KERNELS
        .global _blk_C2_PI_IN;
        .var _blk_C2_PI_IN[DSP4_BLOCK_SIZE];
        .global _bw_k_C2_PI_IN;
        .var _bw_k_C2_PI_IN;        /* the caller's _sample_idx */
        .global _bw_s0_C2_PI_IN;
        .var _bw_s0_C2_PI_IN;       /* walking source pointer */
        .global _bw_s1_C2_PI_IN;
        .var _bw_s1_C2_PI_IN;       /* walking source pointer */
        .global _bw_d0_C2_PI_IN;
        .var _bw_d0_C2_PI_IN;       /* walking sink pointer */
        #endif
...
_C2_PI_IN_process:
            ...
            r0 = 1;
            dm(_auxin_byp_C2_PI_IN) = r0;
            l0 = 0;
            r0 = 0;
            i0 = _blk_C2_PI_IN;
            lcntr = DSP4_BLOCK_SIZE, do .bwpk_C2_PI_IN until lce;
            .bwpk_C2_PI_IN: dm(i0, 1) = r0;
            dm(_buf_C2_PI_IN) = r0;
            rts;
        .bwrun_C2_PI_IN:
        #endif
            ...
            i4 = _blk_C2_XR_PI_L;
            r3 = i4;
            dm(_bw_s0_C2_PI_IN) = r3;
            i4 = _blk_C2_XR_PI_R;
            r3 = i4;
            dm(_bw_s1_C2_PI_IN) = r3;
            i4 = _blk_C2_PI_IN;
            r3 = i4;
            dm(_bw_d0_C2_PI_IN) = r3;
            r5 = dm(_sample_idx);
            dm(_bw_k_C2_PI_IN) = r5;
            r5 = 0;
            dm(_sample_idx) = r5;
            /* sample 0, peeled: the block-rate guard fires here */
                r3 = dm(_bw_s0_C2_PI_IN);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_XR_PI_L) = r0;
                r3 = r3 + 1;
                dm(_bw_s0_C2_PI_IN) = r3;
                r3 = dm(_bw_s1_C2_PI_IN);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_XR_PI_R) = r0;
                r3 = r3 + 1;
                dm(_bw_s1_C2_PI_IN) = r3;
                call _C2_PI_IN_process_sample;
                r0 = dm(_buf_C2_PI_IN);
                r3 = dm(_bw_d0_C2_PI_IN);
                i4 = r3;
                dm(i4, 0) = r0;
                r3 = r3 + 1;
                dm(_bw_d0_C2_PI_IN) = r3;
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_PI_IN until lce;
                r3 = dm(_bw_s0_C2_PI_IN);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_XR_PI_L) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_PI_IN: dm(_bw_d0_C2_PI_IN) = r3;
            r5 = dm(_bw_k_C2_PI_IN);
            dm(_sample_idx) = r5;
            rts;

        .global _C2_PI_IN_process_sample;
        _C2_PI_IN_process_sample:
        #endif
    ...
    r1 = 0;
    comp(r4, r1);
    if ne jump (pc, .auxin_apply_C2_PI_IN);
#if DSP4_BLOCK_KERNELS && DSP4_AUXIN_BYPASS
    ...
    r2 = pass r2;
    if eq jump (pc, .auxin_live_C2_PI_IN);
    r2 = 0;
    dm(_auxin_byp_C2_PI_IN) = r2;
    dm(_auxin_level_frames_C2_PI_IN) = r2;
.auxin_live_C2_PI_IN:
#endif
...
.auxin_go_C2_PI_IN:
    ...
    r2 = pass r2;
    if eq r1 = r3;
    dm(_auxin_q_C2_PI_IN) = r1;

.auxin_apply_C2_PI_IN:
    r0 = dm(_buf_C2_XR_PI_L);
    r1 = dm(_auxin_q_C2_PI_IN);
    mrf = r0 * r1 (ssi);
    call _mrf_rns28;
    dm(_buf_C2_PI_IN) = r0;
    rts;

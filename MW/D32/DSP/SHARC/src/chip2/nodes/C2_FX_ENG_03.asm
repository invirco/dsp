/*----------------------------------------------------------------------
 * FX 3 Engine (FX_ENGINE)
 * Node ID:    C2_FX_ENG_03
 * Chip:       2
 * Channels:   2
 * SPI Page:   1
 * SPI Addr:   1637
...
.var _fx_type_C2_FX_ENG_03 = 3;  /* the graph's `type=Reverb` */
#else
.global _fx_type_C2_FX_ENG_03;
.var _fx_type_C2_FX_ENG_03 = 0;           /* 0=Echo,1=PingPong,2=Doubling,3=Reverb,4=Chorus,5=Flanger,6=Phaser */
#endif
...
.global _fx_bypassed_C2_FX_ENG_03;
.var _fx_bypassed_C2_FX_ENG_03 = 0;
.global _fx_decay_C2_FX_ENG_03;
.var _fx_decay_C2_FX_ENG_03;
.global _fx_predelay_C2_FX_ENG_03;
.var _fx_predelay_C2_FX_ENG_03;
.global _fx_delay_ms_C2_FX_ENG_03;
.var _fx_delay_ms_C2_FX_ENG_03;
.global _fx_feedback_C2_FX_ENG_03;
.var _fx_feedback_C2_FX_ENG_03;
.global _fx_balance_C2_FX_ENG_03;
.var _fx_balance_C2_FX_ENG_03;
.global _fx_damp_C2_FX_ENG_03;
.var _fx_damp_C2_FX_ENG_03;
.global _fx_eq_lo_C2_FX_ENG_03;
.var _fx_eq_lo_C2_FX_ENG_03;
.global _fx_eq_mid_C2_FX_ENG_03;
.var _fx_eq_mid_C2_FX_ENG_03;
.global _fx_eq_hi_C2_FX_ENG_03;
.var _fx_eq_hi_C2_FX_ENG_03;
.global _fx_hpf_coeffs_C2_FX_ENG_03;
.var _fx_hpf_coeffs_C2_FX_ENG_03[5];
.global _fx_mod_rate_C2_FX_ENG_03;
.var _fx_mod_rate_C2_FX_ENG_03;
.global _fx_mod_level_C2_FX_ENG_03;
.var _fx_mod_level_C2_FX_ENG_03;
.global _fx_lfo_shape_C2_FX_ENG_03;
.var _fx_lfo_shape_C2_FX_ENG_03 = 0;      /* 0=sine, 1=triangle */
.global _fx_width_C2_FX_ENG_03;
.var _fx_width_C2_FX_ENG_03;
.global _fx_mix_C2_FX_ENG_03;
.var _fx_mix_C2_FX_ENG_03;
.global _fx_mix_target_C2_FX_ENG_03;
.var _fx_mix_target_C2_FX_ENG_03;
.global _fx_mix_step_C2_FX_ENG_03;
.var _fx_mix_step_C2_FX_ENG_03 = 0.0;
.global _fx_mix_frames_C2_FX_ENG_03;
.var _fx_mix_frames_C2_FX_ENG_03 = 0;
.global _fx_duck_on_C2_FX_ENG_03;
.var _fx_duck_on_C2_FX_ENG_03 = 0;
.global _fx_duck_sens_C2_FX_ENG_03;
.var _fx_duck_sens_C2_FX_ENG_03;

/* LFO state */
.global _fx_lfo_phase_C2_FX_ENG_03;
.var _fx_lfo_phase_C2_FX_ENG_03 = 0.0;
.global _fx_scratch_C2_FX_ENG_03;
.var _fx_scratch_C2_FX_ENG_03;
...
.global _fx_comb_buf_L_C2_FX_ENG_03;
.var _fx_comb_buf_L_C2_FX_ENG_03[11024];
.global _fx_allpass_buf_L_C2_FX_ENG_03;
.var _fx_allpass_buf_L_C2_FX_ENG_03[1563];
.section/dm seg_dmda;
.global _fx_rv_comb_wptrs_C2_FX_ENG_03;
.var _fx_rv_comb_wptrs_C2_FX_ENG_03[8];
.global _fx_rv_comb_lpfs_C2_FX_ENG_03;
.var _fx_rv_comb_lpfs_C2_FX_ENG_03[8];
.global _fx_rv_comb_lens_C2_FX_ENG_03;
.var _fx_rv_comb_lens_C2_FX_ENG_03[8] = 1557, 1617, 1491, 1422, 1277, 1356, 1188, 1116;
.global _fx_rv_comb_ofs_C2_FX_ENG_03;
.var _fx_rv_comb_ofs_C2_FX_ENG_03[8] = 0, 1557, 3174, 4665, 6087, 7364, 8720, 9908;
.global _fx_rv_ap_wptrs_C2_FX_ENG_03;
.var _fx_rv_ap_wptrs_C2_FX_ENG_03[4];
.global _fx_rv_ap_lens_C2_FX_ENG_03;
.var _fx_rv_ap_lens_C2_FX_ENG_03[4] = 556, 441, 341, 225;
.global _fx_rv_ap_ofs_C2_FX_ENG_03;
.var _fx_rv_ap_ofs_C2_FX_ENG_03[4] = 0, 556, 997, 1338;
/* Echo / doubling delay line, 12000 words = 250 ms */
.section/dm seg_delay;
.global _fx_echo_buf_C2_FX_ENG_03;
.var _fx_echo_buf_C2_FX_ENG_03[12000];
.section/dm seg_dmda;
.global _fx_echo_wptr_C2_FX_ENG_03;
.var _fx_echo_wptr_C2_FX_ENG_03 = 0;

.global _buf_L_C2_FX_ENG_03;
.var _buf_L_C2_FX_ENG_03;
.global _buf_R_C2_FX_ENG_03;
.var _buf_R_C2_FX_ENG_03;
...
_C2_FX_ENG_03_process:
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_FX_ENG_03 until lce;
                r3 = dm(_bw_s0_C2_FX_ENG_03);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_RECV_FX_03) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_FX_ENG_03: dm(_bw_d0_C2_FX_ENG_03) = r3;
    ...
    r4 = r4 - 1;
    if le jump (pc, .no_fxramp_C2_FX_ENG_03);
    dm(_fx_mix_frames_C2_FX_ENG_03) = r4;
    f1 = dm(_fx_mix_C2_FX_ENG_03);
    f2 = dm(_fx_mix_step_C2_FX_ENG_03);
    f1 = f1 + f2;
    dm(_fx_mix_C2_FX_ENG_03) = f1;
    jump (pc, .fx_dispatch_C2_FX_ENG_03);
.no_fxramp_C2_FX_ENG_03:
    f1 = dm(_fx_mix_target_C2_FX_ENG_03);
    dm(_fx_mix_C2_FX_ENG_03) = f1;
.fx_dispatch_C2_FX_ENG_03:

    /* Load input */
    r0 = dm(_buf_C2_RECV_FX_03);
...
r1 = 3; comp(r0, r1); if eq jump (pc, .fx_reverb_C2_FX_ENG_03);
r1 = 2; comp(r0, r1); if eq jump (pc, .fx_doubling_C2_FX_ENG_03);
r1 = 0; comp(r0, r1); if eq jump (pc, .fx_echo_C2_FX_ENG_03);
jump (pc, .fx_bypass_C2_FX_ENG_03);

/* ===================== ECHO ===================== */
.fx_echo_C2_FX_ENG_03:
    r1 = dm(_fx_echo_wptr_C2_FX_ENG_03);
    r2 = dm(_fx_delay_ms_C2_FX_ENG_03);  /* delay in samples (MCU converts) */
    ...
    f5 = dm(_fx_feedback_C2_FX_ENG_03);
    f6 = f13 * f5;
    f7 = f15 + f6;
    i0 = _fx_echo_buf_C2_FX_ENG_03;
    m0 = r1;
    ...
    comp(r1, r4);
    if ge r1 = r1 - r4;
    dm(_fx_echo_wptr_C2_FX_ENG_03) = r1;
    /* Wet signal = delayed tap */
    f0 = f13;
    jump (pc, .fx_mix_C2_FX_ENG_03);

/* ===================== DOUBLING ===================== */
.fx_doubling_C2_FX_ENG_03:
...
/* ===================== REVERB ===================== */
.fx_reverb_C2_FX_ENG_03:
    /* Freeverb: 8 parallel comb-LPF + 4 series allpass */
    r14 = 0x00000000;  /* 0.0 IEEE 754 */                   /* comb sum accumulator */
    i3 = _fx_rv_comb_wptrs_C2_FX_ENG_03;
    i4 = _fx_rv_comb_lens_C2_FX_ENG_03;
    i5 = _fx_rv_comb_ofs_C2_FX_ENG_03;
    i6 = _fx_rv_comb_lpfs_C2_FX_ENG_03;
    f10 = dm(_fx_feedback_C2_FX_ENG_03); /* comb feedback */
    f11 = dm(_fx_damp_C2_FX_ENG_03);     /* damp1 */
    r12 = 0x3F800000;  /* 1.0 IEEE 754 */
    f12 = f12 - f11;             /* damp2 = 1 - damp1 */
    r5 = 8;
    lcntr = r5; do .rv_comb_C2_FX_ENG_03 until lce;
        r1 = dm(i3, 0);           /* wptr (peek) */
        r2 = dm(i4, 1);           /* comb length */
        r3 = dm(i5, 1);           /* base offset into comb buffer */
        /* Read delayed sample */
        r4 = r3 + r1;
        i0 = _fx_comb_buf_L_C2_FX_ENG_03;
        m0 = r4;
        modify(i0, m0);
    ...
    /* 4 series allpass */
    i3 = _fx_rv_ap_wptrs_C2_FX_ENG_03;
    i4 = _fx_rv_ap_lens_C2_FX_ENG_03;
    i5 = _fx_rv_ap_ofs_C2_FX_ENG_03;
    r10 = 0x3F000000;  /* 0.5 IEEE 754 */                   /* allpass feedback */
    r5 = 4;
    lcntr = r5; do .rv_ap_C2_FX_ENG_03 until lce;
        r1 = dm(i3, 0);
        r2 = dm(i4, 1);
        r3 = dm(i5, 1);
        r4 = r3 + r1;
        i0 = _fx_allpass_buf_L_C2_FX_ENG_03;
        m0 = r4;
        modify(i0, m0);
...
.fx_bypass_C2_FX_ENG_03:
    ...
    r1 = dm(_fx_type_C2_FX_ENG_03);
    dm(_fx_bypassed_C2_FX_ENG_03) = r1;
    f0 = f15;                    /* dry pass-through */
    jump (pc, .fx_mixed_C2_FX_ENG_03);

/* ===================== PASSTHROUGH ===================== */
.fx_passthru_C2_FX_ENG_03:
    f0 = f15;                    /* dry pass-through */

/* ===================== DRY/WET MIX ===================== */
.fx_mix_C2_FX_ENG_03:
    r1 = 0;
    dm(_fx_bypassed_C2_FX_ENG_03) = r1;  /* an algorithm ran */
.fx_mixed_C2_FX_ENG_03:
    /* f0 = wet, f15 = dry */
    f7 = dm(_fx_mix_C2_FX_ENG_03);

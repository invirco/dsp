...
.var _comp_saved_idx_C2_SUB_COMP;
        ...
        .global _bw_i_C2_SUB_COMP;
        .var _bw_i_C2_SUB_COMP;        /* sample index, across the call */
        ...
        _C2_SUB_COMP_process:
            ...
            r5 = 0;
            dm(_bw_i_C2_SUB_COMP) = r5;
            lcntr = DSP4_BLOCK_SIZE, do .bwlp_C2_SUB_COMP until lce;
                r5 = dm(_bw_i_C2_SUB_COMP);
                dm(_sample_idx) = r5;
                ...
                r5 = dm(_bw_i_C2_SUB_COMP);
                r5 = r5 + 1;
            .bwlp_C2_SUB_COMP: dm(_bw_i_C2_SUB_COMP) = r5;

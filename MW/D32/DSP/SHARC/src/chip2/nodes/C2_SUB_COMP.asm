...
.extern _buf_C2_SUB_EQ;
        ...
        .var _comp_makeup_target_C2_SUB_COMP = 1.0;
        .global _comp_makeup_step_C2_SUB_COMP;
        .var _comp_makeup_step_C2_SUB_COMP = 0.0;
        .global _comp_makeup_frames_C2_SUB_COMP;
        .var _comp_makeup_frames_C2_SUB_COMP = 0;
        .global _comp_knee_C2_SUB_COMP;
        .var _comp_knee_C2_SUB_COMP = 0.0;   /* hard knee until the host sets it */
        .global _comp_parallel_C2_SUB_COMP;
        .var _comp_parallel_C2_SUB_COMP = 100.0;   /* PERCENT (D40); fully wet by default (D59) */
        ...
        .var _comp_parq_C2_SUB_COMP = 0x7FFFFFFF;   /* Q0.31, = _comp_parallel_ converted */
         ...
         * meanwhile. */
        .global _comp_lut_C2_SUB_COMP;
        .var _comp_lut_C2_SUB_COMP[DYN_LUT_N];
        .global _comp_lutc_C2_SUB_COMP;
        .var _comp_lutc_C2_SUB_COMP = 0;
        .global _comp_lutk_C2_SUB_COMP;
        .var _comp_lutk_C2_SUB_COMP[4] = 1, 1, 1, 1;
#endif
        .global _buf_C2_SUB_COMP;
        .var _buf_C2_SUB_COMP;

#if DSP4_BLOCK_KERNELS
.global _comp_saved_idx_C2_SUB_COMP;
.var _comp_saved_idx_C2_SUB_COMP;
#endif
        #if DSP4_BLOCK_KERNELS
        .extern _blk_C2_SUB_EQ;
        #endif
        #if DSP4_BLOCK_KERNELS
        .global _blk_C2_SUB_COMP;
        .var _blk_C2_SUB_COMP[DSP4_BLOCK_SIZE];
        .global _bw_k_C2_SUB_COMP;
        .var _bw_k_C2_SUB_COMP;        /* the caller's _sample_idx */
        .global _bw_s0_C2_SUB_COMP;
        .var _bw_s0_C2_SUB_COMP;       /* walking source pointer */
        .global _bw_d0_C2_SUB_COMP;
        .var _bw_d0_C2_SUB_COMP;       /* walking sink pointer */
        #endif
        ...
        _C2_SUB_COMP_process:
            ...
            i4 = _blk_C2_SUB_EQ;
            r3 = i4;
            dm(_bw_s0_C2_SUB_COMP) = r3;
            i4 = _blk_C2_SUB_COMP;
            r3 = i4;
            dm(_bw_d0_C2_SUB_COMP) = r3;
            r5 = dm(_sample_idx);
            dm(_bw_k_C2_SUB_COMP) = r5;
            r5 = 0;
            dm(_sample_idx) = r5;
            /* sample 0, peeled: the block-rate guard fires here */
                r3 = dm(_bw_s0_C2_SUB_COMP);
                i4 = r3;
                r0 = dm(i4, 0);
            ...
            lcntr = DSP4_BLOCK_SIZE-1, do .bwlp_C2_SUB_COMP until lce;
                r3 = dm(_bw_s0_C2_SUB_COMP);
                i4 = r3;
                r0 = dm(i4, 0);
                dm(_buf_C2_SUB_EQ) = r0;
                ...
                dm(i4, 0) = r0;
                r3 = r3 + 1;
            .bwlp_C2_SUB_COMP: dm(_bw_d0_C2_SUB_COMP) = r3;
            r5 = dm(_bw_k_C2_SUB_COMP);
            dm(_sample_idx) = r5;
            rts;

        .global _C2_SUB_COMP_process_sample;
        _C2_SUB_COMP_process_sample:
        #endif
        ...
        #if DSP4_COMP_NOCVT
            jump (pc, .comp_go_C2_SUB_COMP);   /* TEMP bisect: skip block-rate cvt */
        #endif
         ...
         * BLOCK-1, would run the whole conversion on every sample. */
            ...
            r1 = 0;
            comp(r4, r1);
            if ne jump (pc, .comp_go_C2_SUB_COMP);

            r4 = dm(_comp_makeup_frames_C2_SUB_COMP);
            comp(r4, r1);
            if le jump (pc, .no_mramp_C2_SUB_COMP);
            ...
            r5 = DSP4_BLOCK_SIZE;
            r4 = r4 - r5;
            dm(_comp_makeup_frames_C2_SUB_COMP) = r4;
        ...
        .comp_kdone_C2_SUB_COMP:
            ...
            r0 = _comp_cgp_C2_SUB_COMP;
            r1 = _comp_lutk_C2_SUB_COMP;
            r2 = _comp_lut_C2_SUB_COMP;
            r3 = _comp_lutc_C2_SUB_COMP;
            call _dyn_lut_step;
#endif
        .comp_go_C2_SUB_COMP:
            ...
            r4 = dm(_comp_lutc_C2_SUB_COMP);
            r5 = DYN_LUT_N;
            comp(r4, r5);
            if lt jump (pc, .clutpoly_C2_SUB_COMP);
            i0 = _comp_lut_C2_SUB_COMP;
            call _dyn_lut_gain;           /* r0 = gain Q4.28 */
            jump (pc, .clutgain_C2_SUB_COMP);
        .clutpoly_C2_SUB_COMP:
#endif
            i0 = _comp_cgp_C2_SUB_COMP;
            call _compgain_fx;            /* r0 = gain Q4.28 */
#if DSP4_DYN_LUT
        .clutgain_C2_SUB_COMP:
#endif

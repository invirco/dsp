 ...
 * back in. */
.global _auxin_byp_C2_SNK_IN_07;
.var _auxin_byp_C2_SNK_IN_07 = 0;
#endif
...
_C2_SNK_IN_07_process:
            ...
            /* ---- PARK: _auxin_on_C2_SNK_IN_07 is off ---- */
            r5 = dm(_auxin_on_C2_SNK_IN_07);
            r5 = pass r5;
            if ne jump (pc, .bwrun_C2_SNK_IN_07);
            r0 = 1;
            dm(_auxin_byp_C2_SNK_IN_07) = r0;
            l0 = 0;
            r0 = 0;
            i0 = _blk_C2_SNK_IN_07;
            lcntr = DSP4_BLOCK_SIZE, do .bwpk_C2_SNK_IN_07 until lce;
            .bwpk_C2_SNK_IN_07: dm(i0, 1) = r0;
    ...
    r2 = pass r2;
    if eq jump (pc, .auxin_live_C2_SNK_IN_07);
    r2 = 0;
    dm(_auxin_byp_C2_SNK_IN_07) = r2;
    dm(_auxin_level_frames_C2_SNK_IN_07) = r2;
.auxin_live_C2_SNK_IN_07:
#endif

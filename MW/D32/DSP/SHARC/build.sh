...
# The chip-2 RTA filterbank (S64, src/chip2/rta.asm, generated by
# tools/dsp/dsp_codegen.py::gen_rta): 31 x 1/3-octave x 3 biquads x 2
# channels + ballistics, run after chip 2's chain while DIAG_RTA_ON = 1.
# Off by default; with 0 the image is byte-identical to a build without it.
DSP4_RTA="${DSP4_RTA:-0}"

...
|---|---|---|---|---|---|---|
| `conform_s7_c1.json` | 1 | all | 4800/4800 | True | 292.3 | True |
| `conform_s7_c1_negunit.json` | 1 | effect | 4800/4800 | True | None | True |
| `conform_s7_c1_noverify.json` | 1 | presence | 64/4800 | False | 0.6 | True |
| `conform_s7_c2.json` | 2 | all | 1952/1952 | True | 120.7 | True |
...
|---|---|---|---|---|
| — |  | WINDOW | — | INFO |
| 0x0000 | Chan001Gain001 | POSITIVE CONTROL | 0 | CONTROL DID NOT CLEAR THE NOISE FLOOR (0 moved, 32 moved unwritten) — NO inert verdict is reported from this run |

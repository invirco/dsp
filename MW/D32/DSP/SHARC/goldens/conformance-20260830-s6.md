...
|---|---|---|---|---|---|---|
| `conform_s6_c1.json` | 1 | all | 4800/4800 | True | 292.5 | True |
| `conform_s6_c1_negunit.json` | 1 | effect | 4800/4800 | True | None | True |
| `conform_s6_c1_noverify.json` | 1 | presence | 64/4800 | False | 0.6 | True |
| `conform_s6_c2.json` | 2 | all | 1952/1952 | True | 120.6 | True |
...
|---|---|---|---|---|
| — |  | WINDOW | — | SILENT WINDOW — every cell would look inert; no inert verdict is reported from this run. The signal stops at _buf_C1_EQ_01. |

#!/usr/bin/env python3
"""s60_loop.py — S60 gates 3 and 4 on the MIC 5 -> AUX 1 loop (cable on J25), captures only (analysis on the desk,
...
Every step is timed; /home/app/s60/s60_loop.jsonl."""
import json, os, sys, time
import s60lib as S
T, X, CH = S.T, S.X, S.CH
R = T.Rig('/home/app/s60/s60_loop.jsonl')
c1 = R.c1
M5 = T.LOOP

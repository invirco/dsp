#!/usr/bin/env python3
"""s61_analyse.py <datadir> (S61: s60_analyse.py verbatim, run on the bulk-read captures) — deconvolve the S60 captures against the captured strip-6 reference and score them

"""s61lib — S61 copy of s60lib (paths s61; s61 first on sys.path so dsp4_meascap is the bulk one). The S60 chirp driver on top of s54lib (TEST_OSC SweepOn/SweepStep chirp, TEST_MEAS capture arm)."""
import json, math, os, subprocess, sys, time
os.environ['SYMDIR'] = os.environ.get('SYMDIR', '/home/app/s61')
sys.path.insert(0, '/home/app/dspboot'); sys.path.insert(0, '/home/app/s54'); sys.path.insert(0, '/home/app/s61')

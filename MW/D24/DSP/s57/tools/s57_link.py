...
TEST_OSC off, MeasChan 20. Each 16k capture-arm run is taken with the link in one state for its whole 0.34 s:
...
for i in range(count):
    ...
    cap = {'tool': 's57_link', 'fs_hz': 48000, 'scale': 'q4.28', 'lanes': 1, 'node': 'C1_TEST_MEAS capture, strip 20',

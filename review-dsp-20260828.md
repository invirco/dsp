...
closed D57 and D59 — the two cell-semantics defects the driven probe
found — and re-keyed the capacity harness's scratch tree; both fixes
change the audio of a default-configured strip BY DESIGN and the bus
golden was re-taken in the same session, which is the rule D58 left.

## HUB DISPATCH 2026-09-03 14:19Z — Full market-config capacity fit — 31-band GEQ on ALL outputs + full product graph, whole-graph cycles both chips (float, no audio)   [status: 🟡 dispatched]   [model: opus]

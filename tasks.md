## HUB DISPATCH 2026-09-08 22:55Z — CONFIRM THE DSP CODE AGAINST defs-v2026.09.08.3 — pin .3, propose the dsp.csv + dsp-unmapped.csv pair for the 39/51 new GEQ cells + CrossoverSlope 0x0576 (hub lands .4 tonight), both chips rebuilt, whole addressed set verified on the part by name, capacity restated, window-readiness note; no panel-MCU/app deploy   [status: 🟡 in progress — **PROPOSAL PUSHED: 54f2924**, ready for the hub to land as defs-v2026.09.08.4. d24 dsp.csv 3698→3737 (+39), d32 5358→5409 (+51); dsp-unmapped UNCHANGED at 1248/1590; invariant holds at 4985/6999. NOT byte-identical otherwise: the 31-band GEQ re-lays chip 2 (+51 words; 1192 d24 / 1460 d32 rows move address; chip 1 untouched), so CrossoverSlope lands at 0x059D, not 0x0576 — the two asks in this brief could not both hold. Gates 3-6 running.]   [model: opus]
